...
const _M0FP311moonbitlang4core7builtin33brute__force__find_2econstr_2f200 = 0;
const _M0FP311moonbitlang4core7builtin43boyer__moore__horspool__find_2econstr_2f186 = 0;
...
function _M0FP311moonbitlang4core7builtin28boyer__moore__horspool__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FP311moonbitlang4core7builtin43boyer__moore__horspool__find_2econstr_2f186;
  }
}
function _M0FP311moonbitlang4core7builtin18brute__force__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FP311moonbitlang4core7builtin33brute__force__find_2econstr_2f200;
  }
}
...
function _M0MP311moonbitlang4core5array5Array4pushGUiiiEE(self, value) {
  _M0MP311moonbitlang4core7builtin7JSArray4push(self, value);
}
...
function _M0FP36mizchi6kagura6mesh3d18parse__obj__double(chars, start, end) {
  ...
  const i = { val: start };
  const negative = { val: false };
  if (_M0MP311moonbitlang4core5array5Array2atGiE(chars, i.val) === 45) {
    negative.val = true;
    i.val = i.val + 1 | 0;
  } else {
    if (_M0MP311moonbitlang4core5array5Array2atGiE(chars, i.val) === 43) {
      i.val = i.val + 1 | 0;
    }
  }
  const result = { val: 0 };
  while (true) {
    if (i.val < end) {
      const d = _M0MP311moonbitlang4core5array5Array2atGiE(chars, i.val) - 48 | 0;
      if (d >= 0 && d <= 9) {
  ...
  if (i.val < end && _M0MP311moonbitlang4core5array5Array2atGiE(chars, i.val) === 46) {
    i.val = i.val + 1 | 0;
    const frac_div = { val: 1 };
    while (true) {
      if (i.val < end) {
        const d = _M0MP311moonbitlang4core5array5Array2atGiE(chars, i.val) - 48 | 0;
        if (d >= 0 && d <= 9) {
  ...
  if (i.val < end && (_M0MP311moonbitlang4core5array5Array2atGiE(chars, i.val) === 101 || _M0MP311moonbitlang4core5array5Array2atGiE(chars, i.val) === 69)) {
    i.val = i.val + 1 | 0;
    const exp_neg = { val: false };
    if (i.val < end && _M0MP311moonbitlang4core5array5Array2atGiE(chars, i.val) === 45) {
      exp_neg.val = true;
      i.val = i.val + 1 | 0;
    } else {
      if (i.val < end && _M0MP311moonbitlang4core5array5Array2atGiE(chars, i.val) === 43) {
        i.val = i.val + 1 | 0;
      }
    }
    const exp = { val: 0 };
...
function _M0FP36mizchi6kagura6mesh3d8skip__ws(chars, start, end) {
  const i = { val: start };
  while (true) {
    if (i.val < end && (_M0MP311moonbitlang4core5array5Array2atGiE(chars, i.val) === 32 || _M0MP311moonbitlang4core5array5Array2atGiE(chars, i.val) === 9)) {
      i.val = i.val + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi6kagura6mesh3d10find__char(chars, ch, start, end) {
  const i = { val: start };
  while (true) {
    if (i.val < end && _M0MP311moonbitlang4core5array5Array2atGiE(chars, i.val) !== ch) {
      i.val = i.val + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MP36mizchi6kagura6mesh3d6Mesh3D9from__obj(source) {
  const chars = [];
  const _it = _M0MP311moonbitlang4core6string6String4iter(source);
  while (true) {
    let ch;
    _L: {
  ...
  const has_normals = { val: false };
  const face_starts = [];
  const face_tri_counts = [];
  const pos = { val: 0 };
  while (true) {
    if (pos.val < len) {
      const line_end = { val: pos.val };
      while (true) {
        if (line_end.val < len && (_M0MP311moonbitlang4core5array5Array2atGiE(chars, line_end.val) !== 10 && _M0MP311moonbitlang4core5array5Array2atGiE(chars, line_end.val) !== 13)) {
      ...
      if (line_start < line_end.val) {
        const first = _M0MP311moonbitlang4core5array5Array2atGiE(chars, line_start);
        if (first === 118) {
          if ((line_start + 1 | 0) < line_end.val && _M0MP311moonbitlang4core5array5Array2atGiE(chars, line_start + 1 | 0) === 110) {
            const p = { val: _M0FP36mizchi6kagura6mesh3d8skip__ws(chars, line_start + 2 | 0, line_end.val) };
            ...
            _M0MP311moonbitlang4core5array5Array4pushGdE(normals, nx);
            _M0MP311moonbitlang4core5array5Array4pushGdE(normals, ny);
            _M0MP311moonbitlang4core5array5Array4pushGdE(normals, nz);
          } else {
            if ((line_start + 1 | 0) < line_end.val && _M0MP311moonbitlang4core5array5Array2atGiE(chars, line_start + 1 | 0) === 116) {
              const p = { val: _M0FP36mizchi6kagura6mesh3d8skip__ws(chars, line_start + 2 | 0, line_end.val) };
              const e1 = _M0FP36mizchi6kagura6mesh3d8find__ws(chars, p.val, line_end.val);
              ...
              _M0MP311moonbitlang4core5array5Array4pushGdE(texcoords, u);
              _M0MP311moonbitlang4core5array5Array4pushGdE(texcoords, v);
            } else {
              if ((line_start + 1 | 0) < line_end.val && (_M0MP311moonbitlang4core5array5Array2atGiE(chars, line_start + 1 | 0) === 32 || _M0MP311moonbitlang4core5array5Array2atGiE(chars, line_start + 1 | 0) === 9)) {
                const p = { val: _M0FP36mizchi6kagura6mesh3d8skip__ws(chars, line_start + 1 | 0, line_end.val) };
                const e1 = _M0FP36mizchi6kagura6mesh3d8find__ws(chars, p.val, line_end.val);
                ...
                _M0MP311moonbitlang4core5array5Array4pushGdE(positions, x);
                _M0MP311moonbitlang4core5array5Array4pushGdE(positions, y);
                _M0MP311moonbitlang4core5array5Array4pushGdE(positions, z);
              }
            }
          }
        } else {
          if (first === 102 && ((line_start + 1 | 0) < line_end.val && (_M0MP311moonbitlang4core5array5Array2atGiE(chars, line_start + 1 | 0) === 32 || _M0MP311moonbitlang4core5array5Array2atGiE(chars, line_start + 1 | 0) === 9))) {
            const face_verts = [];
            const p = { val: _M0FP36mizchi6kagura6mesh3d8skip__ws(chars, line_start + 1 | 0, line_end.val) };
            while (true) {
              if (p.val < line_end.val) {
                ...
                if (tok_end > p.val) {
                  _M0MP311moonbitlang4core5array5Array4pushGUiiiEE(face_verts, _M0FP36mizchi6kagura6mesh3d19parse__face__vertex(chars, p.val, tok_end));
                }
            ...
            const face_has_normals = { val: false };
            const _arr = face_verts;
            ...
            while (true) {
              ...
              if (_i < _len$2) {
                ...
                const px = pi >= 0 && (pi + 2 | 0) < positions.length ? _M0MP311moonbitlang4core5array5Array2atGdE(positions, pi) : 0;
                const py = pi >= 0 && (pi + 2 | 0) < positions.length ? _M0MP311moonbitlang4core5array5Array2atGdE(positions, pi + 1 | 0) : 0;
                const pz = pi >= 0 && (pi + 2 | 0) < positions.length ? _M0MP311moonbitlang4core5array5Array2atGdE(positions, pi + 2 | 0) : 0;
                const nx = { val: 0 };
                const ny = { val: 0 };
                const nz = { val: 0 };
                if (face_has_normals.val && vni_raw !== 0) {
                  ...
                  if (ni >= 0 && (ni + 2 | 0) < normals.length) {
                    nx.val = _M0MP311moonbitlang4core5array5Array2atGdE(normals, ni);
                    ny.val = _M0MP311moonbitlang4core5array5Array2atGdE(normals, ni + 1 | 0);
                    nz.val = _M0MP311moonbitlang4core5array5Array2atGdE(normals, ni + 2 | 0);
                  }
                }
                const u = { val: 0 };
                const v = { val: 0 };
                if (vti_raw !== 0) {
                  ...
                  if (ti >= 0 && (ti + 1 | 0) < texcoords.length) {
                    u.val = _M0MP311moonbitlang4core5array5Array2atGdE(texcoords, ti);
                    v.val = _M0MP311moonbitlang4core5array5Array2atGdE(texcoords, ti + 1 | 0);
                  }
                }
            ...
            const tri_count = { val: 0 };
            const _start188 = 1;
            const _end189 = n_face - 1 | 0;
            let _tmp$3 = _start188;
            while (true) {
              const k = _tmp$3;
              if (k < _end189) {
                _M0MP311moonbitlang4core5array5Array4pushGiE(indices, base_idx);
                _M0MP311moonbitlang4core5array5Array4pushGiE(indices, base_idx + k | 0);
                _M0MP311moonbitlang4core5array5Array4pushGiE(indices, (base_idx + k | 0) + 1 | 0);
            ...
            if (!face_has_normals.val) {
              _M0MP311moonbitlang4core5array5Array4pushGiE(face_starts, face_idx_start);
              _M0MP311moonbitlang4core5array5Array4pushGiE(face_tri_counts, tri_count.val);
            }
          }
        }
      }
      pos.val = line_end.val;
      if (pos.val < len && _M0MP311moonbitlang4core5array5Array2atGiE(chars, pos.val) === 13) {
        pos.val = pos.val + 1 | 0;
      }
      if (pos.val < len && _M0MP311moonbitlang4core5array5Array2atGiE(chars, pos.val) === 10) {
        pos.val = pos.val + 1 | 0;
      }
      continue;
    } else {
  ...
  if (!has_normals.val || face_starts.length > 0) {
    const _start193 = 0;
    const _end194 = face_starts.length;
    let _tmp = _start193;
    while (true) {
      const fi = _tmp;
      if (fi < _end194) {
        const idx_start = _M0MP311moonbitlang4core5array5Array2atGiE(face_starts, fi);
        const tris = _M0MP311moonbitlang4core5array5Array2atGiE(face_tri_counts, fi);
        const i0 = _M0MP311moonbitlang4core5array5Array2atGiE(indices, idx_start);
        const i1 = _M0MP311moonbitlang4core5array5Array2atGiE(indices, idx_start + 1 | 0);
        const i2 = _M0MP311moonbitlang4core5array5Array2atGiE(indices, idx_start + 2 | 0);
        ...
        while (true) {
          ...
          if (ti < _end223) {
            ...
            const _start228 = 0;
            const _end229 = 3;
            let _tmp$3 = _start228;
            while (true) {
              const vi = _tmp$3;
              if (vi < _end229) {
                const idx = _M0MP311moonbitlang4core5array5Array2atGiE(indices, base + vi | 0);
