...
const _M0FP311moonbitlang4core4math34trig__reduce_2etwo__over__pi_2f574 = [0, 683565275, -1819212470, 2131351028, 2102212464, 920167782, 1326507024, 0];
...
function _M0FP311moonbitlang4core7builtin40fixed__choose__pivot__by_2esort__2_2f449(_env, a, b) {
  const cmp = _env._2;
  const swaps = _env._1;
  const arr = _env._0;
...
function _M0FP311moonbitlang4core7builtin40fixed__choose__pivot__by_2esort__3_2f450(_env, a, b, c) {
  _M0FP311moonbitlang4core7builtin40fixed__choose__pivot__by_2esort__2_2f449(_env, a, b);
  _M0FP311moonbitlang4core7builtin40fixed__choose__pivot__by_2esort__2_2f449(_env, b, c);
  _M0FP311moonbitlang4core7builtin40fixed__choose__pivot__by_2esort__2_2f449(_env, a, b);
}
function _M0FP311moonbitlang4core7builtin24fixed__choose__pivot__byGUiRP36mizchi6kagura7scene3d8Object3DEE(arr, cmp) {
  ...
  if (len >= 8) {
    ...
    if (len > 50) {
      _M0FP311moonbitlang4core7builtin40fixed__choose__pivot__by_2esort__3_2f450(_env, a - 1 | 0, a, a + 1 | 0);
      _M0FP311moonbitlang4core7builtin40fixed__choose__pivot__by_2esort__3_2f450(_env, b - 1 | 0, b, b + 1 | 0);
      _M0FP311moonbitlang4core7builtin40fixed__choose__pivot__by_2esort__3_2f450(_env, c - 1 | 0, c, c + 1 | 0);
    }
    _M0FP311moonbitlang4core7builtin40fixed__choose__pivot__by_2esort__3_2f450(_env, a, b, c);
  }
  if (swaps.val === 12) {
...
function _M0FP311moonbitlang4core4math12trig__reduce(x, switch_over) {
  ...
  const ind = exp >> 5;
  exp = exp & 31;
  let hi = _M0MP311moonbitlang4core5array13ReadOnlyArray2atGjE(_M0FP311moonbitlang4core4math34trig__reduce_2etwo__over__pi_2f574, ind);
  let mi = _M0MP311moonbitlang4core5array13ReadOnlyArray2atGjE(_M0FP311moonbitlang4core4math34trig__reduce_2etwo__over__pi_2f574, ind + 1 | 0);
  let lo = _M0MP311moonbitlang4core5array13ReadOnlyArray2atGjE(_M0FP311moonbitlang4core4math34trig__reduce_2etwo__over__pi_2f574, ind + 2 | 0);
  const tp = _M0MP311moonbitlang4core5array13ReadOnlyArray2atGjE(_M0FP311moonbitlang4core4math34trig__reduce_2etwo__over__pi_2f574, ind + 3 | 0);
  if (exp > 0) {
...
function _M0FP36mizchi6kagura6postfx30new__fullscreen__quad__command(dst, shader, src_image_ids, uniform_dwords, blend) {
  ...
  return _M0FP36mizchi6kagura3gfx37new__draw__triangles__command_2einner(dst, shader, [dst_region], 0, 0, 0, blend, _M0FP36mizchi6kagura6postfx30fullscreen__quad__vertex__data(), _M0FP36mizchi6kagura6postfx25fullscreen__quad__indices(), src_image_ids, uniform_dwords, 1);
}
...
function _M0MP26mizchi12postfx__demo9DemoState12build__scene(self) {
  const objects = [];
  _M0MP311moonbitlang4core5array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(objects, _M0FP36mizchi6kagura7scene3d8object3d(self.ground_mesh, undefined, undefined, undefined, _M0MP36mizchi6kagura6math3d4Vec43new(0.3, 0.35, 0.3, 1), Option$None$8$, new Option$Some$9$(100), Option$None$10$));
  _M0MP311moonbitlang4core5array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(objects, _M0FP36mizchi6kagura7scene3d8object3d(self.cube_mesh, _M0MP36mizchi6kagura6math3d4Vec33new(-2, 0.5, 0), undefined, undefined, _M0MP36mizchi6kagura6math3d4Vec43new(1, 0.2, 0.1, 1), Option$None$8$, Option$None$9$, Option$None$10$));
  _M0MP311moonbitlang4core5array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(objects, _M0FP36mizchi6kagura7scene3d8object3d(self.sphere_mesh, _M0MP36mizchi6kagura6math3d4Vec33new(1.5, 0.7, 1), undefined, undefined, _M0MP36mizchi6kagura6math3d4Vec43new(1, 0.95, 0.3, 1), Option$None$8$, Option$None$9$, Option$None$10$));
  const angle = (self.frame + 0) * 0.015;
  _M0MP311moonbitlang4core5array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(objects, _M0FP36mizchi6kagura7scene3d8object3d(self.cube_mesh, _M0MP36mizchi6kagura6math3d4Vec33new(0, 0.5, -2), _M0MP36mizchi6kagura6math3d10Quaternion17from__axis__angle(_M0MP36mizchi6kagura6math3d4Vec37unit__y(), angle), undefined, _M0MP36mizchi6kagura6math3d4Vec43new(0.2, 0.9, 1, 1), Option$None$8$, Option$None$9$, Option$None$10$));
  _M0MP311moonbitlang4core5array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(objects, _M0FP36mizchi6kagura7scene3d8object3d(self.sphere_mesh, _M0MP36mizchi6kagura6math3d4Vec33new(2.5, 0.7, -1.5), undefined, undefined, _M0MP36mizchi6kagura6math3d4Vec43new(1, 1, 1, 1), Option$None$8$, Option$None$9$, Option$None$10$));
...
function _M0MP26mizchi12postfx__demo9DemoState4draw(self, ctx) {
  ...
  const scene_cmds = _M0FP36mizchi6kagura7scene3d20render__scene3d__gpu(scene, self.scene_target, self.shader3d, ctx.screen_w, ctx.screen_h, Option$None$11$, Option$None$11$, Option$None$11$, Option$None$11$);
  const _arr = scene_cmds;
  const _len = _arr.length;
  let _tmp = 0;
  while (true) {
    const _i = _tmp;
  ...
  const tonemap_cmd = _M0FP36mizchi6kagura6postfx21new__tonemap__command(self.scene_target, self.tonemap_sh, self.post_target.id, 1);
  _M0MP311moonbitlang4core5array5Array4pushGRP36mizchi6kagura3gfx20DrawTrianglesCommandE(all_cmds, tonemap_cmd);
  ...
  _M0MP311moonbitlang4core5array5Array4pushGRP36mizchi6kagura3gfx20DrawTrianglesCommandE(all_cmds, fxaa_cmd);
  return all_cmds;
}
function _M0MP26mizchi12postfx__demo9DemoState3new() {
  ...
  return { cube_mesh: _M0MP36mizchi6kagura6mesh3d6Mesh3D4cube(1), sphere_mesh: _M0MP36mizchi6kagura6mesh3d6Mesh3D6sphere(0.7, 8, 6), ground_mesh: _M0MP36mizchi6kagura6mesh3d6Mesh3D13plane_2einner(16, 16, 4), scene_target: scene_target, bloom_a: bloom_a, bloom_b: bloom_b, post_target: post_target, shader3d: shader3d, bloom_threshold_sh: bloom_threshold_sh, bloom_hblur_sh: bloom_hblur_sh, bloom_vblur_sh: bloom_vblur_sh, bloom_composite_sh: bloom_composite_sh, fxaa_sh: fxaa_sh, tonemap_sh: tonemap_sh, camera: camera, lighting: lighting, input: _M0FP36mizchi6kagura9inpututil18new__input__helper(), frame: 0 };
}
...
(() => {
  ...
  }, (ctx) => _M0MP26mizchi12postfx__demo9DemoState4draw(state, ctx), undefined, undefined, 735, _M0FP26mizchi12postfx__demo9screen__w, _M0FP26mizchi12postfx__demo9screen__h, "Post-Processing Effects Demo", "#app");
})();
