...
test("model-authoring-vlm-local-feedback writes local review artifacts", () => {
  ...
  try {
    ...
    const result = spawnSync(
      process.execPath,
      [
        resolve("modules/editor/modeling3d/scripts/model-authoring-vlm-local-feedback.mjs"),
        "--bundle",
        bundlePath,
        "--parsed",
        parsedPath,
    ...
    assert.equal(stdoutJson.target_file, "modules/editor/modeling3d/examples/model_authoring/src/model_doc.mbt");
