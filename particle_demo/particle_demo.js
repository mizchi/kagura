...
function _M0FP36mizchi6kagura6draw3d28new__particle__draw__command(dst, shader, dst_region, index_offset, pipeline_id, uniform_hash, blend, vertex_data, indices, view_projection, src_image_ids) {
  ...
  return _M0FP36mizchi6kagura3gfx37new__draw__triangles__command_2einner(dst, shader, [dst_region], index_offset, pipeline_id, uniform_hash, blend, vertex_data, indices, src_image_ids, uniform_dwords, 1);
}
...
function _M0MP36mizchi6kagura10particle3d15ParticleEmitter26build__billboard__vertices(self, camera_right, camera_up) {
  ...
  while (true) {
    ...
    if (i < self.particles.length) {
      ...
      const base_idx = Math.imul(i, 4) | 0;
...
(() => {
  ...
  }, (ctx) => _M0MP26mizchi14particle__demo9DemoState4draw(state, ctx), undefined, undefined, 735, _M0FP26mizchi14particle__demo9screen__w, _M0FP26mizchi14particle__demo9screen__h, "Particle System Demo", "#app");
})();
