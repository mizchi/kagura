...
function usage() {
  console.error(
    [
      "Usage: node modules/editor/modeling3d/scripts/model-authoring-vlm-perf.mjs \\",
...
async function runDaemonHandoff({
  ...
  const args = [
    resolve(process.cwd(), "modules/editor/modeling3d/scripts/model-authoring-vlm-handoff.mjs"),
    "--example",
    example,
    "--live-review",
    "--provider",
