...
export const HACKNSLASH_GENERATED_DIR = "examples/hacknslash_3d/assets/generated";
...
export function defaultOutputPathForImage(imagePath) {
  ...
  return resolve(HACKNSLASH_GENERATED_DIR, `${safeStem}-trellis.glb`);
}

export function defaultPreprocessedPathForImage(imagePath) {
  const safeStem = defaultGeneratedStem(imagePath);
  return resolve(HACKNSLASH_GENERATED_DIR, `${safeStem}-prepped.png`);
}

export function toHacknslashQueryAssetPath(outputPath, cwd = process.cwd()) {
  const rel = relative(resolve(cwd, "examples/hacknslash_3d"), resolve(outputPath));
