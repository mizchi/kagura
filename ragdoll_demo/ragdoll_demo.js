...
function _M0TP36mizchi6kagura9physics2d15RevoluteJoint2D(param0, param1, param2, param3, param4, param5) {
  this.body_a_id = param0;
  this.body_b_id = param1;
  this.local_anchor_a = param2;
  this.local_anchor_b = param3;
  this.hertz = param4;
  this.damping_ratio = param5;
}
function _M0TP26mizchi13ragdoll__demo9DemoState(param0, param1, param2, param3, param4, param5) {
  this.world = param0;
  this.input = param1;
  this.frame = param2;
  this.grabbed_id = param3;
  this.mouse_phys_x = param4;
  this.mouse_phys_y = param5;
}
...
const _M0FPC14math34trig__reduce_2etwo__over__pi_2f759 = [0, 683565275, -1819212470, 2131351028, 2102212464, 920167782, 1326507024, 0];
...
function _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self, index) {
...
function _M0FPC14math12trig__reduce(x, switch_over) {
  ...
  const ind = exp >> 5;
  exp = exp & 31;
  let hi = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f759, ind);
  let mi = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f759, ind + 1 | 0);
  let lo = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f759, ind + 2 | 0);
  const tp = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f759, ind + 3 | 0);
  if (exp > 0) {
...
function _M0FP36mizchi6kagura9debugutil18new__line__command(dst, shader, x0, y0, x1, y1, width, color, pipeline_id) {
  ...
  return _M0FP36mizchi6kagura3gfx37new__draw__triangles__command_2einner(dst, shader, [_M0FP36mizchi6kagura3gfx16new__dst__region(_M0MPC16double6Double7to__int(min_x), _M0MPC16double6Double7to__int(min_y), _M0MPC16double6Double7to__int(max_x - min_x + width), _M0MPC16double6Double7to__int(max_y - min_y + width), 6)], 0, pipeline_id, 0, _M0FP36mizchi6kagura3gfx22blend__mode__from__int(1), vertices, indices, [], uniform, 1, 0);
}
...
function _M0MP36mizchi6kagura9physics2d14PhysicsWorld2D9get__body(self, id) {
  ...
  while (true) {
    ...
    if (i < self.bodies.length) {
      if (_M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, i).id === id) {
        return _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, i);
      }
      _tmp = i + 1 | 0;
      continue;
    } else {
...
function _M0MP36mizchi6kagura9physics2d11RigidBody2D12apply__force(self, f) {
  return new _M0TP36mizchi6kagura9physics2d11RigidBody2D(self.id, self.body_type, self.position, self.velocity, _M0MP36mizchi6kagura6vector4Vec23add(self.force, f), self.angle, self.angular_velocity, self.torque, self.mass, self.inv_mass, self.restitution, self.friction, self.inv_inertia, self.angular_damping, self.linear_damping, self.collider, self.is_sleeping, self.sleep_timer, self.is_bullet);
}
function _M0MP36mizchi6kagura9physics2d14PhysicsWorld2D12apply__force(self, body_id, force) {
  ...
  while (true) {
    const i = _tmp;
    if (i < self.bodies.length) {
      if (_M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, i).id === body_id) {
        _M0MPC15array5Array3setGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, i, _M0MP36mizchi6kagura9physics2d11RigidBody2D12apply__force(_M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, i), force));
        return;
      }
      _tmp = i + 1 | 0;
      continue;
...
function _M0MP36mizchi6kagura9physics2d14PhysicsWorld2D20add__revolute__joint(self, joint) {
  _M0MPC15array5Array4pushGRP36mizchi6kagura3gfx20DrawTrianglesCommandE(self.joints_revolute, joint);
}
...
function _M0FP36mizchi6kagura9physics2d16ccd__sweep__body(bullet_idx, bodies, dt) {
  const bullet = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(bodies, bullet_idx);
  ...
  while (true) {
    ...
    if (i < bodies.length) {
      if (i === bullet_idx) {
        ...
        const other = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(bodies, i);
...
function _M0FP36mizchi6kagura9physics2d8obb__obb(a, he_a, off_a, b, he_b, off_b) {
  ...
  while (true) {
    const i = _tmp;
    if (i < axes.length) {
      const axis = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(axes, i);
      let min_a;
      let max_a;
      _L: {
  ...
  while (true) {
    const i = _tmp$2;
    if (i < 4) {
      const v = _M0MP36mizchi6kagura6vector4Vec23add(center_a, _M0MP36mizchi6kagura6vector4Vec26rotate(_M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(local_corners_a, i), a.angle));
  ...
  while (true) {
    const i = _tmp$3;
    if (i < 4) {
      const v = _M0MP36mizchi6kagura6vector4Vec23add(center_b, _M0MP36mizchi6kagura6vector4Vec26rotate(_M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(local_corners_b, i), b.angle));
...
function _M0FP36mizchi6kagura9physics2d17find__body__index(bodies, id) {
  ...
  while (true) {
    const i = _tmp;
    if (i < bodies.length) {
      if (_M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(bodies, i).id === id) {
        return i;
      }
      _tmp = i + 1 | 0;
      continue;
...
function _M0FP36mizchi6kagura9physics2d27precompute__distance__joint(joint, bodies, sub_dt) {
  ...
  const a = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(bodies, idx_a);
  const b = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(bodies, idx_b);
...
function _M0FP36mizchi6kagura9physics2d19solve__constraint2d(constraints, ci, bodies) {
  const c = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(constraints, ci);
  const a = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(bodies, c.idx_a);
  const b = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(bodies, c.idx_b);
  ...
  const a2 = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(bodies, c.idx_a);
  const b2 = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(bodies, c.idx_b);
    ...
    while (true) {
      ...
      if (i < bucket.length) {
        ...
        while (true) {
          const j = _tmp$2;
          if (j < bucket.length) {
            const a = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.entries, _M0MPC15array5Array2atGiE(bucket, i));
            const b = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.entries, _M0MPC15array5Array2atGiE(bucket, j));
...
function _M0MP36mizchi6kagura9physics2d14PhysicsWorld2D4step(self, dt) {
  ...
  while (true) {
    const i = _tmp;
    if (i < self.bodies.length) {
      _M0MP36mizchi6kagura9physics2d17SpatialHashGrid2D6insert(self.broadphase, i, _M0MP36mizchi6kagura9physics2d11RigidBody2D11world__aabb(_M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, i)));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    ...
    if (p < pairs.length) {
      ...
      let idx_b;
      _L: {
        const _bind = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(pairs, p);
      ...
      const body_a = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, idx_a);
      const body_b = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, idx_b);
  ...
  while (true) {
    ...
    if (c < raw_contacts.length) {
      ...
      let contact;
      _L: {
        const _bind$2 = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(raw_contacts, c);
      ...
      _L$2: {
        ...
        if (_M0MP36mizchi6kagura6vector4Vec23dot(cached.normal, contact.normal) > 0.9) {
          if (cached.points.length > 0) {
            const pt = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(cached.points, 0);
            ...
            if (Math.abs(jn) > 1e-15 || Math.abs(jt) > 1e-15) {
              ...
              const _tmp$6 = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, idx_a);
              _M0MPC15array5Array3setGRP36mizchi6kagura9physics2d11RigidBody2DE(_tmp$5, idx_a, new _M0TP36mizchi6kagura9physics2d11RigidBody2D(_tmp$6.id, _tmp$6.body_type, _tmp$6.position, _M0MP36mizchi6kagura6vector4Vec23add(_M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, idx_a).velocity, _M0MP36mizchi6kagura6vector4Vec25scale(impulse, body_a.inv_mass)), _tmp$6.force, _tmp$6.angle, _tmp$6.angular_velocity, _tmp$6.torque, _tmp$6.mass, _tmp$6.inv_mass, _tmp$6.restitution, _tmp$6.friction, _tmp$6.inv_inertia, _tmp$6.angular_damping, _tmp$6.linear_damping, _tmp$6.collider, _tmp$6.is_sleeping, _tmp$6.sleep_timer, _tmp$6.is_bullet));
              const _tmp$7 = self.bodies;
              const _tmp$8 = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, idx_b);
              _M0MPC15array5Array3setGRP36mizchi6kagura9physics2d11RigidBody2DE(_tmp$7, idx_b, new _M0TP36mizchi6kagura9physics2d11RigidBody2D(_tmp$8.id, _tmp$8.body_type, _tmp$8.position, _M0MP36mizchi6kagura6vector4Vec23sub(_M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, idx_b).velocity, _M0MP36mizchi6kagura6vector4Vec25scale(impulse, body_b.inv_mass)), _tmp$8.force, _tmp$8.angle, _tmp$8.angular_velocity, _tmp$8.torque, _tmp$8.mass, _tmp$8.inv_mass, _tmp$8.restitution, _tmp$8.friction, _tmp$8.inv_inertia, _tmp$8.angular_damping, _tmp$8.linear_damping, _tmp$8.collider, _tmp$8.is_sleeping, _tmp$8.sleep_timer, _tmp$8.is_bullet));
            }
          }
        }
      }
  ...
  while (true) {
    ...
    if (j < self.joints_distance.length) {
      ...
      _L: {
        _L$2: {
          const _bind$2 = _M0FP36mizchi6kagura9physics2d27precompute__distance__joint(_M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.joints_distance, j), self.bodies, sub_dt);
          if (_bind$2 === undefined) {
          } else {
            const _Some = _bind$2;
            const _c = _Some;
  ...
  while (true) {
    ...
    if (j < self.joints_revolute.length) {
      ...
      _L: {
        _L$2: {
          const _bind$2 = _M0FP36mizchi6kagura9physics2d27precompute__revolute__joint(_M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.joints_revolute, j), self.bodies, sub_dt);
          if (_bind$2 === undefined) {
          } else {
            const _Some = _bind$2;
            const _c = _Some;
  ...
  while (true) {
    ...
    if (_s < substeps) {
      ...
      while (true) {
        const i = _tmp$7;
        if (i < self.bodies.length) {
          const body = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, i);
        ...
        if (_iter < config.velocity_iterations) {
          ...
          while (true) {
            ...
            if (di < dist_constraints.length) {
              _M0FP36mizchi6kagura9physics2d22solve__distance__joint(dist_constraints, di, self.bodies, _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.joints_distance, di));
              _tmp$10 = di + 1 | 0;
              continue;
            } else {
              break;
  ...
  while (true) {
    ...
    if (c < constraints.length) {
      const con = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(constraints, c);
      const body_a = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, con.idx_a);
      const body_b = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.bodies, con.idx_b);
      const pair_key = _M0FP36mizchi6kagura9physics2d18contact__pair__key(body_a.id, body_b.id);
...
function _M0MP36mizchi6kagura9physics2d11RigidBody2D11new__static(id, position, collider) {
  ...
  return new _M0TP36mizchi6kagura9physics2d11RigidBody2D(id, _bind, position, _bind$2, _bind$3, _bind$4, _bind$5, _bind$6, _bind$7, _bind$8, _bind$9, _bind$10, _bind$11, _bind$12, _bind$13, collider, _bind$14, _bind$15, _bind$16);
}
...
function _M0FP26mizchi13ragdoll__demo18draw__rotated__box(cmds, dst, shader, cx, cy, hw, hh, angle, color, sw, sh) {
  ...
  while (true) {
    ...
    if (i < 4) {
      ...
      let ly;
      _L: {
        const _bind = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(corners, i);
        const _lx = _bind._0;
        const _ly = _bind._1;
        lx = _lx;
        ly = _ly;
...
function _M0FP26mizchi13ragdoll__demo13world__anchor(body, anchor) {
  const c = _M0FPC14math3cos(body.angle);
  const s = _M0FPC14math3sin(body.angle);
...
function _M0MP26mizchi13ragdoll__demo9DemoState4draw(self, ctx) {
  ...
  _M0MPC15array5Array4pushGRP36mizchi6kagura3gfx20DrawTrianglesCommandE(cmds, _M0FP36mizchi6kagura9debugutil29new__ndc__rect__fill__command(ctx.dst, ctx.shader, 0, 0, sw, sh, sw, sh, _M0FP36mizchi6kagura9debugutil16color__from__hex(_M0FP26mizchi13ragdoll__demo9color__bg), 0));
  let _tmp = 0;
  while (true) {
    const i = _tmp;
    if (i < self.world.bodies.length) {
      const body = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.world.bodies, i);
  ...
  while (true) {
    ...
    if (j < self.world.joints_revolute.length) {
      const joint = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(self.world.joints_revolute, j);
      ...
      _L: {
        ...
        _M0MPC15array5Array4pushGRP36mizchi6kagura3gfx20DrawTrianglesCommandE(cmds, _M0FP36mizchi6kagura9debugutil18new__line__command(ctx.dst, ctx.shader, sx0, sy0, sx1, sy1, 2, joint_color, 0));
      }
      _tmp$2 = j + 1 | 0;
      continue;
    } else {
  ...
  if (self.grabbed_id >= 0) {
    ...
    _L: {
      ...
      _M0MPC15array5Array4pushGRP36mizchi6kagura3gfx20DrawTrianglesCommandE(cmds, _M0FP36mizchi6kagura9debugutil18new__line__command(ctx.dst, ctx.shader, mx_screen, my_screen, bx_screen, by_screen, 2, _M0FP36mizchi6kagura9debugutil16color__from__hex(16728128), 0));
    }
  }
  return cmds;
}
function _M0FP26mizchi13ragdoll__demo18make__ragdoll__box(id, x, y, hx, hy, mass) {
  return _M0MP36mizchi6kagura9physics2d11RigidBody2D13with__damping(_M0MP36mizchi6kagura9physics2d11RigidBody2D14with__friction(_M0MP36mizchi6kagura9physics2d11RigidBody2D17with__restitution(_M0MP36mizchi6kagura9physics2d11RigidBody2D12new__dynamic(id, _M0MP36mizchi6kagura6vector4Vec23new(x, y), mass, new _M0DTP36mizchi6kagura9physics2d15ColliderShape2D10OBBShape2D(_M0MP36mizchi6kagura6vector4Vec23new(hx, hy), _M0MP36mizchi6kagura6vector4Vec24zero())), 0.2), 0.5), 0.1);
}
function _M0FP26mizchi13ragdoll__demo21make__ragdoll__circle(id, x, y, radius, mass) {
  return _M0MP36mizchi6kagura9physics2d11RigidBody2D13with__damping(_M0MP36mizchi6kagura9physics2d11RigidBody2D14with__friction(_M0MP36mizchi6kagura9physics2d11RigidBody2D17with__restitution(_M0MP36mizchi6kagura9physics2d11RigidBody2D12new__dynamic(id, _M0MP36mizchi6kagura6vector4Vec23new(x, y), mass, new _M0DTP36mizchi6kagura9physics2d15ColliderShape2D11CircleShape(_M0MP36mizchi6kagura6vector4Vec24zero(), radius)), 0.2), 0.5), 0.1);
}
function _M0FP26mizchi13ragdoll__demo14make__revolute(a_id, b_id, anchor_a, anchor_b) {
  return new _M0TP36mizchi6kagura9physics2d15RevoluteJoint2D(a_id, b_id, anchor_a, anchor_b, 8, 0.5);
}
...
function _M0MP26mizchi13ragdoll__demo9DemoState3new() {
  ...
  _M0MP36mizchi6kagura9physics2d14PhysicsWorld2D9add__body(world, _M0MP36mizchi6kagura9physics2d11RigidBody2D11new__static(_M0FP26mizchi13ragdoll__demo10id__ground, _M0MP36mizchi6kagura6vector4Vec23new(0, -5.5), new _M0DTP36mizchi6kagura9physics2d15ColliderShape2D11AABBShape2D(_M0MP36mizchi6kagura6vector4Vec23new(10, 1), _M0MP36mizchi6kagura6vector4Vec24zero())));
  _M0FP26mizchi13ragdoll__demo14build__ragdoll(world);
  return new _M0TP26mizchi13ragdoll__demo9DemoState(world, _M0FP36mizchi6kagura9inpututil18new__input__helper(), 0, -1, 0, 0);
}
function _M0FP26mizchi13ragdoll__demo22find__closest__dynamic(world, mx, my) {
  const best_id = new _M0TPC13ref3RefGiE(-1);
  const best_dist = new _M0TPC13ref3RefGdE(_M0FP26mizchi13ragdoll__demo14grab__distance);
  let _tmp = 0;
  while (true) {
    const i = _tmp;
    if (i < world.bodies.length) {
      const body = _M0MPC15array5Array2atGRP36mizchi6kagura9physics2d11RigidBody2DE(world.bodies, i);
      if (!_M0MP36mizchi6kagura9physics2d11RigidBody2D11is__dynamic(body)) {
        _tmp = i + 1 | 0;
        continue;
      }
