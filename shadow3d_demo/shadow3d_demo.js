...
function _M0TP36mizchi6kagura8shadow3d12ShadowConfig(param0, param1, param2, param3, param4, param5, param6, param7) {
  this.map_size = param0;
  this.half_extent = param1;
  this.near = param2;
  this.far = param3;
  this.distance = param4;
  this.center = param5;
  this.bias = param6;
  this.pcf_texel_size = param7;
}
function _M0TP36mizchi6kagura8shadow3d12ShadowCaster(param0, param1) {
  this.mesh = param0;
  this.model_matrix = param1;
}
...
function _M0TP26mizchi14shadow3d__demo11SceneObject(param0, param1) {
  this.mesh = param0;
  this.model_matrix = param1;
}
...
function _M0TP26mizchi14shadow3d__demo9DemoState(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10) {
  this.cube_mesh = param0;
  this.sphere_mesh = param1;
  this.ground_mesh = param2;
  this.shadow_map = param3;
  this.depth_shader = param4;
  this.lit_shader = param5;
  this.shadow_config = param6;
  this.camera = param7;
  this.lighting = param8;
  this.input = param9;
  this.frame = param10;
}
...
const _M0FPB32brute__force__find_2econstr_2f97 = 0;
const _M0FPB42boyer__moore__horspool__find_2econstr_2f83 = 0;
...
const _M0FPC14math34trig__reduce_2etwo__over__pi_2f301 = [0, 683565275, -1819212470, 2131351028, 2102212464, 920167782, 1326507024, 0];
...
function _M0MPC15array5Array2atGRP26mizchi14shadow3d__demo11SceneObjectE(self, index) {
...
function _M0FPB28boyer__moore__horspool__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FPB42boyer__moore__horspool__find_2econstr_2f83;
  }
}
function _M0FPB18brute__force__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FPB32brute__force__find_2econstr_2f97;
  }
}
...
function _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(self, value) {
...
function _M0MPC15array5Array6filterGRP26mizchi5audio5VoiceE(self, f) {
  ...
  while (true) {
    ...
    if (_ < _bind) {
      const v = self[_];
      if (f(v)) {
        _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(arr, v);
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
...
function _M0FPC14math12trig__reduce(x, switch_over) {
  ...
  const ind = exp >> 5;
  exp = exp & 31;
  let hi = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f301, ind);
  let mi = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f301, ind + 1 | 0);
  let lo = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f301, ind + 2 | 0);
  const tp = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f301, ind + 3 | 0);
  if (exp > 0) {
...
function _M0MP36mizchi6kagura6math3d4Mat411rotation__y(angle_rad) {
  const c = _M0FPC14math3cos(angle_rad);
  const s = _M0FPC14math3sin(angle_rad);
  const m = _M0MP36mizchi6kagura6math3d4Mat48identity();
  const _tmp = m.elements;
  $bound_check(_tmp, 0);
  _tmp[0] = c;
...
function _M0FP36mizchi6kagura9inpututil27update__touch__input__state(state, snapshot) {
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(next_durations, new _M0TP36mizchi6kagura9inpututil18TouchDurationEntry(id, duration));
      _tmp$3 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi6kagura9inpututil25update__key__input__state(state, snapshot) {
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(next_durations, new _M0TP36mizchi6kagura9inpututil16KeyDurationEntry(key, duration));
      _tmp$3 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi6kagura9inpututil27update__mouse__input__state(state, snapshot) {
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(next_durations, new _M0TP36mizchi6kagura9inpututil24MouseButtonDurationEntry(button, duration));
      _tmp$3 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi6kagura8shadow3d35shadow__depth__resource__cache__key(shadow_map, shader, mesh, uniform_dwords) {
  const values = [shadow_map.id, shadow_map.width, shadow_map.height, shader.id, mesh.vertex_data.length, mesh.indices.length, uniform_dwords.length];
  const _bind = mesh.vertex_data;
  const _bind$2 = _bind.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
    if (_ < _bind$2) {
      const vertex = _bind[_];
      _M0MPC15array5Array4pushGiE(values, _M0FP36mizchi6kagura3gfx21double__to__f32__bits(vertex));
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    ...
    if (_ < _bind$4) {
      ...
      _M0MPC15array5Array4pushGiE(values, index);
      _tmp$2 = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  const _bind$5 = uniform_dwords.length;
  let _tmp$3 = 0;
  while (true) {
    const _ = _tmp$3;
    if (_ < _bind$5) {
  ...
  return _M0FP36mizchi6kagura3gfx27build__resource__cache__key(1397245008, values);
}
function _M0MP36mizchi6kagura8shadow3d12ShadowConfig3new(map_size, half_extent, near, far, distance, center, bias) {
  return new _M0TP36mizchi6kagura8shadow3d12ShadowConfig(map_size, half_extent, near, far, distance, center, bias, 1 / (map_size + 0));
}
...
function _M0FP36mizchi6kagura8shadow3d30shadow__depth__uniform__dwords(model, light_vp) {
  ...
  while (true) {
    ...
    if (i < _bind$2) {
      ...
      _M0MPC15array5Array4pushGiE(dwords, _M0FP36mizchi6kagura8shadow3d3f32(_tmp$2[i]));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi6kagura8shadow3d27new__shadow__depth__command(shadow_map, shader, mesh, model, light_vp) {
  ...
  return _M0FP36mizchi6kagura3gfx37new__draw__triangles__command_2einner(shadow_map, shader, [dst_region], 0, 0, 0, _M0FP36mizchi6kagura3gfx22blend__mode__from__int(0), mesh.vertex_data, mesh.indices, [], uniform_dwords, 1, _M0FP36mizchi6kagura8shadow3d35shadow__depth__resource__cache__key(shadow_map, shader, mesh, uniform_dwords));
}
function _M0MP36mizchi6kagura8shadow3d12ShadowCaster3new(mesh, model_matrix) {
  return new _M0TP36mizchi6kagura8shadow3d12ShadowCaster(mesh, model_matrix);
}
function _M0FP36mizchi6kagura8shadow3d29shadow__depth__pass__commands(shadow_map, depth_shader, casters, lighting, config) {
  ...
  const commands = [];
  const _bind = 0;
  const _bind$2 = casters.length;
  let _tmp = _bind;
  while (true) {
    const i = _tmp;
    if (i < _bind$2) {
      const caster = _M0MPC15array5Array2atGRP26mizchi14shadow3d__demo11SceneObjectE(casters, i);
      _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(commands, _M0FP36mizchi6kagura8shadow3d27new__shadow__depth__command(shadow_map, depth_shader, caster.mesh, caster.model_matrix, light_vp));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi6kagura8shadow3d28shadow__lit__uniform__dwords(model, view_projection, lighting, light_vp, config) {
  ...
  while (true) {
    ...
    if (i < _bind$4) {
      ...
      _M0MPC15array5Array4pushGiE(dwords, _M0FP36mizchi6kagura8shadow3d3f32(_tmp$3[i]));
      _tmp$2 = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  const _bind$5 = 0;
  const _bind$6 = normal_dw.length;
  let _tmp$3 = _bind$5;
  while (true) {
    const i = _tmp$3;
    if (i < _bind$6) {
  ...
  while (true) {
    ...
    if (i < _bind$10) {
      ...
      _M0MPC15array5Array4pushGiE(dwords, _M0FP36mizchi6kagura8shadow3d3f32(_tmp$6[i]));
      _tmp$5 = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  _M0MPC15array5Array4pushGiE(dwords, _M0FP36mizchi6kagura8shadow3d3f32(config.bias));
  _M0MPC15array5Array4pushGiE(dwords, _M0FP36mizchi6kagura8shadow3d3f32(config.pcf_texel_size));
  _M0MPC15array5Array4pushGiE(dwords, _M0FP36mizchi6kagura8shadow3d3f32(0));
  _M0MPC15array5Array4pushGiE(dwords, _M0FP36mizchi6kagura8shadow3d3f32(0));
  return dwords;
}
  ...
  if (active) {
    ...
    while (true) {
      ...
      if (i < gamepad_count) {
        ...
        _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(gamepads, _M0FP36mizchi6kagura4core22new__gamepad__snapshot(_M0FP26mizchi19web__runtime__hooks26js__input__gamepad__id__at(i), axes, pressed_buttons));
        _tmp$4 = i + 1 | 0;
        continue;
      } else {
        break;
...
function _M0MP26mizchi14shadow3d__demo9DemoState14build__objects(self) {
  ...
  _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(objects, new _M0TP26mizchi14shadow3d__demo11SceneObject(self.ground_mesh, ground_model));
  const cube1_model = _M0MP36mizchi6kagura6math3d4Mat411translation(-2, 0.5, 0);
  _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(objects, new _M0TP26mizchi14shadow3d__demo11SceneObject(self.cube_mesh, cube1_model));
  ...
  _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(objects, new _M0TP26mizchi14shadow3d__demo11SceneObject(self.cube_mesh, cube2_model));
  ...
  _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(objects, new _M0TP26mizchi14shadow3d__demo11SceneObject(self.cube_mesh, cube3_model));
  const sphere_model = _M0MP36mizchi6kagura6math3d4Mat411translation(1, 0.6, 1.5);
  _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(objects, new _M0TP26mizchi14shadow3d__demo11SceneObject(self.sphere_mesh, sphere_model));
  return objects;
}
function _M0MP26mizchi14shadow3d__demo9DemoState4draw(self, ctx) {
  ...
  while (true) {
    const i = _tmp;
    if (i < _bind$2) {
      _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(casters, _M0MP36mizchi6kagura8shadow3d12ShadowCaster3new(_M0MPC15array5Array2atGRP26mizchi14shadow3d__demo11SceneObjectE(objects, i).mesh, _M0MPC15array5Array2atGRP26mizchi14shadow3d__demo11SceneObjectE(objects, i).model_matrix));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  const lit_cmds = [];
  const _bind$3 = 0;
  const _bind$4 = objects.length;
  let _tmp$2 = _bind$3;
  while (true) {
    const i = _tmp$2;
    if (i < _bind$4) {
      const obj = _M0MPC15array5Array2atGRP26mizchi14shadow3d__demo11SceneObjectE(objects, i);
      ...
      _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(lit_cmds, cmd);
      _tmp$2 = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  const all_cmds = [];
  const _bind$5 = depth_cmds.length;
  let _tmp$3 = 0;
  while (true) {
    const _ = _tmp$3;
    if (_ < _bind$5) {
      const cmd = depth_cmds[_];
      _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(all_cmds, cmd);
      _tmp$3 = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  const _bind$6 = lit_cmds.length;
  let _tmp$4 = 0;
  while (true) {
    const _ = _tmp$4;
    if (_ < _bind$6) {
      const cmd = lit_cmds[_];
      _M0MPC15array5Array4pushGRP36mizchi6kagura8shadow3d12ShadowCasterE(all_cmds, cmd);
      _tmp$4 = _ + 1 | 0;
      continue;
    } else {
...
function _M0MP26mizchi14shadow3d__demo9DemoState3new() {
  ...
  const lighting = _M0MP36mizchi6kagura7light3d19LightingEnvironment3new(_M0MP36mizchi6kagura7light3d16DirectionalLight3new(_M0MP36mizchi6kagura6math3d4Vec33new(-0.4, -1, -0.6), _M0MP36mizchi6kagura6math3d4Vec33new(1, 1, 0.95), 0.9), _M0MP36mizchi6kagura7light3d12AmbientLight3new(_M0MP36mizchi6kagura6math3d4Vec33new(1, 1, 1), 0.25), _M0DTPC16option6OptionGRPB5ArrayGRP36mizchi6kagura7light3d10PointLightEE4None__, _M0DTPC16option6OptionGRPB5ArrayGRP36mizchi6kagura7light3d9SpotLightEE4None__);
  return new _M0TP26mizchi14shadow3d__demo9DemoState(_M0MP36mizchi6kagura6mesh3d6Mesh3D4cube(1), _M0MP36mizchi6kagura6mesh3d6Mesh3D6sphere(0.6, 8, 6), _M0MP36mizchi6kagura6mesh3d6Mesh3D13plane_2einner(20, 20, 4), shadow_map, depth_shader, lit_shader, shadow_config, camera, lighting, _M0FP36mizchi6kagura9inpututil18new__input__helper(), 0);
}
...
(() => {
  ...
  }, (ctx) => _M0MP26mizchi14shadow3d__demo9DemoState4draw(state, ctx), undefined, undefined, undefined, 735, _M0FP26mizchi14shadow3d__demo9screen__w, _M0FP26mizchi14shadow3d__demo9screen__h, "Shadow Mapping Demo", "#app");
})();
