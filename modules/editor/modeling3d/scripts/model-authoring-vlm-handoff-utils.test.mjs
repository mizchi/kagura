...
test("resolveExampleReviewConfig exposes dragon organic review metadata", () => {
  ...
  assert.equal(config.targetFile, "modules/editor/modeling3d/examples/dragon_authoring/src/model_doc.mbt");
...
test("resolveExampleReviewConfig maps authoring examples to review profiles", () => {
  assert.deepEqual(resolveExampleReviewConfig("model_authoring"), {
    targetFile: "modules/editor/modeling3d/examples/model_authoring/src/model_doc.mbt",
  ...
  assert.deepEqual(resolveExampleReviewConfig("chair_authoring"), {
    targetFile: "modules/editor/modeling3d/examples/chair_authoring/src/model_doc.mbt",
  ...
  assert.deepEqual(resolveExampleReviewConfig("shelf_authoring"), {
    targetFile: "modules/editor/modeling3d/examples/shelf_authoring/src/model_doc.mbt",
    profileId: "hard_surface_prop",
    constraints: [
...
test("buildLiveReviewBundle emits current-state bundle JSON", () => {
  ...
  assert.equal(parsed.target_file, "modules/editor/modeling3d/examples/frog_authoring/src/model_doc.mbt");
