...
test("buildVlmReviewRequest attaches screenshot, bundle, and prompt as multimodal inputs", () => {
  ...
  const bundleText =
    '{"target_file":"modules/editor/modeling3d/examples/model_authoring/src/model_doc.mbt","patch_payload":{"manual_issue_details":[]}}';
...
test("buildVlmReviewRequest accepts multi-view screenshots", () => {
  ...
  const bundleText =
    JSON.stringify({
      target_file: "modules/editor/modeling3d/examples/frog_authoring/src/model_doc.mbt",
...
test("buildVlmReviewInstructions falls back to legacy target_file inference", () => {
  const instructions = buildVlmReviewInstructions({
    ...
    bundleText:
      '{"target_file":"modules/editor/modeling3d/examples/chair_authoring/src/model_doc.mbt","patch_payload":{"manual_issue_details":[]}}',
  });
...
test("buildVlmReviewInstructions infers hard-surface rubric for shelf target files", () => {
  const instructions = buildVlmReviewInstructions({
    ...
    bundleText:
      '{"target_file":"modules/editor/modeling3d/examples/shelf_authoring/src/model_doc.mbt","patch_payload":{"manual_issue_details":[]}}',
  });
...
test("extractStructuredReview parses top-level output_text JSON", () => {
  const expected = {
    target_file: "modules/editor/modeling3d/examples/model_authoring/src/model_doc.mbt",
    ...
    pr_comment_lines: [
      "## Kagura VLM Review",
      "- Target: `modules/editor/modeling3d/examples/model_authoring/src/model_doc.mbt`",
      "- Confidence: `high`",
    ...
    choices: [
      {
        message: {
          content: JSON.stringify({
            target_file: "modules/editor/modeling3d/examples/shelf_authoring/src/model_doc.mbt",
            overall_summary: "summary",
            confidence: "high",
            recommended_actions: [],
            manual_followups: [
