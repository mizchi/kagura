...
const _M0FP311moonbitlang4core7builtin33brute__force__find_2econstr_2f162 = 0;
const _M0FP311moonbitlang4core7builtin43boyer__moore__horspool__find_2econstr_2f148 = 0;
...
const _M0FP311moonbitlang4core4math34trig__reduce_2etwo__over__pi_2f768 = [0, 683565275, -1819212470, 2131351028, 2102212464, 920167782, 1326507024, 0];
...
function _M0FP311moonbitlang4core7builtin28boyer__moore__horspool__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FP311moonbitlang4core7builtin43boyer__moore__horspool__find_2econstr_2f148;
  }
}
function _M0FP311moonbitlang4core7builtin18brute__force__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FP311moonbitlang4core7builtin33brute__force__find_2econstr_2f162;
  }
}
...
function _M0FP311moonbitlang4core4math12trig__reduce(x, switch_over) {
  ...
  const ind = exp >> 5;
  exp = exp & 31;
  let hi = _M0MP311moonbitlang4core5array13ReadOnlyArray2atGjE(_M0FP311moonbitlang4core4math34trig__reduce_2etwo__over__pi_2f768, ind);
  let mi = _M0MP311moonbitlang4core5array13ReadOnlyArray2atGjE(_M0FP311moonbitlang4core4math34trig__reduce_2etwo__over__pi_2f768, ind + 1 | 0);
  let lo = _M0MP311moonbitlang4core5array13ReadOnlyArray2atGjE(_M0FP311moonbitlang4core4math34trig__reduce_2etwo__over__pi_2f768, ind + 2 | 0);
  const tp = _M0MP311moonbitlang4core5array13ReadOnlyArray2atGjE(_M0FP311moonbitlang4core4math34trig__reduce_2etwo__over__pi_2f768, ind + 3 | 0);
  if (exp > 0) {
...
function _M0FP36mizchi6kagura9debugutil18new__line__command(dst, shader, x0, y0, x1, y1, width, color, pipeline_id) {
  ...
  return _M0FP36mizchi6kagura3gfx37new__draw__triangles__command_2einner(dst, shader, [_M0FP36mizchi6kagura3gfx16new__dst__region(_M0MP311moonbitlang4core6double6Double7to__int(min_x), _M0MP311moonbitlang4core6double6Double7to__int(min_y), _M0MP311moonbitlang4core6double6Double7to__int(max_x - min_x + width), _M0MP311moonbitlang4core6double6Double7to__int(max_y - min_y + width), 6)], 0, pipeline_id, 0, _M0FP36mizchi6kagura3gfx22blend__mode__from__int(1), vertices, indices, [], uniform, 1);
}
...
function _M0FP36mizchi6kagura9debugutil26new__simple__draw__command(dst, shader, vertices, indices, color) {
  const uniform = _M0FP36mizchi6kagura9debugutil26color__to__uniform__dwords(color);
  return _M0FP36mizchi6kagura3gfx37new__draw__triangles__command_2einner(dst, shader, [_M0FP36mizchi6kagura3gfx16new__dst__region(0, 0, 0, 0, indices.length)], 0, 0, 0, _M0FP36mizchi6kagura3gfx22blend__mode__from__int(1), vertices, indices, [], uniform, 1);
}
...
(() => {
  ...
  }, (ctx) => _M0MP26mizchi13ragdoll__demo9DemoState4draw(state, ctx), undefined, undefined, 735, _M0FP26mizchi13ragdoll__demo9screen__w, _M0FP26mizchi13ragdoll__demo9screen__h, "Ragdoll Demo", "#app");
})();
