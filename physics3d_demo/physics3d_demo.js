...
function _M0TPB3MapGlRP36mizchi6kagura9physics3d17ContactManifold3DE(param0, param1, param2, param3, param4, param5, param6) {
  this.entries = param0;
  this.size = param1;
...
function _M0TPB5EntryGlRP36mizchi6kagura9physics3d17ContactManifold3DE(param0, param1, param2, param3, param4, param5) {
  this.prev = param0;
  this.next = param1;
  this.psl = param2;
  this.hash = param3;
...
function _M0TP36mizchi6kagura11collision3d4AABB(param0, param1) {
  this.min = param0;
  this.max = param1;
}
...
function _M0TP36mizchi6kagura11collision3d15SpatialHashGrid(param0, param1, param2, param3) {
...
function _M0TP36mizchi6kagura11collision3d15BroadphaseEntry(param0, param1) {
  this.id = param0;
  this.aabb = param1;
}
function _M0TP36mizchi6kagura9physics3d14SolverConfig3D(param0, param1, param2, param3) {
  this.substeps = param0;
  this.velocity_iterations = param1;
  this.contact_hertz = param2;
  this.contact_damping_ratio = param3;
}
function _M0TP36mizchi6kagura9physics3d12PhysicsWorld(param0, param1, param2, param3, param4, param5, param6) {
  this.bodies = param0;
  this.gravity = param1;
  ...
  this.joints_ball = param6;
}
function _M0TPB9ArrayViewGUlRP36mizchi6kagura9physics3d17ContactManifold3DEE(param0, param1, param2) {
  this.buf = param0;
  this.start = param1;
  this.end = param2;
}
...
function _M0TP36mizchi6kagura9physics3d7Contact(param0, param1, param2, param3, param4) {
...
function _M0TPC13ref3RefGRP36mizchi6kagura6math3d4Vec3E(param0) {
  this.val = param0;
}
function _M0TP36mizchi6kagura9physics3d21BallJointConstraint3D(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11) {
  this.idx_a = param0;
  this.idx_b = param1;
  this.r_a = param2;
  this.r_b = param3;
  ...
  this.effective_mass_z = param6;
  this.gamma = param7;
  this.bias_coefficient = param8;
  this.acc_impulse_x = param9;
  this.acc_impulse_y = param10;
  this.acc_impulse_z = param11;
}
function _M0TP36mizchi6kagura9physics3d19ContactConstraint3D(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12) {
  this.idx_a = param0;
  this.idx_b = param1;
  this.contact = param2;
  this.r_a = param3;
  ...
  this.tangent_dir = param7;
  this.gamma = param8;
  this.bias_coefficient = param9;
  this.restitution_bias = param10;
  this.acc_jn = param11;
  this.acc_jt = param12;
}
function _M0TP36mizchi6kagura9physics3d25DistanceJointConstraint3D(param0, param1, param2, param3, param4, param5, param6, param7, param8) {
  this.idx_a = param0;
  this.idx_b = param1;
  this.r_a = param2;
  this.r_b = param3;
...
function _M0TP36mizchi6kagura9physics3d9RigidBody(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18) {
  this.id = param0;
  ...
  this.inv_inertia = param10;
  this.restitution = param11;
  this.friction = param12;
  this.collider = param13;
...
function _M0TPC13ref3RefGRP36mizchi6kagura9physics3d19ContactConstraint3DE(param0) {
  this.val = param0;
}
function _M0TP36mizchi6kagura9physics3d17ContactManifold3D(param0, param1, param2, param3) {
  this.body_a_id = param0;
  this.body_b_id = param1;
  this.normal = param2;
  this.points = param3;
}
function _M0TP36mizchi6kagura9physics3d15ManifoldPoint3D(param0, param1, param2, param3, param4) {
  this.local_a = param0;
  this.local_b = param1;
...
function _M0DTP36mizchi6kagura9physics3d13ColliderShape11SphereShape(param0, param1) {
  this._0 = param0;
  this._1 = param1;
}
_M0DTP36mizchi6kagura9physics3d13ColliderShape11SphereShape.prototype.$tag = 0;
function _M0DTP36mizchi6kagura9physics3d13ColliderShape9AABBShape(param0, param1) {
  this._0 = param0;
  this._1 = param1;
}
_M0DTP36mizchi6kagura9physics3d13ColliderShape9AABBShape.prototype.$tag = 1;
function _M0TP26mizchi15physics3d__demo9DemoState(param0, param1, param2, param3, param4, param5, param6, param7, param8) {
  this.cube_mesh = param0;
  this.sphere_mesh = param1;
  this.ground_mesh = param2;
  this.world = param3;
  this.camera = param4;
  this.lighting = param5;
  this.input = param6;
...
const _M0FPC14math35trig__reduce_2etwo__over__pi_2f1037 = [0, 683565275, -1819212470, 2131351028, 2102212464, 920167782, 1326507024, 0];
...
function _M0MPC15array5Array2atGUdddbEE(self, index) {
...
function _M0MPC15array9ArrayView6lengthGUlRP36mizchi6kagura9physics3d17ContactManifold3DEE(self) {
  return self.end - self.start | 0;
}
...
function _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(self, value) {
...
function _M0MPC16option6Option6unwrapGRPB5EntryGlRP36mizchi6kagura9physics3d17ContactManifold3DEE(self) {
  if (self === undefined) {
    return $panic();
  } else {
    const _Some = self;
...
function _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(self, index, value) {
  const len = self.length;
  if (index >= 0 && index < len) {
    $bound_check(self, index);
    self[index] = value;
...
function _M0MPB3Map11new_2einnerGlRP36mizchi6kagura9physics3d17ContactManifold3DE(capacity) {
  const capacity$2 = _M0MPC13int3Int20next__power__of__two(capacity);
  const _bind = capacity$2 - 1 | 0;
  const _bind$2 = _M0FPB21calc__grow__threshold(capacity$2);
  const _bind$3 = $make_array_len_and_init(capacity$2, undefined);
  const _bind$4 = undefined;
  return new _M0TPB3MapGlRP36mizchi6kagura9physics3d17ContactManifold3DE(_bind$3, 0, capacity$2, _bind, _bind$2, _bind$4, -1);
}
...
function _M0MPB3Map20add__entry__to__tailGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self, idx, entry) {
  ...
  if (_bind === -1) {
    ...
    _M0MPC16option6Option6unwrapGRPB5EntryGlRP36mizchi6kagura9physics3d17ContactManifold3DEE(_tmp[_bind]).next = entry;
  }
  self.tail = idx;
  const _tmp = self.entries;
...
function _M0MPB3Map10set__entryGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self, entry, new_idx) {
  const _tmp = self.entries;
...
function _M0MPB3Map10push__awayGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self, idx, entry) {
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      entry$2.psl = psl;
      _M0MPB3Map10set__entryGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self, entry$2, idx$2);
      return;
    } else {
      const _Some = _bind;
...
function _M0MPB3Map15set__with__hashGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self, key, value, hash) {
  let _tmp = 0;
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      if (self.size >= self.grow_at) {
        _M0MPB3Map4growGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self);
        _tmp = 0;
      ...
      const entry = new _M0TPB5EntryGlRP36mizchi6kagura9physics3d17ContactManifold3DE(_bind$2, _bind$3, psl, hash, key, value);
      _M0MPB3Map20add__entry__to__tailGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self, idx, entry);
      return undefined;
    } else {
      const _Some = _bind;
      const _curr_entry = _Some;
      ...
      if (psl > _curr_entry.psl) {
        ...
        _M0MPB3Map10push__awayGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self, idx, _curr_entry);
        const _bind$2 = self.tail;
        const _bind$3 = undefined;
        const entry = new _M0TPB5EntryGlRP36mizchi6kagura9physics3d17ContactManifold3DE(_bind$2, _bind$3, psl, hash, key, value);
        _M0MPB3Map20add__entry__to__tailGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self, idx, entry);
...
function _M0MPB3Map4growGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self) {
  ...
  while (true) {
    ...
    if (_param === undefined) {
      ...
      const _hash = _x.hash;
      _M0MPB3Map15set__with__hashGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self, _key, _value, _hash);
      _tmp = _next;
      continue;
    }
  }
...
function _M0MPB3Map3setGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self, key, value) {
  _M0MPB3Map15set__with__hashGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self, key, value, _M0IP016_24default__implPB4Hash4hashGlE(key));
}
...
function _M0MPB3Map11from__arrayGlRP36mizchi6kagura9physics3d17ContactManifold3DE(arr) {
  const length = _M0MPC15array9ArrayView6lengthGUlRP36mizchi6kagura9physics3d17ContactManifold3DEE(arr);
  let capacity = _M0MPC13int3Int20next__power__of__two(length);
  if (length > _M0FPB21calc__grow__threshold(capacity)) {
    capacity = Math.imul(capacity, 2) | 0;
  }
  const m = _M0MPB3Map11new_2einnerGlRP36mizchi6kagura9physics3d17ContactManifold3DE(capacity);
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      _M0MPB3Map3setGlRP36mizchi6kagura9physics3d17ContactManifold3DE(m, e._0, e._1);
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MPB3Map3getGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self, key) {
...
function _M0MPB3Map4eachGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self, f) {
  let _tmp = self.head;
  while (true) {
    const _param = _tmp;
    if (_param === undefined) {
...
function _M0MPC15array10FixedArray12fill_2einnerGORPB5EntryGlRP36mizchi6kagura9physics3d17ContactManifold3DEE(self, value, start, end) {
...
function _M0MPB3Map5clearGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self) {
  _M0MPC15array10FixedArray12fill_2einnerGORPB5EntryGlRP36mizchi6kagura9physics3d17ContactManifold3DEE(self.entries, undefined, 0, undefined);
  self.size = 0;
  self.head = undefined;
  self.tail = -1;
}
...
function _M0MPC15array5Array28unsafe__truncate__to__lengthGRP36mizchi6kagura11collision3d15BroadphaseEntryE(self, new_len) {
...
function _M0FPB40fixed__choose__pivot__by_2esort__2_2f882(_env, a, b) {
  const swaps = _env._2;
  const arr = _env._1;
  const cmp = _env._0;
...
function _M0FPB40fixed__choose__pivot__by_2esort__3_2f883(_env, a, b, c) {
  _M0FPB40fixed__choose__pivot__by_2esort__2_2f882(_env, a, b);
  _M0FPB40fixed__choose__pivot__by_2esort__2_2f882(_env, b, c);
  _M0FPB40fixed__choose__pivot__by_2esort__2_2f882(_env, a, b);
}
function _M0FPB24fixed__choose__pivot__byGUiRP36mizchi6kagura7scene3d8Object3DEE(arr, cmp) {
  ...
  if (len >= 8) {
    ...
    if (len > 50) {
      _M0FPB40fixed__choose__pivot__by_2esort__3_2f883(_env, a - 1 | 0, a, a + 1 | 0);
      _M0FPB40fixed__choose__pivot__by_2esort__3_2f883(_env, b - 1 | 0, b, b + 1 | 0);
      _M0FPB40fixed__choose__pivot__by_2esort__3_2f883(_env, c - 1 | 0, c, c + 1 | 0);
    }
    _M0FPB40fixed__choose__pivot__by_2esort__3_2f883(_env, a, b, c);
  }
  if (swaps.val === 12) {
...
function _M0MPC15array5Array5clearGRP36mizchi6kagura11collision3d15BroadphaseEntryE(self) {
  _M0MPC15array5Array28unsafe__truncate__to__lengthGRP36mizchi6kagura11collision3d15BroadphaseEntryE(self, 0);
}
function _M0MPC15array5Array6filterGRP26mizchi5audio5VoiceE(self, f) {
  ...
  while (true) {
    ...
    if (_ < _bind) {
      const v = self[_];
      if (f(v)) {
        _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(arr, v);
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
...
function _M0FPC14math12trig__reduce(x, switch_over) {
  ...
  const ind = exp >> 5;
  exp = exp & 31;
  let hi = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math35trig__reduce_2etwo__over__pi_2f1037, ind);
  let mi = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math35trig__reduce_2etwo__over__pi_2f1037, ind + 1 | 0);
  let lo = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math35trig__reduce_2etwo__over__pi_2f1037, ind + 2 | 0);
  const tp = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math35trig__reduce_2etwo__over__pi_2f1037, ind + 3 | 0);
  if (exp > 0) {
...
function _M0MP36mizchi6kagura6math3d4Vec37unit__x() {
  return new _M0TP36mizchi6kagura6math3d4Vec3(1, 0, 0);
}
...
function _M0MP36mizchi6kagura6math3d4Vec37unit__z() {
  return new _M0TP36mizchi6kagura6math3d4Vec3(0, 0, 1);
}
...
function _M0MP36mizchi6kagura6math3d4Vec36negate(self) {
  return new _M0TP36mizchi6kagura6math3d4Vec3(-self.x, -self.y, -self.z);
}
...
function _M0MP36mizchi6kagura6math3d4Vec33min(self, other) {
  return new _M0TP36mizchi6kagura6math3d4Vec3(_M0FPC13cmp7minimumGdE(self.x, other.x), _M0FPC13cmp7minimumGdE(self.y, other.y), _M0FPC13cmp7minimumGdE(self.z, other.z));
}
function _M0MP36mizchi6kagura6math3d4Vec33max(self, other) {
  return new _M0TP36mizchi6kagura6math3d4Vec3(_M0FPC13cmp7maximumGdE(self.x, other.x), _M0FPC13cmp7maximumGdE(self.y, other.y), _M0FPC13cmp7maximumGdE(self.z, other.z));
}
...
function _M0MP36mizchi6kagura6math3d10Quaternion9normalize(self) {
  ...
  if (len < 1e-12) {
    ...
    const inv = 1 / len;
    return new _M0TP36mizchi6kagura6math3d10Quaternion(self.x * inv, self.y * inv, self.z * inv, self.w * inv);
  }
}
function _M0MP36mizchi6kagura6math3d10Quaternion8multiply(self, other) {
  return new _M0TP36mizchi6kagura6math3d10Quaternion(self.w * other.x + self.x * other.w + self.y * other.z - self.z * other.y, self.w * other.y - self.x * other.z + self.y * other.w + self.z * other.x, self.w * other.z + self.x * other.y - self.y * other.x + self.z * other.w, self.w * other.w - self.x * other.x - self.y * other.y - self.z * other.z);
}
...
function _M0MP36mizchi6kagura11transform3d11Transform3D24from__position__rotation(pos, rot) {
  return new _M0TP36mizchi6kagura11transform3d11Transform3D(pos, rot, _M0MP36mizchi6kagura6math3d4Vec33one());
}
  ...
  while (true) {
    ...
    if (i < bone_count) {
      ...
      while (true) {
        const j = _tmp$2;
        if (j < _bind$3) {
          const _tmp$3 = _M0MPC15array5Array2atGUdddbEE(skinning_matrices, i).elements;
...
function _M0FP36mizchi6kagura9inpututil27update__touch__input__state(state, snapshot) {
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(next_durations, new _M0TP36mizchi6kagura9inpututil18TouchDurationEntry(id, duration));
      _tmp$3 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi6kagura9inpututil25update__key__input__state(state, snapshot) {
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(next_durations, new _M0TP36mizchi6kagura9inpututil16KeyDurationEntry(key, duration));
      _tmp$3 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi6kagura9inpututil27update__mouse__input__state(state, snapshot) {
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(next_durations, new _M0TP36mizchi6kagura9inpututil24MouseButtonDurationEntry(button, duration));
      _tmp$3 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MP36mizchi6kagura11collision3d4AABB3new(min, max) {
  return new _M0TP36mizchi6kagura11collision3d4AABB(min, max);
}
function _M0FP36mizchi6kagura11collision3d9cell__key(cx, cy, cz) {
  const mask = 2097151;
  const x = _M0MPC13int3Int9to__int64(cx & mask);
  const y = _M0MPC13int3Int9to__int64(cy & mask);
  const z = _M0MPC13int3Int9to__int64(cz & mask);
  return _M0IPC15int645Int64PB5BitOr3lor(_M0IPC15int645Int64PB5BitOr3lor(_M0IPC15int645Int64PB3Shl3shl(x, 42), _M0IPC15int645Int64PB3Shl3shl(y, 21)), z);
}
    ...
    while (true) {
      ...
      if (i < bucket.length) {
        ...
        while (true) {
          const j = _tmp$2;
          if (j < bucket.length) {
            const a = _M0MPC15array5Array2atGUdddbEE(self.entries, _M0MPC15array5Array2atGiE(bucket, i));
            const b = _M0MPC15array5Array2atGUdddbEE(self.entries, _M0MPC15array5Array2atGiE(bucket, j));
            ...
            if (_bind$2 === -1) {
              ...
              if (_M0MP36mizchi6kagura11collision3d4AABB16intersects__aabb(a.aabb, b.aabb)) {
                _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(result, { _0: min_id, _1: max_id });
              }
            }
            _tmp$2 = j + 1 | 0;
            continue;
...
function _M0MP36mizchi6kagura11collision3d15SpatialHashGrid3new(cell_size) {
  ...
  const _bind = [];
  return new _M0TP36mizchi6kagura11collision3d15SpatialHashGrid(cell_size, _tmp, _M0MPB3Map11from__arrayGlRPB5ArrayGiEE(new _M0TPB9ArrayViewGUlRPB5ArrayGiEEE(_bind, 0, 0)), []);
}
function _M0MP36mizchi6kagura11collision3d15SpatialHashGrid5clear(self) {
  _M0MPB3Map5clearGlRPB5ArrayGiEE(self.cells);
  _M0MPC15array5Array5clearGRP36mizchi6kagura11collision3d15BroadphaseEntryE(self.entries);
}
function _M0MP36mizchi6kagura11collision3d15SpatialHashGrid6insert(self, id, aabb) {
  const idx = self.entries.length;
  _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(self.entries, new _M0TP36mizchi6kagura11collision3d15BroadphaseEntry(id, aabb));
...
function _M0MP36mizchi6kagura9physics3d14SolverConfig3D7default() {
  return new _M0TP36mizchi6kagura9physics3d14SolverConfig3D(4, 1, 30, 1);
}
function _M0MP36mizchi6kagura9physics3d12PhysicsWorld11new_2einner(gravity, broadphase_cell_size, solver_config) {
  ...
  const _bind = [];
  return new _M0TP36mizchi6kagura9physics3d12PhysicsWorld(_tmp, gravity, _tmp$2, solver_config, _M0MPB3Map11from__arrayGlRP36mizchi6kagura9physics3d17ContactManifold3DE(new _M0TPB9ArrayViewGUlRP36mizchi6kagura9physics3d17ContactManifold3DEE(_bind, 0, 0)), [], []);
}
...
function _M0MP36mizchi6kagura9physics3d12PhysicsWorld9add__body(self, body) {
  _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(self.bodies, body);
}
...
function _M0FP36mizchi6kagura9physics3d19sweep__sphere__aabb(sphere_pos, sphere_vel, sphere_radius, aabb_min, aabb_max) {
  ...
  if (Math.abs(sphere_vel.x) < 1e-12) {
    ...
    const t1 = new _M0TPC13ref3RefGdE((expanded_min.x - sphere_pos.x) * inv_d);
    const t2 = new _M0TPC13ref3RefGdE((expanded_max.x - sphere_pos.x) * inv_d);
    if (t1.val > t2.val) {
      const tmp = t1.val;
      t1.val = t2.val;
      t2.val = tmp;
  ...
  if (Math.abs(sphere_vel.y) < 1e-12) {
    ...
    const t1 = new _M0TPC13ref3RefGdE((expanded_min.y - sphere_pos.y) * inv_d);
    const t2 = new _M0TPC13ref3RefGdE((expanded_max.y - sphere_pos.y) * inv_d);
    if (t1.val > t2.val) {
      const tmp = t1.val;
      t1.val = t2.val;
      t2.val = tmp;
  ...
  if (Math.abs(sphere_vel.z) < 1e-12) {
    ...
    const t1 = new _M0TPC13ref3RefGdE((expanded_min.z - sphere_pos.z) * inv_d);
    const t2 = new _M0TPC13ref3RefGdE((expanded_max.z - sphere_pos.z) * inv_d);
    if (t1.val > t2.val) {
      const tmp = t1.val;
      t1.val = t2.val;
      t2.val = tmp;
...
function _M0FP36mizchi6kagura9physics3d18ccd__sweep__body3d(bullet_idx, bodies, dt) {
  const bullet = _M0MPC15array5Array2atGUdddbEE(bodies, bullet_idx);
  ...
  while (true) {
    ...
    if (i < bodies.length) {
      if (i === bullet_idx) {
        ...
        const other = _M0MPC15array5Array2atGUdddbEE(bodies, i);
...
function _M0FP36mizchi6kagura9physics3d10aabb__aabb(a, he_a, off_a, b, he_b, off_b) {
  ...
  return new _M0TP36mizchi6kagura9physics3d7Contact(a.id, b.id, normal, penetration, contact_point);
}
function _M0FP36mizchi6kagura9physics3d12sphere__aabb(sphere_body, sphere_off, sphere_r, box_body, box_he, box_off, swapped) {
  ...
  if (_M0MP36mizchi6kagura11collision3d4AABB15contains__point(box_aabb, sphere_center)) {
    ...
    const min_dist = new _M0TPC13ref3RefGdE(dx_neg);
    const face_outward = new _M0TPC13ref3RefGRP36mizchi6kagura6math3d4Vec3E(_M0MP36mizchi6kagura6math3d4Vec33new(-1, 0, 0));
    ...
    return swapped ? new _M0TP36mizchi6kagura9physics3d7Contact(box_body.id, sphere_body.id, face_outward.val, penetration, contact_point) : new _M0TP36mizchi6kagura9physics3d7Contact(sphere_body.id, box_body.id, _M0MP36mizchi6kagura6math3d4Vec36negate(face_outward.val), penetration, contact_point);
  } else {
    ...
    return swapped ? new _M0TP36mizchi6kagura9physics3d7Contact(box_body.id, sphere_body.id, normal, penetration, closest) : new _M0TP36mizchi6kagura9physics3d7Contact(sphere_body.id, box_body.id, _M0MP36mizchi6kagura6math3d4Vec36negate(normal), penetration, closest);
  }
}
...
function _M0FP36mizchi6kagura9physics3d19find__body__index3d(bodies, id) {
  ...
  while (true) {
    const i = _tmp;
    if (i < bodies.length) {
      if (_M0MPC15array5Array2atGUdddbEE(bodies, i).id === id) {
        return i;
      }
      _tmp = i + 1 | 0;
      continue;
...
function _M0FP36mizchi6kagura9physics3d25precompute__ball__joint3d(joint, bodies, sub_dt) {
  ...
  const a = _M0MPC15array5Array2atGUdddbEE(bodies, idx_a);
  const b = _M0MPC15array5Array2atGUdddbEE(bodies, idx_b);
  ...
  return new _M0TP36mizchi6kagura9physics3d21BallJointConstraint3D(idx_a, idx_b, r_a, r_b, eff_x, eff_y, eff_z, gamma, beta, 0, 0, 0);
}
function _M0FP36mizchi6kagura9physics3d24precompute__constraint3d(a, b, idx_a, idx_b, contact, hertz, damping_ratio, sub_dt) {
  ...
  return new _M0TP36mizchi6kagura9physics3d19ContactConstraint3D(idx_a, idx_b, contact, r_a, r_b, normal_mass, tangent_mass, tangent, gamma, beta, restitution_bias, 0, 0);
}
function _M0FP36mizchi6kagura9physics3d29precompute__distance__joint3d(joint, bodies, sub_dt) {
  ...
  return new _M0TP36mizchi6kagura9physics3d25DistanceJointConstraint3D(idx_a, idx_b, r_a, r_b, axis, effective_mass, gamma, beta, 0);
}
function _M0FP36mizchi6kagura9physics3d20solve__ball__joint3d(constraints, ci, bodies) {
  const c = _M0MPC15array5Array2atGUdddbEE(constraints, ci);
  const a = _M0MPC15array5Array2atGUdddbEE(bodies, c.idx_a);
  const b = _M0MPC15array5Array2atGUdddbEE(bodies, c.idx_b);
  ...
  if (Math.abs(dx) > 1e-15 || (Math.abs(dy) > 1e-15 || Math.abs(dz) > 1e-15)) {
    ...
    _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(bodies, c.idx_a, new _M0TP36mizchi6kagura9physics3d9RigidBody(a.id, a.body_type, a.position, _M0MP36mizchi6kagura6math3d4Vec33sub(a.velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(impulse, a.inv_mass)), a.force, a.rotation, _M0MP36mizchi6kagura6math3d4Vec33sub(a.angular_velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(angular_a, a.inv_inertia)), a.torque, a.mass, a.inv_mass, a.inv_inertia, a.restitution, a.friction, a.collider, a.linear_damping, a.angular_damping, a.is_sleeping, a.sleep_timer, a.is_bullet));
    _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(bodies, c.idx_b, new _M0TP36mizchi6kagura9physics3d9RigidBody(b.id, b.body_type, b.position, _M0MP36mizchi6kagura6math3d4Vec33add(b.velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(impulse, b.inv_mass)), b.force, b.rotation, _M0MP36mizchi6kagura6math3d4Vec33add(b.angular_velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(angular_b, b.inv_inertia)), b.torque, b.mass, b.inv_mass, b.inv_inertia, b.restitution, b.friction, b.collider, b.linear_damping, b.angular_damping, b.is_sleeping, b.sleep_timer, b.is_bullet));
  }
  _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(constraints, ci, new _M0TP36mizchi6kagura9physics3d21BallJointConstraint3D(c.idx_a, c.idx_b, c.r_a, c.r_b, c.effective_mass_x, c.effective_mass_y, c.effective_mass_z, c.gamma, c.bias_coefficient, new_ax, new_ay, new_az));
}
...
function _M0FP36mizchi6kagura9physics3d19solve__constraint3d(constraints, ci, bodies) {
  ...
  if (Math.abs(delta_jn) > 1e-15) {
    ...
    _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(bodies, c.idx_a, new _M0TP36mizchi6kagura9physics3d9RigidBody(a.id, a.body_type, a.position, _M0MP36mizchi6kagura6math3d4Vec33add(a.velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(impulse_n, a.inv_mass)), a.force, a.rotation, _M0FP36mizchi6kagura9physics3d19clamp__angular__vec(_M0MP36mizchi6kagura6math3d4Vec33add(a.angular_velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(r_a_cross_n, delta_jn * a.inv_inertia))), a.torque, a.mass, a.inv_mass, a.inv_inertia, a.restitution, a.friction, a.collider, a.linear_damping, a.angular_damping, a.is_sleeping, a.sleep_timer, a.is_bullet));
    _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(bodies, c.idx_b, new _M0TP36mizchi6kagura9physics3d9RigidBody(b.id, b.body_type, b.position, _M0MP36mizchi6kagura6math3d4Vec33sub(b.velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(impulse_n, b.inv_mass)), b.force, b.rotation, _M0FP36mizchi6kagura9physics3d19clamp__angular__vec(_M0MP36mizchi6kagura6math3d4Vec33sub(b.angular_velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(r_b_cross_n, delta_jn * b.inv_inertia))), b.torque, b.mass, b.inv_mass, b.inv_inertia, b.restitution, b.friction, b.collider, b.linear_damping, b.angular_damping, b.is_sleeping, b.sleep_timer, b.is_bullet));
  }
  const a2 = _M0MPC15array5Array2atGUdddbEE(bodies, c.idx_a);
  const b2 = _M0MPC15array5Array2atGUdddbEE(bodies, c.idx_b);
  ...
  if (Math.abs(v_t) > 1e-08) {
    ...
    if (Math.abs(delta_jt) > 1e-15) {
      ...
      _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(bodies, c.idx_a, new _M0TP36mizchi6kagura9physics3d9RigidBody(a2.id, a2.body_type, a2.position, _M0MP36mizchi6kagura6math3d4Vec33add(a2.velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(impulse_t, a2.inv_mass)), a2.force, a2.rotation, _M0FP36mizchi6kagura9physics3d19clamp__angular__vec(_M0MP36mizchi6kagura6math3d4Vec33add(a2.angular_velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(r_a_cross_t, delta_jt * a2.inv_inertia))), a2.torque, a2.mass, a2.inv_mass, a2.inv_inertia, a2.restitution, a2.friction, a2.collider, a2.linear_damping, a2.angular_damping, a2.is_sleeping, a2.sleep_timer, a2.is_bullet));
      _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(bodies, c.idx_b, new _M0TP36mizchi6kagura9physics3d9RigidBody(b2.id, b2.body_type, b2.position, _M0MP36mizchi6kagura6math3d4Vec33sub(b2.velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(impulse_t, b2.inv_mass)), b2.force, b2.rotation, _M0FP36mizchi6kagura9physics3d19clamp__angular__vec(_M0MP36mizchi6kagura6math3d4Vec33sub(b2.angular_velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(r_b_cross_t, delta_jt * b2.inv_inertia))), b2.torque, b2.mass, b2.inv_mass, b2.inv_inertia, b2.restitution, b2.friction, b2.collider, b2.linear_damping, b2.angular_damping, b2.is_sleeping, b2.sleep_timer, b2.is_bullet));
    }
  }
  _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(constraints, ci, new _M0TP36mizchi6kagura9physics3d19ContactConstraint3D(c.idx_a, c.idx_b, c.contact, c.r_a, c.r_b, c.normal_mass, c.tangent_mass, c.tangent_dir, c.gamma, c.bias_coefficient, c.restitution_bias, cur_acc_jn, cur_acc_jt.val));
}
function _M0FP36mizchi6kagura9physics3d24solve__distance__joint3d(constraints, ci, bodies, joint) {
  ...
  if (Math.abs(delta_impulse) > 1e-15) {
    ...
    _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(bodies, c.idx_a, new _M0TP36mizchi6kagura9physics3d9RigidBody(a.id, a.body_type, a.position, _M0MP36mizchi6kagura6math3d4Vec33sub(a.velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(impulse, a.inv_mass)), a.force, a.rotation, _M0MP36mizchi6kagura6math3d4Vec33sub(a.angular_velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(r_a_cross, delta_impulse * a.inv_inertia)), a.torque, a.mass, a.inv_mass, a.inv_inertia, a.restitution, a.friction, a.collider, a.linear_damping, a.angular_damping, a.is_sleeping, a.sleep_timer, a.is_bullet));
    _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(bodies, c.idx_b, new _M0TP36mizchi6kagura9physics3d9RigidBody(b.id, b.body_type, b.position, _M0MP36mizchi6kagura6math3d4Vec33add(b.velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(impulse, b.inv_mass)), b.force, b.rotation, _M0MP36mizchi6kagura6math3d4Vec33add(b.angular_velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(r_b_cross, delta_impulse * b.inv_inertia)), b.torque, b.mass, b.inv_mass, b.inv_inertia, b.restitution, b.friction, b.collider, b.linear_damping, b.angular_damping, b.is_sleeping, b.sleep_timer, b.is_bullet));
  }
  _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(constraints, ci, new _M0TP36mizchi6kagura9physics3d25DistanceJointConstraint3D(c.idx_a, c.idx_b, c.r_a, c.r_b, c.axis, c.effective_mass, c.gamma, c.bias_coefficient, new_acc));
}
...
function _M0MP36mizchi6kagura9physics3d12PhysicsWorld4step(self, dt) {
  ...
  while (true) {
    ...
    if (i < self.bodies.length) {
      _M0MP36mizchi6kagura11collision3d15SpatialHashGrid6insert(self.broadphase, i, _M0MP36mizchi6kagura9physics3d9RigidBody11world__aabb(_M0MPC15array5Array2atGUdddbEE(self.bodies, i)));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    ...
    if (p < pairs.length) {
      ...
      let idx_b;
      _L: {
        const _bind = _M0MPC15array5Array2atGUdddbEE(pairs, p);
      ...
      const body_a = _M0MPC15array5Array2atGUdddbEE(self.bodies, idx_a);
      const body_b = _M0MPC15array5Array2atGUdddbEE(self.bodies, idx_b);
      if (body_a.inv_mass >= 1e-12 || body_b.inv_mass >= 1e-12) {
        ...
        _L$2: {
          ...
          _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(raw_contacts, { _0: idx_a, _1: idx_b, _2: contact });
        }
      }
      _tmp$2 = p + 1 | 0;
      continue;
  ...
  const constraints = [];
  const _bind = [];
  const new_cache = _M0MPB3Map11from__arrayGlRP36mizchi6kagura9physics3d17ContactManifold3DE(new _M0TPB9ArrayViewGUlRP36mizchi6kagura9physics3d17ContactManifold3DEE(_bind, 0, 0));
  let _tmp$3 = 0;
  while (true) {
    const c = _tmp$3;
    if (c < raw_contacts.length) {
      ...
      let contact;
      _L: {
        const _bind$2 = _M0MPC15array5Array2atGUdddbEE(raw_contacts, c);
      ...
      const body_a = _M0MPC15array5Array2atGUdddbEE(self.bodies, idx_a);
      const body_b = _M0MPC15array5Array2atGUdddbEE(self.bodies, idx_b);
      const constraint = new _M0TPC13ref3RefGRP36mizchi6kagura9physics3d19ContactConstraint3DE(_M0FP36mizchi6kagura9physics3d24precompute__constraint3d(body_a, body_b, idx_a, idx_b, contact, config.contact_hertz, config.contact_damping_ratio, sub_dt));
      const pair_key = _M0FP36mizchi6kagura9physics3d20contact__pair__key3d(body_a.id, body_b.id);
      let cached;
      _L$2: {
        _L$3: {
          const _bind$2 = _M0MPB3Map3getGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self.contact_cache, pair_key);
        ...
        if (_M0MP36mizchi6kagura6math3d4Vec33dot(cached.normal, contact.normal) > 0.9) {
          if (cached.points.length > 0) {
            const pt = _M0MPC15array5Array2atGUdddbEE(cached.points, 0);
            const warm_factor = 0.8;
            const _tmp$4 = constraint.val;
            constraint.val = new _M0TP36mizchi6kagura9physics3d19ContactConstraint3D(_tmp$4.idx_a, _tmp$4.idx_b, _tmp$4.contact, _tmp$4.r_a, _tmp$4.r_b, _tmp$4.normal_mass, _tmp$4.tangent_mass, _tmp$4.tangent_dir, _tmp$4.gamma, _tmp$4.bias_coefficient, _tmp$4.restitution_bias, pt.normal_impulse * warm_factor, pt.tangent_impulse * warm_factor);
            const n = contact.normal;
            ...
            if (Math.abs(jn) > 1e-15 || Math.abs(jt) > 1e-15) {
              ...
              const _tmp$6 = _M0MPC15array5Array2atGUdddbEE(self.bodies, idx_a);
              _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(_tmp$5, idx_a, new _M0TP36mizchi6kagura9physics3d9RigidBody(_tmp$6.id, _tmp$6.body_type, _tmp$6.position, _M0MP36mizchi6kagura6math3d4Vec33add(_M0MPC15array5Array2atGUdddbEE(self.bodies, idx_a).velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(impulse, body_a.inv_mass)), _tmp$6.force, _tmp$6.rotation, _tmp$6.angular_velocity, _tmp$6.torque, _tmp$6.mass, _tmp$6.inv_mass, _tmp$6.inv_inertia, _tmp$6.restitution, _tmp$6.friction, _tmp$6.collider, _tmp$6.linear_damping, _tmp$6.angular_damping, _tmp$6.is_sleeping, _tmp$6.sleep_timer, _tmp$6.is_bullet));
              const _tmp$7 = self.bodies;
              const _tmp$8 = _M0MPC15array5Array2atGUdddbEE(self.bodies, idx_b);
              _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(_tmp$7, idx_b, new _M0TP36mizchi6kagura9physics3d9RigidBody(_tmp$8.id, _tmp$8.body_type, _tmp$8.position, _M0MP36mizchi6kagura6math3d4Vec33sub(_M0MPC15array5Array2atGUdddbEE(self.bodies, idx_b).velocity, _M0MP36mizchi6kagura6math3d4Vec35scale(impulse, body_b.inv_mass)), _tmp$8.force, _tmp$8.rotation, _tmp$8.angular_velocity, _tmp$8.torque, _tmp$8.mass, _tmp$8.inv_mass, _tmp$8.inv_inertia, _tmp$8.restitution, _tmp$8.friction, _tmp$8.collider, _tmp$8.linear_damping, _tmp$8.angular_damping, _tmp$8.is_sleeping, _tmp$8.sleep_timer, _tmp$8.is_bullet));
            }
          }
        }
      }
      _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(constraints, constraint.val);
      _tmp$3 = c + 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    ...
    if (j < self.joints_distance.length) {
      ...
      _L: {
        _L$2: {
          const _bind$2 = _M0FP36mizchi6kagura9physics3d29precompute__distance__joint3d(_M0MPC15array5Array2atGUdddbEE(self.joints_distance, j), self.bodies, sub_dt);
          if (_bind$2 === undefined) {
          } else {
            const _Some = _bind$2;
            const _c = _Some;
        ...
        _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(dist_constraints, c);
      }
      _tmp$4 = j + 1 | 0;
      continue;
    } else {
  ...
  while (true) {
    ...
    if (j < self.joints_ball.length) {
      ...
      _L: {
        _L$2: {
          const _bind$2 = _M0FP36mizchi6kagura9physics3d25precompute__ball__joint3d(_M0MPC15array5Array2atGUdddbEE(self.joints_ball, j), self.bodies, sub_dt);
          if (_bind$2 === undefined) {
          } else {
            const _Some = _bind$2;
            const _c = _Some;
        ...
        _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(ball_constraints, c);
      }
      _tmp$5 = j + 1 | 0;
      continue;
    } else {
  ...
  while (true) {
    ...
    if (_s < substeps) {
      ...
      while (true) {
        const i = _tmp$7;
        if (i < self.bodies.length) {
          const body = _M0MPC15array5Array2atGUdddbEE(self.bodies, i);
          if (_M0MP36mizchi6kagura9physics3d9RigidBody11is__dynamic(body) && !body.is_sleeping) {
            ...
            _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(self.bodies, i, new _M0TP36mizchi6kagura9physics3d9RigidBody(body.id, body.body_type, body.position, new_vel, body.force, body.rotation, new_angular_vel, body.torque, body.mass, body.inv_mass, body.inv_inertia, body.restitution, body.friction, body.collider, body.linear_damping, body.angular_damping, body.is_sleeping, body.sleep_timer, body.is_bullet));
          }
          _tmp$7 = i + 1 | 0;
          continue;
        } else {
        ...
        if (_iter < config.velocity_iterations) {
          ...
          while (true) {
            ...
            if (di < dist_constraints.length) {
              _M0FP36mizchi6kagura9physics3d24solve__distance__joint3d(dist_constraints, di, self.bodies, _M0MPC15array5Array2atGUdddbEE(self.joints_distance, di));
              _tmp$10 = di + 1 | 0;
              continue;
            } else {
              break;
              ...
              _L: {
                _L$2: {
                  ...
                  if (_bind$2.$tag === 1) {
                    ...
                    _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(self.bodies, i, new _M0TP36mizchi6kagura9physics3d9RigidBody(body.id, body.body_type, _M0MP36mizchi6kagura6math3d4Vec33add(body.position, _M0MP36mizchi6kagura6math3d4Vec35scale(body.velocity, sub_dt)), body.velocity, body.force, new_rotation, body.angular_velocity, body.torque, body.mass, body.inv_mass, body.inv_inertia, body.restitution, body.friction, body.collider, body.linear_damping, body.angular_damping, body.is_sleeping, body.sleep_timer, body.is_bullet));
                  }
                  break _L;
                }
                ...
                _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(self.bodies, i, new _M0TP36mizchi6kagura9physics3d9RigidBody(body.id, body.body_type, _M0MP36mizchi6kagura6math3d4Vec33add(body.position, _M0MP36mizchi6kagura6math3d4Vec35scale(body.velocity, sub_dt * safe_toi)), body.velocity, body.force, safe_rotation, body.angular_velocity, body.torque, body.mass, body.inv_mass, body.inv_inertia, body.restitution, body.friction, body.collider, body.linear_damping, body.angular_damping, body.is_sleeping, body.sleep_timer, body.is_bullet));
              }
            } else {
              _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(self.bodies, i, new _M0TP36mizchi6kagura9physics3d9RigidBody(body.id, body.body_type, _M0MP36mizchi6kagura6math3d4Vec33add(body.position, _M0MP36mizchi6kagura6math3d4Vec35scale(body.velocity, sub_dt)), body.velocity, body.force, new_rotation, body.angular_velocity, body.torque, body.mass, body.inv_mass, body.inv_inertia, body.restitution, body.friction, body.collider, body.linear_damping, body.angular_damping, body.is_sleeping, body.sleep_timer, body.is_bullet));
            }
  ...
  while (true) {
    ...
    if (c < constraints.length) {
      const con = _M0MPC15array5Array2atGUdddbEE(constraints, c);
      const body_a = _M0MPC15array5Array2atGUdddbEE(self.bodies, con.idx_a);
      const body_b = _M0MPC15array5Array2atGUdddbEE(self.bodies, con.idx_b);
      const pair_key = _M0FP36mizchi6kagura9physics3d20contact__pair__key3d(body_a.id, body_b.id);
      ...
      _M0MPB3Map3setGlRP36mizchi6kagura9physics3d17ContactManifold3DE(new_cache, pair_key, new _M0TP36mizchi6kagura9physics3d17ContactManifold3D(body_a.id, body_b.id, con.contact.normal, [new _M0TP36mizchi6kagura9physics3d15ManifoldPoint3D(local_a, local_b, con.contact.penetration, con.acc_jn, con.acc_jt)]));
      _tmp$7 = c + 1 | 0;
      continue;
    } else {
      break;
  ...
  _M0MPB3Map5clearGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self.contact_cache);
  _M0MPB3Map4eachGlRP36mizchi6kagura9physics3d17ContactManifold3DE(new_cache, (k, v) => {
    _M0MPB3Map3setGlRP36mizchi6kagura9physics3d17ContactManifold3DE(self.contact_cache, k, v);
  });
  let _tmp$8 = 0;
  while (true) {
    const i = _tmp$8;
    if (i < self.bodies.length) {
      ...
      if (_M0MP36mizchi6kagura9physics3d9RigidBody11is__dynamic(body)) {
        _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(self.bodies, i, new _M0TP36mizchi6kagura9physics3d9RigidBody(body.id, body.body_type, body.position, body.velocity, _M0MP36mizchi6kagura6math3d4Vec34zero(), body.rotation, body.angular_velocity, _M0MP36mizchi6kagura6math3d4Vec34zero(), body.mass, body.inv_mass, body.inv_inertia, body.restitution, body.friction, body.collider, body.linear_damping, body.angular_damping, body.is_sleeping, body.sleep_timer, body.is_bullet));
      }
      _tmp$8 = i + 1 | 0;
      continue;
    } else {
      ...
      if (i < n) {
        ...
        if (_M0MP36mizchi6kagura9physics3d9RigidBody11is__dynamic(body)) {
          ...
          if (speed < _M0FP36mizchi6kagura9physics3d28sleep__velocity__threshold3d && angular_speed < _M0FP36mizchi6kagura9physics3d27sleep__angular__threshold3d) {
            _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(self.bodies, i, new _M0TP36mizchi6kagura9physics3d9RigidBody(body.id, body.body_type, body.position, body.velocity, body.force, body.rotation, body.angular_velocity, body.torque, body.mass, body.inv_mass, body.inv_inertia, body.restitution, body.friction, body.collider, body.linear_damping, body.angular_damping, body.is_sleeping, body.sleep_timer + dt, body.is_bullet));
          } else {
            _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(self.bodies, i, new _M0TP36mizchi6kagura9physics3d9RigidBody(body.id, body.body_type, body.position, body.velocity, body.force, body.rotation, body.angular_velocity, body.torque, body.mass, body.inv_mass, body.inv_inertia, body.restitution, body.friction, body.collider, body.linear_damping, body.angular_damping, false, 0, body.is_bullet));
          }
        }
        _tmp$11 = i + 1 | 0;
        continue;
          ...
          _L: {
            _L$2: {
              ...
              if (_bind$3 === -1) {
                ...
                if (_x === true) {
                  if (!body.is_sleeping) {
                    _M0MPC15array5Array3setGRP36mizchi6kagura9physics3d9RigidBodyE(self.bodies, i, new _M0TP36mizchi6kagura9physics3d9RigidBody(body.id, body.body_type, body.position, _M0MP36mizchi6kagura6math3d4Vec34zero(), body.force, body.rotation, _M0MP36mizchi6kagura6math3d4Vec34zero(), body.torque, body.mass, body.inv_mass, body.inv_inertia, body.restitution, body.friction, body.collider, body.linear_damping, body.angular_damping, true, body.sleep_timer, body.is_bullet));
                  }
                } else {
                  break _L$2;
                }
...
function _M0FP36mizchi6kagura7scene3d27render__object__gpu_2einner(mesh, model, color, material, skinning, vp, frustum, lighting, dst, shader3d, screen_w, screen_h, cmds, shader3d_textured, shader3d_pbr, shader3d_pbr_textured, shader3d_skinned, camera_pos) {
  ...
  if (is_pbr) {
    ...
    _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(cmds, cmd);
    return;
  } else {
    _L$4: {
      let sk;
...
function _M0FP36mizchi6kagura7scene3d23sort__objects__for__gpu(objects) {
  ...
  while (true) {
    const i = _tmp;
    if (i < _bind$2) {
      _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(ordered, { _0: i, _1: _M0MPC15array5Array2atGUdddbEE(objects, i) });
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(sorted, entry._1);
      _tmp$2 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP26mizchi19web__runtime__hooks27bridge__web__capture__input(active, _tick) {
  if (active) {
    ...
    while (true) {
      const i = _tmp$3;
      if (i < touch_count) {
        _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(touches, _M0FP36mizchi6kagura4core17new__touch__point(_M0FP26mizchi19web__runtime__hooks24js__input__touch__id__at(i), _M0FP26mizchi19web__runtime__hooks23js__input__touch__x__at(i), _M0FP26mizchi19web__runtime__hooks23js__input__touch__y__at(i)));
        _tmp$3 = i + 1 | 0;
        continue;
      } else {
        break;
    ...
    while (true) {
      ...
      if (i < gamepad_count) {
        ...
        _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(gamepads, _M0FP36mizchi6kagura4core22new__gamepad__snapshot(_M0FP26mizchi19web__runtime__hooks26js__input__gamepad__id__at(i), axes, pressed_buttons));
        _tmp$4 = i + 1 | 0;
        continue;
      } else {
        break;
...
function _M0FP26mizchi15physics3d__demo11body__color(id) {
  const hex = id < _M0FP26mizchi15physics3d__demo12body__colors.length ? _M0MPC15array5Array2atGiE(_M0FP26mizchi15physics3d__demo12body__colors, id) : 11184810;
...
function _M0MP26mizchi15physics3d__demo9DemoState4draw(self, ctx) {
  ...
  while (true) {
    ...
    if (i < self.world.bodies.length) {
      const body = _M0MPC15array5Array2atGUdddbEE(self.world.bodies, i);
      ...
      _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(objects, new _M0TP36mizchi6kagura7scene3d8Object3D(mesh, transform, color, undefined, is_ground ? 100 : 0, undefined));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  return _M0FP36mizchi6kagura7scene3d20render__scene3d__gpu(scene, ctx.dst, self.shader3d, ctx.screen_w, ctx.screen_h, _M0DTPC16option6OptionGORP36mizchi6kagura3gfx12ShaderHandleE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura3gfx12ShaderHandleE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura3gfx12ShaderHandleE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura3gfx12ShaderHandleE4None__);
}
function _M0MP26mizchi15physics3d__demo9DemoState3new() {
  ...
  _M0MP36mizchi6kagura9physics3d12PhysicsWorld9add__body(world, new _M0TP36mizchi6kagura9physics3d9RigidBody(0, 1, _M0MP36mizchi6kagura6math3d4Vec33new(0, -0.5, 0), _M0MP36mizchi6kagura6math3d4Vec34zero(), _M0MP36mizchi6kagura6math3d4Vec34zero(), _M0MP36mizchi6kagura6math3d10Quaternion8identity(), _M0MP36mizchi6kagura6math3d4Vec34zero(), _M0MP36mizchi6kagura6math3d4Vec34zero(), 0, 0, 0, 0.5, 0.6, new _M0DTP36mizchi6kagura9physics3d13ColliderShape9AABBShape(_M0MP36mizchi6kagura6math3d4Vec33new(10, 0.5, 10), _M0MP36mizchi6kagura6math3d4Vec34zero()), 0, 0, false, 0, false));
  ...
  while (true) {
    ...
    if (i < spawn_data.length) {
      ...
      let is_sphere;
      _L: {
        const _bind = _M0MPC15array5Array2atGUdddbEE(spawn_data, i);
        const _x = _bind._0;
        const _y = _bind._1;
        const _z = _bind._2;
      ...
      const id = i + 1 | 0;
      const collider = is_sphere ? new _M0DTP36mizchi6kagura9physics3d13ColliderShape11SphereShape(_M0MP36mizchi6kagura6math3d4Vec34zero(), 0.4) : new _M0DTP36mizchi6kagura9physics3d13ColliderShape9AABBShape(_M0MP36mizchi6kagura6math3d4Vec33new(0.4, 0.4, 0.4), _M0MP36mizchi6kagura6math3d4Vec34zero());
      const mass = 1;
      const inv_inertia = is_sphere ? 1 / (0.4 * mass * 0.4 * 0.4) : 6 / (mass * 0.8 * 0.8);
      _M0MP36mizchi6kagura9physics3d12PhysicsWorld9add__body(world, new _M0TP36mizchi6kagura9physics3d9RigidBody(id, 0, _M0MP36mizchi6kagura6math3d4Vec33new(x, y, z), _M0MP36mizchi6kagura6math3d4Vec34zero(), _M0MP36mizchi6kagura6math3d4Vec34zero(), _M0MP36mizchi6kagura6math3d10Quaternion8identity(), _M0MP36mizchi6kagura6math3d4Vec34zero(), _M0MP36mizchi6kagura6math3d4Vec34zero(), mass, 1 / mass, inv_inertia, 0.3, 0.6, collider, 0.05, 0.15, false, 0, false));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  return new _M0TP26mizchi15physics3d__demo9DemoState(_M0MP36mizchi6kagura6mesh3d6Mesh3D4cube(0.8), _M0MP36mizchi6kagura6mesh3d6Mesh3D6sphere(0.4, 8, 6), _M0MP36mizchi6kagura6mesh3d6Mesh3D13plane_2einner(20, 20, 4), world, camera, lighting, _M0FP36mizchi6kagura9inpututil18new__input__helper(), _M0FP36mizchi6kagura3gfx19new__shader__handle(10, _M0FP36mizchi6kagura6draw3d31shader3d__lit__untextured__wgsl()), 0);
}
