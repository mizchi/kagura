...
import * as runtime from '../../assets/web/kagura-runtime.generated.js';
import * as inventory from '../../assets/web/kagura-inventory.generated.js';
...
for (const [name, api] of [['runtime', runtime], ['inventory', inventory]]) {
  test(`compiled ${name} ESM and its JS ABI declaration expose the same API`, () => {
    const declarations = readFileSync(new URL(`../../assets/web/kagura-${name}.generated.d.ts`, import.meta.url), 'utf8');
