...
function _M0TP26mizchi5audio11AudioBuffer(param0, param1, param2) {
  this.channels = param0;
  this.sample_rate = param1;
  this.data = param2;
}
function _M0TP26mizchi5audio5Mixer(param0, param1, param2, param3, param4, param5) {
  this.voices = param0;
  this.master_gain = param1;
  this.channels = param2;
  this.sample_rate = param3;
  this.resample_quality = param4;
  this.next_voice_id = param5;
}
function _M0TP26mizchi5audio5Voice(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11) {
  this.id = param0;
  this.source = param1;
  ...
  this.state = param5;
  this.looping = param6;
  this.sample_rate = param7;
  this.loop_start = param8;
  this.loop_end = param9;
  this.envelope = param10;
  this.effects = param11;
}
function _M0DTP26mizchi5audio11AudioSource6Buffer(param0) {
  this._0 = param0;
}
_M0DTP26mizchi5audio11AudioSource6Buffer.prototype.$tag = 0;
function _M0DTP26mizchi5audio11AudioSource6Stream(param0) {
  this._0 = param0;
}
_M0DTP26mizchi5audio11AudioSource6Stream.prototype.$tag = 1;
...
function _M0TP36mizchi6kagura5audio9AudioClip(param0, param1, param2) {
  this.format = param0;
  this.data = param1;
  this.loop_ = param2;
}
function _M0TP36mizchi6kagura5audio17MixerAudioContext(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9) {
  this.mixer = param0;
  this.player_map = param1;
  this.next_id = param2;
  this.bgm_player_id = param3;
  this.bgm_fade_target = param4;
  this.bgm_fade_speed = param5;
  this.bgm_current_volume = param6;
  this.bgm_outgoing_id = param7;
  this.bgm_outgoing_volume = param8;
  this.bgm_outgoing_fade_speed = param9;
}
function _M0DTPC16option6OptionGfE4None() {}
_M0DTPC16option6OptionGfE4None.prototype.$tag = 0;
const _M0DTPC16option6OptionGfE4None__ = new _M0DTPC16option6OptionGfE4None();
function _M0DTPC16option6OptionGfE4Some(param0) {
  this._0 = param0;
}
_M0DTPC16option6OptionGfE4Some.prototype.$tag = 1;
function _M0DTPC16option6OptionGORP26mizchi5audio8EnvelopeE4None() {}
_M0DTPC16option6OptionGORP26mizchi5audio8EnvelopeE4None.prototype.$tag = 0;
const _M0DTPC16option6OptionGORP26mizchi5audio8EnvelopeE4None__ = new _M0DTPC16option6OptionGORP26mizchi5audio8EnvelopeE4None();
function _M0DTPC16option6OptionGORP26mizchi5audio8EnvelopeE4Some(param0) {
  this._0 = param0;
}
_M0DTPC16option6OptionGORP26mizchi5audio8EnvelopeE4Some.prototype.$tag = 1;
function _M0TP36mizchi6kagura5audio8PlayerId(param0) {
  this.value = param0;
}
function _M0DTPC16result6ResultGRP36mizchi6kagura5audio8PlayerIdRPC15error5ErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP36mizchi6kagura5audio8PlayerIdRPC15error5ErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP36mizchi6kagura5audio8PlayerIdRPC15error5ErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP36mizchi6kagura5audio8PlayerIdRPC15error5ErrorE2Ok.prototype.$tag = 1;
...
function _M0TP26mizchi7arena3d9ItemState(param0, param1) {
  this.position = param0;
  this.active = param1;
}
function _M0TP26mizchi7arena3d10EnemyState(param0, param1, param2) {
  this.position = param0;
  this.waypoints = param1;
  this.waypoint_idx = param2;
}
function _M0TP26mizchi7arena3d9GameState(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13) {
  this.mode = param0;
  this.score = param1;
  this.frame_count = param2;
  this.player = param3;
  this.items = param4;
  this.enemies = param5;
  this.camera = param6;
  this.lighting = param7;
  this.input = param8;
  this.meshes = param9;
  this.shader3d = param10;
  this.audio_ctx = param11;
  this.sfx_collect = param12;
  this.sfx_hit = param13;
}
function _M0TP26mizchi7arena3d11PlayerState(param0) {
  this.position = param0;
}
function _M0TP26mizchi7arena3d6Meshes(param0, param1, param2, param3, param4) {
  this.player = param0;
  this.item = param1;
  this.enemy = param2;
  this.ground = param3;
...
const _M0FPB33brute__force__find_2econstr_2f203 = 0;
const _M0FPB43boyer__moore__horspool__find_2econstr_2f189 = 0;
...
const _M0FPC14math34trig__reduce_2etwo__over__pi_2f537 = [0, 683565275, -1819212470, 2131351028, 2102212464, 920167782, 1326507024, 0];
...
function _M0MPC15array5Array2atGRP36mizchi6kagura6math3d4Vec3E(self, index) {
...
function _M0MPC15array9ArrayView6lengthGUiRP36mizchi6kagura7scene3d9SceneNodeEE(self) {
  return self.end - self.start | 0;
}
...
function _M0FPB28boyer__moore__horspool__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FPB43boyer__moore__horspool__find_2econstr_2f189;
  }
}
function _M0FPB18brute__force__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FPB33brute__force__find_2econstr_2f203;
  }
}
...
function _M0MPC15array5Array4pushGRP26mizchi7arena3d9ItemStateE(self, value) {
...
function _M0MPC16option6Option6unwrapGRPB5EntryGiRP36mizchi6kagura7scene3d9SceneNodeEE(self) {
  if (self === undefined) {
    return $panic();
  } else {
    const _Some = self;
...
function _M0MPB3Map20add__entry__to__tailGiRP36mizchi6kagura7scene3d9SceneNodeE(self, idx, entry) {
  ...
  if (_bind === -1) {
    ...
    _M0MPC16option6Option6unwrapGRPB5EntryGiRP36mizchi6kagura7scene3d9SceneNodeEE(_tmp[_bind]).next = entry;
  }
  self.tail = idx;
  const _tmp = self.entries;
...
function _M0MPB3Map11from__arrayGiRP36mizchi6kagura7scene3d9SceneNodeE(arr) {
  const length = _M0MPC15array9ArrayView6lengthGUiRP36mizchi6kagura7scene3d9SceneNodeEE(arr);
...
function _M0MPC15array5Array6filterGRP26mizchi5audio5VoiceE(self, f) {
  ...
  while (true) {
    ...
    if (_ < _bind) {
      const v = self[_];
      if (f(v)) {
        _M0MPC15array5Array4pushGRP26mizchi7arena3d9ItemStateE(arr, v);
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
...
function _M0FPC14math12trig__reduce(x, switch_over) {
  ...
  const ind = exp >> 5;
  exp = exp & 31;
  let hi = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f537, ind);
  let mi = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f537, ind + 1 | 0);
  let lo = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f537, ind + 2 | 0);
  const tp = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f537, ind + 3 | 0);
  if (exp > 0) {
...
function _M0FP26mizchi5audio18new__audio__buffer(channels, sample_rate, frames) {
  return new _M0TP26mizchi5audio11AudioBuffer(channels, sample_rate, $make_array_len_and_init(Math.imul(frames, channels) | 0, Math.fround(0)));
}
...
function _M0FP26mizchi5audio12pause__voice(mixer, id) {
  ...
  if (_M0IP26mizchi5audio10VoiceStatePB2Eq5equal(voice.state, 0)) {
    voice.state = 1;
    return true;
  } else {
    return false;
...
function _M0FP26mizchi5audio18new__mixer_2einner(sample_rate, resample_quality) {
  return new _M0TP26mizchi5audio5Mixer([], Math.fround(1), 2, sample_rate, resample_quality, 0);
}
...
function _M0FP26mizchi5audio18new__voice_2einner(mixer, source, gain, pan, looping, envelope) {
  ...
  return new _M0TP26mizchi5audio5Voice(id, source, Math.fround(0), gain, pan, 0, looping, sample_rate, 0, 0, envelope, []);
}
function _M0FP26mizchi5audio32new__voice__from__buffer_2einner(mixer, buffer, gain, pan, looping, envelope) {
  return _M0FP26mizchi5audio18new__voice_2einner(mixer, new _M0DTP26mizchi5audio11AudioSource6Buffer(buffer), gain, pan, looping, envelope);
}
...
function _M0FP26mizchi5audio10add__voice(mixer, voice) {
  _M0MPC15array5Array4pushGRP26mizchi7arena3d9ItemStateE(mixer.voices, voice);
  return voice.id;
}
...
function _M0FP36mizchi6kagura5audio16new__audio__clip(format, data, loop_) {
  return new _M0TP36mizchi6kagura5audio9AudioClip(format, data, loop_);
}
...
function _M0MP36mizchi6kagura5audio17MixerAudioContext3new(sample_rate) {
  return new _M0TP36mizchi6kagura5audio17MixerAudioContext(_M0FP26mizchi5audio10new__mixer(sample_rate, undefined), [], 1, undefined, 1, 0, 1, undefined, 0, 0);
}
...
function _M0IP36mizchi6kagura5audio17MixerAudioContextP36mizchi6kagura5audio12AudioContext14create__player(self, clip) {
  ...
  const voice = _M0FP26mizchi5audio24new__voice__from__buffer(self.mixer, buffer, _M0DTPC16option6OptionGfE4None__, _M0DTPC16option6OptionGfE4None__, clip.loop_, _M0DTPC16option6OptionGORP26mizchi5audio8EnvelopeE4None__);
  const voice_id = _M0FP26mizchi5audio10add__voice(self.mixer, voice);
  _M0FP26mizchi5audio12pause__voice(self.mixer, voice_id);
  const player_id = new _M0TP36mizchi6kagura5audio8PlayerId(self.next_id);
  self.next_id = self.next_id + 1 | 0;
  _M0MPC15array5Array4pushGRP26mizchi7arena3d9ItemStateE(self.player_map, { _0: player_id, _1: voice_id });
  return new _M0DTPC16result6ResultGRP36mizchi6kagura5audio8PlayerIdRPC15error5ErrorE2Ok(player_id);
}
...
function _M0IP36mizchi6kagura5audio17MixerAudioContextP36mizchi6kagura5audio12AudioContext4seek(self, id, position) {
  ...
  const frame = _M0MPC16double6Double7to__int(position * (voice.sample_rate + 0));
...
function _M0MP36mizchi6kagura8camera3d11OrbitCamera12with__target(self, target) {
  return new _M0TP36mizchi6kagura8camera3d11OrbitCamera(target, self.distance, self.yaw, self.pitch, self.fov_y_rad, self.aspect, self.near, self.far);
}
  ...
  while (true) {
    ...
    if (i < bone_count) {
      ...
      while (true) {
        const j = _tmp$2;
        if (j < _bind$3) {
          const _tmp$3 = _M0MPC15array5Array2atGRP36mizchi6kagura6math3d4Vec3E(skinning_matrices, i).elements;
...
function _M0FP36mizchi6kagura9inpututil27update__touch__input__state(state, snapshot) {
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _M0MPC15array5Array4pushGRP26mizchi7arena3d9ItemStateE(next_durations, new _M0TP36mizchi6kagura9inpututil18TouchDurationEntry(id, duration));
      _tmp$3 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi6kagura9inpututil25update__key__input__state(state, snapshot) {
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _M0MPC15array5Array4pushGRP26mizchi7arena3d9ItemStateE(next_durations, new _M0TP36mizchi6kagura9inpututil16KeyDurationEntry(key, duration));
      _tmp$3 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi6kagura9inpututil27update__mouse__input__state(state, snapshot) {
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _M0MPC15array5Array4pushGRP26mizchi7arena3d9ItemStateE(next_durations, new _M0TP36mizchi6kagura9inpututil24MouseButtonDurationEntry(button, duration));
      _tmp$3 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi6kagura7scene3d27render__object__gpu_2einner(mesh, model, color, material, skinning, vp, frustum, lighting, dst, shader3d, screen_w, screen_h, cmds, shader3d_textured, shader3d_pbr, shader3d_pbr_textured, shader3d_skinned, camera_pos) {
  ...
  if (is_pbr) {
    ...
    _M0MPC15array5Array4pushGRP26mizchi7arena3d9ItemStateE(cmds, cmd);
    return;
  } else {
    _L$4: {
      let sk;
...
function _M0FP26mizchi19web__runtime__hooks27bridge__web__capture__input(active, _tick) {
  if (active) {
    ...
    while (true) {
      const i = _tmp$3;
      if (i < touch_count) {
        _M0MPC15array5Array4pushGRP26mizchi7arena3d9ItemStateE(touches, _M0FP36mizchi6kagura4core17new__touch__point(_M0FP26mizchi19web__runtime__hooks24js__input__touch__id__at(i), _M0FP26mizchi19web__runtime__hooks23js__input__touch__x__at(i), _M0FP26mizchi19web__runtime__hooks23js__input__touch__y__at(i)));
        _tmp$3 = i + 1 | 0;
        continue;
      } else {
        break;
    ...
    while (true) {
      ...
      if (i < gamepad_count) {
        ...
        _M0MPC15array5Array4pushGRP26mizchi7arena3d9ItemStateE(gamepads, _M0FP36mizchi6kagura4core22new__gamepad__snapshot(_M0FP26mizchi19web__runtime__hooks26js__input__gamepad__id__at(i), axes, pressed_buttons));
        _tmp$4 = i + 1 | 0;
        continue;
      } else {
        break;
...
function _M0MP26mizchi7arena3d9GameState19build__scene__graph(self) {
  ...
  _M0MP36mizchi6kagura7scene3d10SceneGraph9add__node(graph, _M0FP36mizchi6kagura7scene3d11scene__node(new _M0DTPC16option6OptionGORP36mizchi6kagura6mesh3d6Mesh3DE4Some(self.meshes.ground), undefined, undefined, undefined, _M0FP26mizchi7arena3d13color__ground, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d8MaterialE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d13SkinningStateE4None__));
  ...
  _M0MP36mizchi6kagura7scene3d10SceneGraph9add__node(graph, _M0FP36mizchi6kagura7scene3d11scene__node(new _M0DTPC16option6OptionGORP36mizchi6kagura6mesh3d6Mesh3DE4Some(self.meshes.wall), _M0MP36mizchi6kagura6math3d4Vec33new(0, wh, -(h + wt / 2)), undefined, _M0MP36mizchi6kagura6math3d4Vec33new(h * 2 + wt * 2, _M0FP26mizchi7arena3d12wall__height, wt), _M0FP26mizchi7arena3d11color__wall, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d8MaterialE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d13SkinningStateE4None__));
  _M0MP36mizchi6kagura7scene3d10SceneGraph9add__node(graph, _M0FP36mizchi6kagura7scene3d11scene__node(new _M0DTPC16option6OptionGORP36mizchi6kagura6mesh3d6Mesh3DE4Some(self.meshes.wall), _M0MP36mizchi6kagura6math3d4Vec33new(0, wh, h + wt / 2), undefined, _M0MP36mizchi6kagura6math3d4Vec33new(h * 2 + wt * 2, _M0FP26mizchi7arena3d12wall__height, wt), _M0FP26mizchi7arena3d11color__wall, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d8MaterialE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d13SkinningStateE4None__));
  _M0MP36mizchi6kagura7scene3d10SceneGraph9add__node(graph, _M0FP36mizchi6kagura7scene3d11scene__node(new _M0DTPC16option6OptionGORP36mizchi6kagura6mesh3d6Mesh3DE4Some(self.meshes.wall), _M0MP36mizchi6kagura6math3d4Vec33new(-(h + wt / 2), wh, 0), undefined, _M0MP36mizchi6kagura6math3d4Vec33new(wt, _M0FP26mizchi7arena3d12wall__height, h * 2), _M0FP26mizchi7arena3d11color__wall, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d8MaterialE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d13SkinningStateE4None__));
  _M0MP36mizchi6kagura7scene3d10SceneGraph9add__node(graph, _M0FP36mizchi6kagura7scene3d11scene__node(new _M0DTPC16option6OptionGORP36mizchi6kagura6mesh3d6Mesh3DE4Some(self.meshes.wall), _M0MP36mizchi6kagura6math3d4Vec33new(h + wt / 2, wh, 0), undefined, _M0MP36mizchi6kagura6math3d4Vec33new(wt, _M0FP26mizchi7arena3d12wall__height, h * 2), _M0FP26mizchi7arena3d11color__wall, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d8MaterialE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d13SkinningStateE4None__));
  const _bind = 0;
  const _bind$2 = self.items.length;
  let _tmp = _bind;
  while (true) {
    const i = _tmp;
    if (i < _bind$2) {
      const item = _M0MPC15array5Array2atGRP36mizchi6kagura6math3d4Vec3E(self.items, i);
      if (item.active) {
        _M0MP36mizchi6kagura7scene3d10SceneGraph9add__node(graph, _M0FP36mizchi6kagura7scene3d11scene__node(new _M0DTPC16option6OptionGORP36mizchi6kagura6mesh3d6Mesh3DE4Some(self.meshes.item), item.position, undefined, undefined, _M0FP26mizchi7arena3d11color__item, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d8MaterialE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d13SkinningStateE4None__));
      }
      _tmp = i + 1 | 0;
      continue;
    } else {
  ...
  const _bind$3 = 0;
  const _bind$4 = self.enemies.length;
  let _tmp$2 = _bind$3;
  while (true) {
    const i = _tmp$2;
    if (i < _bind$4) {
      const e = _M0MPC15array5Array2atGRP36mizchi6kagura6math3d4Vec3E(self.enemies, i);
      _M0MP36mizchi6kagura7scene3d10SceneGraph9add__node(graph, _M0FP36mizchi6kagura7scene3d11scene__node(new _M0DTPC16option6OptionGORP36mizchi6kagura6mesh3d6Mesh3DE4Some(self.meshes.enemy), e.position, undefined, undefined, _M0FP26mizchi7arena3d12color__enemy, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d8MaterialE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d13SkinningStateE4None__));
      _tmp$2 = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  _M0MP36mizchi6kagura7scene3d10SceneGraph9add__node(graph, _M0FP36mizchi6kagura7scene3d11scene__node(new _M0DTPC16option6OptionGORP36mizchi6kagura6mesh3d6Mesh3DE4Some(self.meshes.player), self.player.position, undefined, undefined, _M0FP26mizchi7arena3d13color__player, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d8MaterialE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d13SkinningStateE4None__));
  return graph;
}
function _M0MP26mizchi7arena3d9GameState4draw(self, ctx) {
  ...
  return _M0FP36mizchi6kagura7scene3d27render__scene3d__graph__gpu(graph, _M0MP36mizchi6kagura8camera3d11OrbitCamera12to__camera3d(self.camera), self.lighting, ctx.dst, self.shader3d, ctx.screen_w, ctx.screen_h, _M0DTPC16option6OptionGORP36mizchi6kagura3gfx12ShaderHandleE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura3gfx12ShaderHandleE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura3gfx12ShaderHandleE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura3gfx12ShaderHandleE4None__);
}
function _M0FP26mizchi7arena3d20generate__tone__clip(freq, duration, sample_rate) {
  ...
  const num_frames = _M0MPC16double6Double7to__int(duration * (sample_rate + 0));
  const bytes_arr = [];
  const _bind = 0;
  let _tmp = _bind;
  while (true) {
    ...
    if (i < num_frames) {
      ...
      const value = _M0FPC14math3sin(6.28318530717958623 * freq * t) * envelope;
      const i16_val = _M0MPC16double6Double7to__int(value * 32767);
      const lo = i16_val & 255;
      const hi = i16_val >> 8 & 255;
      _M0MPC15array5Array4pushGyE(bytes_arr, lo);
      _M0MPC15array5Array4pushGyE(bytes_arr, hi);
      _M0MPC15array5Array4pushGyE(bytes_arr, lo);
      _M0MPC15array5Array4pushGyE(bytes_arr, hi);
      _tmp = i + 1 | 0;
      continue;
  ...
  return _M0FP36mizchi6kagura5audio16new__audio__clip(fmt, _M0MPC15bytes5Bytes11from__array(new _M0TPB9ArrayViewGyE(bytes_arr, 0, bytes_arr.length)), false);
}
function _M0FP26mizchi7arena3d10make__item(index) {
  ...
  const pos = _M0MPC15array5Array2atGRP36mizchi6kagura6math3d4Vec3E(positions, index % positions.length | 0);
  return new _M0TP26mizchi7arena3d9ItemState(pos, true);
}
function _M0MP26mizchi7arena3d9GameState3new() {
  ...
  while (true) {
    const i = _tmp;
    if (i < _M0FP26mizchi7arena3d11item__count) {
      _M0MPC15array5Array4pushGRP26mizchi7arena3d9ItemStateE(items, _M0FP26mizchi7arena3d10make__item(i));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  _M0MPC15array5Array4pushGRP26mizchi7arena3d9ItemStateE(enemies, new _M0TP26mizchi7arena3d10EnemyState(_M0MPC15array5Array2atGRP36mizchi6kagura6math3d4Vec3E(wp0, 0), wp0, 0));
  _M0MPC15array5Array4pushGRP26mizchi7arena3d9ItemStateE(enemies, new _M0TP26mizchi7arena3d10EnemyState(_M0MPC15array5Array2atGRP36mizchi6kagura6math3d4Vec3E(wp1, 0), wp1, 0));
  _M0MPC15array5Array4pushGRP26mizchi7arena3d9ItemStateE(enemies, new _M0TP26mizchi7arena3d10EnemyState(_M0MPC15array5Array2atGRP36mizchi6kagura6math3d4Vec3E(wp2, 0), wp2, 0));
  ...
  _L: {
    _L$2: {
      const _bind$2 = _M0IP36mizchi6kagura5audio17MixerAudioContextP36mizchi6kagura5audio12AudioContext14create__player(audio_ctx, clip_collect);
      if (_bind$2.$tag === 1) {
        const _ok = _bind$2;
        sfx_collect = _ok._0;
      } else {
  ...
  _L$2: {
    _L$3: {
      const _bind$2 = _M0IP36mizchi6kagura5audio17MixerAudioContextP36mizchi6kagura5audio12AudioContext14create__player(audio_ctx, clip_hit);
      if (_bind$2.$tag === 1) {
        const _ok = _bind$2;
        sfx_hit = _ok._0;
      } else {
  ...
  return new _M0TP26mizchi7arena3d9GameState(_M0FP26mizchi7arena3d13mode__playing, 0, 0, new _M0TP26mizchi7arena3d11PlayerState(_M0MP36mizchi6kagura6math3d4Vec33new(0, 0.5, 0)), items, enemies, camera, lighting, _M0FP36mizchi6kagura9inpututil18new__input__helper(), new _M0TP26mizchi7arena3d6Meshes(_M0MP36mizchi6kagura6mesh3d6Mesh3D6sphere(0.5, 6, 4), _M0MP36mizchi6kagura6mesh3d6Mesh3D6sphere(0.3, 4, 3), _M0MP36mizchi6kagura6mesh3d6Mesh3D4cube(0.8), _M0MP36mizchi6kagura6mesh3d6Mesh3D13plane_2einner(20, 20, 4), _M0MP36mizchi6kagura6mesh3d6Mesh3D4cube(1)), _M0FP36mizchi6kagura3gfx19new__shader__handle(100, _M0FP36mizchi6kagura6draw3d31shader3d__lit__untextured__wgsl()), audio_ctx, sfx_collect, sfx_hit);
}
function _M0MP26mizchi7arena3d9GameState5reset(self) {
  ...
  while (true) {
    ...
    if (i < _bind$4) {
      const e = _M0MPC15array5Array2atGRP36mizchi6kagura6math3d4Vec3E(self.enemies, i);
      e.waypoint_idx = 0;
      e.position = _M0MPC15array5Array2atGRP36mizchi6kagura6math3d4Vec3E(e.waypoints, 0);
      _tmp$2 = i + 1 | 0;
      continue;
    } else {
      return;
...
function _M0FP26mizchi7arena3d13respawn__item(item, frame) {
  ...
  item.position = _M0MP36mizchi6kagura6math3d4Vec33new(r * _M0FPC14math3cos(angle), 0.3, r * _M0FPC14math3sin(angle));
...
function _M0MP26mizchi7arena3d9GameState15update__playing(self) {
  ...
  const dz = new _M0TPC13ref3RefGdE(0);
  ...
  while (true) {
    ...
    if (i < _bind$2) {
      ...
      if (item.active && _M0FP26mizchi7arena3d12distance__xz(self.player.position, item.position) < _M0FP26mizchi7arena3d19item__collect__dist) {
        ...
        _L: {
          _L$2: {
            const _bind$3 = _M0IP36mizchi6kagura5audio17MixerAudioContextP36mizchi6kagura5audio12AudioContext4seek(self.audio_ctx, self.sfx_collect, 0);
            if (_bind$3.$tag === 1) {
              const _ok = _bind$3;
              _ok._0;
            } else {
        ...
        _L$2: {
          _L$3: {
            const _bind$3 = _M0IP36mizchi6kagura5audio17MixerAudioContextP36mizchi6kagura5audio12AudioContext4play(self.audio_ctx, self.sfx_collect);
            if (_bind$3.$tag === 1) {
              const _ok = _bind$3;
              _ok._0;
            } else {
  ...
  while (true) {
    ...
    if (i < _bind$4) {
      const e = _M0MPC15array5Array2atGRP36mizchi6kagura6math3d4Vec3E(self.enemies, i);
      const target = _M0MPC15array5Array2atGRP36mizchi6kagura6math3d4Vec3E(e.waypoints, e.waypoint_idx);
      ...
      if (_M0FP26mizchi7arena3d12distance__xz(self.player.position, e.position) < _M0FP26mizchi7arena3d16enemy__hit__dist) {
        ...
        _L: {
          _L$2: {
            const _bind$5 = _M0IP36mizchi6kagura5audio17MixerAudioContextP36mizchi6kagura5audio12AudioContext4seek(self.audio_ctx, self.sfx_hit, 0);
            if (_bind$5.$tag === 1) {
              const _ok = _bind$5;
              _ok._0;
            } else {
        ...
        _L$2: {
          _L$3: {
            const _bind$5 = _M0IP36mizchi6kagura5audio17MixerAudioContextP36mizchi6kagura5audio12AudioContext4play(self.audio_ctx, self.sfx_hit);
            if (_bind$5.$tag === 1) {
              const _ok = _bind$5;
              _ok._0;
            } else {
...
(() => {
  ...
  }, (ctx) => _M0MP26mizchi7arena3d9GameState4draw(state, ctx), undefined, undefined, state.audio_ctx, 735, _M0FP26mizchi7arena3d9screen__w, _M0FP26mizchi7arena3d9screen__h, "3D Arena Collector", "#app");
})();
