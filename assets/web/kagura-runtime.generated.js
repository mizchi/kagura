...
// Source SHA-256: 5a2aee85378dfc19a7a15ad7237407b858d6c0aa76cab4f6a74dc6bef67ee4f6
...
const _M0FP36mizchi21kagura__platform__web9web__core11delete__key = (value, key) => { delete value[key]; };
const _M0FP36mizchi21kagura__platform__web9web__core14object__spread = (left, right) => ({...left, ...right});
const _M0FP36mizchi21kagura__platform__web9web__core6truthy = (value) => !!value;
function $compare_int(a, b) {
  return (a >= b) - (a <= b);
}
const _M0FP36mizchi21kagura__platform__web9web__core7to__i32 = (value) => value | 0;
const _M0FP36mizchi21kagura__platform__web9web__core6finite = (value) => Number.isFinite(value);
const _M0FP36mizchi21kagura__platform__web9web__core14replace__first = (source, from, to) => source.replace(from, to);
const _M0FP36mizchi21kagura__platform__web9web__core12range__error = (message) => { throw new RangeError(message); };
const _M0FP36mizchi21kagura__platform__web9web__core13safe__integer = (value) => Number.isSafeInteger(value);
function _M0TP36mizchi21kagura__platform__web9web__core12MotionPlayer(param0, param1, param2, param3, param4, param5) {
  this.clips = param0;
  this.clip = param1;
  this.time = param2;
  this.playing = param3;
...
const _M0FP36mizchi21kagura__platform__web9web__core14fixed__decimal = (value, digits) => Number(value.toFixed(digits));
const _M0FP36mizchi21kagura__platform__web9web__core13float32__copy = (source) => new Float32Array(source);
const _M0FP36mizchi21kagura__platform__web9web__core12uint32__copy = (source) => new Uint32Array(source);
const _M0FP36mizchi21kagura__platform__web9web__core10to__uint32 = (source) => source >>> 0;
const _M0FP36mizchi21kagura__platform__web9web__core14unique__symbol = () => Symbol("static geometry");
const _M0FP36mizchi21kagura__platform__web9web__core11type__error = (message) => { throw new TypeError(message); };
function _M0TP36mizchi21kagura__platform__web9web__core12GamepadState(param0, param1, param2, param3, param4, param5, param6, param7) {
...
function _M0TP36mizchi21kagura__platform__web9web__core12ControlState(param0, param1, param2, param3, param4, param5, param6) {
...
const _M0FP36mizchi21kagura__platform__web9web__core24parse__texture__bindingsN7_2abindS311 = "texture";
const _M0FP36mizchi21kagura__platform__web9web__core17position__pattern = _M0MP46mizchi2js8builtins6regexp6RegExp3new("position\\s*:\\s*vec3<f32>", undefined);
const _M0FP36mizchi21kagura__platform__web9web__core16weights__pattern = _M0MP46mizchi2js8builtins6regexp6RegExp3new("weights\\s*:\\s*vec4<f32>", undefined);
const _M0FP36mizchi21kagura__platform__web9web__core15joints__pattern = _M0MP46mizchi2js8builtins6regexp6RegExp3new("joints\\s*:\\s*vec4<f32>", undefined);
const _M0FP36mizchi21kagura__platform__web9web__core24parse__texture__bindingsN6constrS504 = "g";
const _M0MPC16string10StringView4findN6constrS9865 = 0;
const _M0FP36mizchi21kagura__platform__web9web__core25instance__uniform__shaderN5tupleS505 = { _0: "@group(0) @binding(0) var<uniform> uniforms: Uniforms;", _1: "struct InstanceUniforms { values: array<Uniforms, 32>, };\n@group(0) @binding(0) var<uniform> instance_uniforms: InstanceUniforms;\nvar<private> uniforms: Uniforms;" };
const _M0FP36mizchi21kagura__platform__web9web__core25instance__uniform__shaderN5tupleS506 = { _0: "struct VertexOutput {", _1: "struct VertexOutput {\n  @location(7) @interpolate(flat) instance_id: u32," };
const _M0FP36mizchi21kagura__platform__web9web__core25instance__uniform__shaderN5tupleS507 = { _0: "@vertex fn vs_main(input: VertexInput) -> VertexOutput {", _1: "@vertex fn vs_main(input: VertexInput, @builtin(instance_index) instance_id: u32) -> VertexOutput {\n  uniforms = instance_uniforms.values[instance_id];" };
const _M0FP36mizchi21kagura__platform__web9web__core25instance__uniform__shaderN5tupleS508 = { _0: "var out: VertexOutput;", _1: "var out: VertexOutput;\n  out.instance_id = instance_id;" };
const _M0FP36mizchi21kagura__platform__web9web__core25instance__uniform__shaderN5tupleS509 = { _0: "@fragment fn fs_main(in: VertexOutput) -> @location(0) vec4<f32> {", _1: "@fragment fn fs_main(in: VertexOutput) -> @location(0) vec4<f32> {\n  uniforms = instance_uniforms.values[in.instance_id];" };
const _M0FP36mizchi21kagura__platform__web9web__core11victrix__idN6constrS503 = "i";
const _M0FP36mizchi21kagura__platform__web9web__core11victrix__id = _M0MP46mizchi2js8builtins6regexp6RegExp3new("\\bVendor:\\s*0e6f\\s+Product:\\s*0218\\b", _M0FP36mizchi21kagura__platform__web9web__core11victrix__idN6constrS503);
const _M0FP36mizchi21kagura__platform__web9web__core18normalize__gamepadN5tupleS510 = { _0: 3, _1: 6 };
const _M0FP36mizchi21kagura__platform__web9web__core18normalize__gamepadN5tupleS511 = { _0: 4, _1: 7 };
const _M0FP36mizchi21kagura__platform__web9web__core13radial__stickN5tupleS512 = { _0: 0, _1: 0 };
const _M0FP36mizchi21kagura__platform__web9web__core20read__frame__profileN5tupleS513 = { _0: "renderCpuMs", _1: "_lastRenderCpuMs" };
const _M0FP36mizchi21kagura__platform__web9web__core20read__frame__profileN5tupleS514 = { _0: "renderUploadCpuMs", _1: "_lastRenderUploadCpuMs" };
const _M0FP36mizchi21kagura__platform__web9web__core20read__frame__profileN5tupleS515 = { _0: "renderBindGroupCpuMs", _1: "_lastRenderBindGroupCpuMs" };
const _M0FP36mizchi21kagura__platform__web9web__core20read__frame__profileN5tupleS516 = { _0: "renderEncodeCpuMs", _1: "_lastRenderEncodeCpuMs" };
const _M0FP36mizchi21kagura__platform__web9web__core20read__frame__profileN5tupleS517 = { _0: "renderSubmitCpuMs", _1: "_lastRenderSubmitCpuMs" };
...
function _M0FP36mizchi21kagura__platform__web9web__core13array__values(value) {
  return _M0FP36mizchi2js4core11is__nullish(value) ? [] : _M0FP36mizchi2js4core11array__from(value);
}
function _M0FP36mizchi21kagura__platform__web9web__core20apply__object__patch(previous, patch) {
  const value = _M0FP36mizchi21kagura__platform__web9web__core14object__spread(_M0FP36mizchi21kagura__platform__web9web__core6truthy(_M0MP36mizchi2js4core3Any5__get(patch, "full")) ? _M0FP36mizchi2js4core4null() : previous, _M0MP36mizchi2js4core3Any5__get(patch, "set"));
  const _bind = _M0FP36mizchi21kagura__platform__web9web__core13array__values(_M0MP36mizchi2js4core3Any5__get(patch, "remove"));
  ...
  while (true) {
    ...
    if (_ < _bind$2) {
      const key = _bind[_];
      _M0FP36mizchi21kagura__platform__web9web__core11delete__key(value, key);
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi21kagura__platform__web9web__core6length(value) {
...
function _M0FP36mizchi21kagura__platform__web9web__core24create__dependency__gate() {
  ...
  return (dependencies) => {
    ...
    if (_bind.$tag === 1) {
      const _Some = _bind;
      const _old = _Some._0;
      if (_M0FP36mizchi21kagura__platform__web9web__core6length(_old) === count) {
        let same = true;
        let _tmp = 0;
        while (true) {
          const i = _tmp;
...
function _M0FP36mizchi21kagura__platform__web9web__core12is__stride32(source) {
  return _M0MP46mizchi2js8builtins6regexp6RegExp6test__(_M0FP36mizchi21kagura__platform__web9web__core17position__pattern, source);
}
function _M0FP36mizchi21kagura__platform__web9web__core12is__stride64(source) {
  return _M0FP36mizchi21kagura__platform__web9web__core12is__stride32(source) && (_M0MP46mizchi2js8builtins6regexp6RegExp6test__(_M0FP36mizchi21kagura__platform__web9web__core15joints__pattern, source) && _M0MP46mizchi2js8builtins6regexp6RegExp6test__(_M0FP36mizchi21kagura__platform__web9web__core16weights__pattern, source));
}
function _M0FP36mizchi21kagura__platform__web9web__core14is__3d__shader(source) {
  return _M0FP36mizchi21kagura__platform__web9web__core12is__stride32(source) || _M0FP36mizchi21kagura__platform__web9web__core12is__stride64(source);
}
function _M0FP36mizchi21kagura__platform__web9web__core8fallback(value, default_) {
  return _M0FP36mizchi2js4core11is__nullish(value) ? default_ : value;
}
function _M0FP36mizchi21kagura__platform__web9web__core5field(value, key) {
...
function _M0FP36mizchi21kagura__platform__web9web__core13number__field(value, key, default_) {
  return _M0FP36mizchi21kagura__platform__web9web__core8fallback(_M0FP36mizchi21kagura__platform__web9web__core5field(value, key), default_);
}
function _M0FP36mizchi21kagura__platform__web9web__core21command__needs__depth(command) {
  const hint = _M0FP36mizchi21kagura__platform__web9web__core13number__field(command, "vertexStrideHint", 0);
  return _M0FP36mizchi21kagura__platform__web9web__core6truthy(_M0MP36mizchi2js4core3Any5__get(command, "isCustom")) && (hint > 0 ? hint >= 8 : _M0FP36mizchi21kagura__platform__web9web__core14is__3d__shader(_M0MP36mizchi2js4core3Any5__get(command, "shaderSource")));
}
function _M0FP36mizchi21kagura__platform__web9web__core24parse__texture__bindings(source) {
  const pattern = _M0MP46mizchi2js8builtins6regexp6RegExp3new("@binding\\((\\d+)\\)\\s+var\\s+\\w+\\s*:\\s*(texture_2d<f32>|texture_2d|sampler)", _M0FP36mizchi21kagura__platform__web9web__core24parse__texture__bindingsN6constrS504);
  const bindings = [];
  while (true) {
    ...
    _M0MPC15array5Array4pushGUisEE(bindings, { _0: index, _1: _M0MPC16string6String11has__prefix(raw, new _M0TPC16string10StringView(_M0FP36mizchi21kagura__platform__web9web__core24parse__texture__bindingsN7_2abindS311, 0, _M0FP36mizchi21kagura__platform__web9web__core24parse__texture__bindingsN7_2abindS311.length)) ? "texture" : "sampler" });
    continue;
  }
...
function _M0FP36mizchi21kagura__platform__web9web__core20get__instance__count(command) {
  const raw = _M0FP36mizchi21kagura__platform__web9web__core8fallback(_M0FP36mizchi21kagura__platform__web9web__core5field(command, "instanceCount"), _M0FP36mizchi21kagura__platform__web9web__core5field(command, "instance_count"));
  if (_M0FP36mizchi21kagura__platform__web9web__core6finite(raw)) {
    const _p = _M0FP36mizchi21kagura__platform__web9web__core7to__i32(raw);
    const _p$2 = 1;
...
function _M0FP36mizchi21kagura__platform__web9web__core25get__resource__cache__key(command) {
  const raw = _M0FP36mizchi21kagura__platform__web9web__core8fallback(_M0FP36mizchi21kagura__platform__web9web__core5field(command, "resourceCacheKey"), _M0FP36mizchi21kagura__platform__web9web__core5field(command, "resource_cache_key"));
  return _M0FP36mizchi21kagura__platform__web9web__core6finite(raw) ? _M0FP36mizchi21kagura__platform__web9web__core7to__i32(raw) : 0;
}
function _M0FP36mizchi21kagura__platform__web9web__core8argument(value, default_) {
  return _M0FP36mizchi2js4core13is__undefined(value) ? default_ : value;
}
function _M0FP36mizchi21kagura__platform__web9web__core13equal__dwords(a, b, count) {
  ...
  const count$2 = _M0FP36mizchi21kagura__platform__web9web__core8argument(count, _M0MP36mizchi2js4core3Any5__get(b, "length"));
  let _tmp;
...
function _M0FP36mizchi21kagura__platform__web9web__core25instance__uniform__shader(source, dwords) {
  if (!_M0FP36mizchi21kagura__platform__web9web__core13safe__integer(dwords) || (dwords < 4 || (dwords > 128 || _M0IPC16double6DoublePB3Mod3mod(dwords, 4) !== 0))) {
    _M0FP36mizchi21kagura__platform__web9web__core12range__error("Invalid instance uniform layout");
  }
  const replacements = [_M0FP36mizchi21kagura__platform__web9web__core25instance__uniform__shaderN5tupleS505, _M0FP36mizchi21kagura__platform__web9web__core25instance__uniform__shaderN5tupleS506, _M0FP36mizchi21kagura__platform__web9web__core25instance__uniform__shaderN5tupleS507, _M0FP36mizchi21kagura__platform__web9web__core25instance__uniform__shaderN5tupleS508, _M0FP36mizchi21kagura__platform__web9web__core25instance__uniform__shaderN5tupleS509];
  let result = source;
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      result = _M0FP36mizchi21kagura__platform__web9web__core14replace__first(result, _from, _to);
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi21kagura__platform__web9web__core13require__time(value) {
  if (!_M0FP36mizchi21kagura__platform__web9web__core6finite(value)) {
    _M0FP36mizchi2js4core12throw__error("Expected finite time");
  }
  return value;
}
function _M0MP36mizchi21kagura__platform__web9web__core12MotionPlayer8duration(self) {
  const _p = _M0MP36mizchi2js4core3Any5__get(self.clip, "duration");
  return _p;
}
function _M0FP36mizchi21kagura__platform__web9web__core5clamp(value, low, high) {
  return _M0MPC16double6Double3min(_M0MPC16double6Double3max(value, low), high);
}
function _M0FP36mizchi21kagura__platform__web9web__core22create__motion__player(asset) {
  const clips = _M0FP36mizchi21kagura__platform__web9web__core13array__values(_M0MP36mizchi2js4core3Any5__get(asset, "clips"));
  const state = new _M0TP36mizchi21kagura__platform__web9web__core12MotionPlayer(clips, _M0MPC15array5Array2atGRP36mizchi2js4core3AnyE(clips, 0), 0, false, 1, true);
  return _M0MP46mizchi2js8builtins6object6Object6freeze(_M0FP36mizchi2js4core13from__entries([{ _0: "snapshot", _1: () => {
    ...
    const fps = _p;
    return _M0FP36mizchi2js4core13from__entries([{ _0: "clip", _1: _M0MP36mizchi2js4core3Any5__get(state.clip, "id") }, { _0: "time", _1: state.time }, { _0: "duration", _1: _M0MP36mizchi21kagura__platform__web9web__core12MotionPlayer8duration(state) }, { _0: "fps", _1: fps }, { _0: "frame", _1: _M0MP46mizchi2js8builtins4math4Math5round(state.time * fps) }, { _0: "playing", _1: state.playing }, { _0: "speed", _1: state.speed }, { _0: "loop", _1: state.looping }]);
  } }, { _0: "selectClip", _1: (id) => {
    ...
    if (state.time >= _M0MP36mizchi21kagura__platform__web9web__core12MotionPlayer8duration(state)) {
      state.time = 0;
    }
    state.playing = true;
  } }, { _0: "pause", _1: () => {
    ...
    state.time = _M0FP36mizchi21kagura__platform__web9web__core5clamp(_M0FP36mizchi21kagura__platform__web9web__core13require__time(value), 0, _M0MP36mizchi21kagura__platform__web9web__core12MotionPlayer8duration(state));
    state.playing = false;
    ...
    const _p = _M0MP36mizchi2js4core3Any5__get(state.clip, "fps");
    const fps = _p;
    state.time = _M0FP36mizchi21kagura__platform__web9web__core5clamp((_M0MP46mizchi2js8builtins4math4Math5round(state.time * fps) + 0 + direction) / fps, 0, _M0MP36mizchi21kagura__platform__web9web__core12MotionPlayer8duration(state));
    state.playing = false;
  } }, { _0: "setSpeed", _1: (value) => {
    const speed = _M0FP36mizchi21kagura__platform__web9web__core13require__time(value);
    ...
    const delta = _M0FP36mizchi21kagura__platform__web9web__core13require__time(value);
    if (delta < 0) {
    ...
    if (state.time >= _M0MP36mizchi21kagura__platform__web9web__core12MotionPlayer8duration(state)) {
      if (state.looping) {
        state.time = _M0IPC16double6DoublePB3Mod3mod(state.time, _M0MP36mizchi21kagura__platform__web9web__core12MotionPlayer8duration(state));
        return;
      } else {
        state.time = _M0MP36mizchi21kagura__platform__web9web__core12MotionPlayer8duration(state);
        state.playing = false;
        return;
      }
    } else {
...
function _M0FP36mizchi21kagura__platform__web9web__core6vector(x, y) {
  return _M0FP36mizchi2js4core13from__entries([{ _0: "x", _1: x }, { _0: "y", _1: y }]);
}
function _M0FP36mizchi21kagura__platform__web9web__core15geometry__pairs(gpu) {
...
function _M0FP36mizchi21kagura__platform__web9web__core18geometry__snapshot(vertices, indices) {
  return _M0FP36mizchi2js4core13from__entries([{ _0: "vertexData", _1: _M0FP36mizchi21kagura__platform__web9web__core13float32__copy(vertices) }, { _0: "indices", _1: _M0FP36mizchi21kagura__platform__web9web__core12uint32__copy(indices) }, { _0: "immutableGeometry", _1: true }, { _0: "sharedGeometry", _1: true }]);
}
function _M0FP36mizchi21kagura__platform__web9web__core18register__geometry(gpu, id, revision, vertices, indices) {
  let _tmp;
  let _tmp$2;
  ...
  if (!(_p === _p$2)) {
    ...
    const _p$4 = "symbol";
    if (!(_p$3 === _p$4)) {
      _tmp$3 = !_M0FP36mizchi21kagura__platform__web9web__core13safe__integer(id);
    } else {
      _tmp$3 = false;
    }
    _tmp$2 = _tmp$3;
  ...
  if (_tmp$2) {
    ...
    _tmp = !_M0FP36mizchi21kagura__platform__web9web__core13safe__integer(revision) || revision < 0;
  }
  if (_tmp) {
    _M0FP36mizchi21kagura__platform__web9web__core11type__error("Invalid geometry identity/revision");
  }
  let registry;
  ...
  const pairs = _M0FP36mizchi21kagura__platform__web9web__core15geometry__pairs(gpu);
  ...
  if (old.$tag === 1) {
    ...
    if (revision < old_revision) {
      _M0FP36mizchi21kagura__platform__web9web__core12range__error("Stale geometry revision");
    }
    if (revision === old_revision) {
  ...
  const snapshot = _M0FP36mizchi21kagura__platform__web9web__core18geometry__snapshot(vertices, indices);
...
function _M0FP36mizchi21kagura__platform__web9web__core20unregister__geometry(gpu, id) {
  if (_M0FP36mizchi2js4core11is__nullish(_M0MP36mizchi2js4core3Any5__get(gpu, "_geometryRegistry"))) {
    return undefined;
  }
  ...
  if (_bind.$tag === 1) {
    const _Some = _bind;
    const _entry = _Some._0;
    const _bind$2 = _M0MP46mizchi2js8builtins4weak7WeakMap3getGRP36mizchi2js4core3AnyRP46mizchi2js8builtins4weak7WeakMapGRP36mizchi2js4core3AnyRP36mizchi2js4core3AnyEE(_M0FP36mizchi21kagura__platform__web9web__core15geometry__pairs(gpu), _M0MP36mizchi2js4core3Any5__get(_entry, "vertices"));
    if (_bind$2.$tag === 1) {
...
function _M0FP36mizchi21kagura__platform__web9web__core26register__static__geometry(gpu, vertices, indices) {
  const pairs = _M0FP36mizchi21kagura__platform__web9web__core15geometry__pairs(gpu);
  const _bind = _M0MP46mizchi2js8builtins4weak7WeakMap3getGRP36mizchi2js4core3AnyRP46mizchi2js8builtins4weak7WeakMapGRP36mizchi2js4core3AnyRP36mizchi2js4core3AnyEE(pairs, vertices);
  let by_index;
  if (_bind.$tag === 1) {
  ...
  _M0MP46mizchi2js8builtins4weak7WeakMap3setGRP36mizchi2js4core3AnyRP46mizchi2js8builtins4weak7WeakMapGRP36mizchi2js4core3AnyRP36mizchi2js4core3AnyEE(pairs, vertices, by_index);
  const snapshot = _M0FP36mizchi21kagura__platform__web9web__core18geometry__snapshot(vertices, indices);
  _M0MP46mizchi2js8builtins4weak7WeakMap3setGRP36mizchi2js4core3AnyRP46mizchi2js8builtins4weak7WeakMapGRP36mizchi2js4core3AnyRP36mizchi2js4core3AnyEE(by_index, indices, _M0FP36mizchi2js4core13from__entries([{ _0: "id", _1: _M0FP36mizchi21kagura__platform__web9web__core14unique__symbol() }, { _0: "snapshot", _1: snapshot }]));
  return snapshot;
}
function _M0FP36mizchi21kagura__platform__web9web__core18snapshot__vertices(cache, source) {
  ...
  if (_bind.$tag === 1) {
    ...
    if (_M0FP36mizchi21kagura__platform__web9web__core6length(_previous) === _M0FP36mizchi21kagura__platform__web9web__core6length(source)) {
      let i = 0;
      while (true) {
        if (i < _M0FP36mizchi21kagura__platform__web9web__core6length(source)) {
  ...
  const packed = _M0FP36mizchi21kagura__platform__web9web__core13float32__copy(source);
...
function _M0FP36mizchi21kagura__platform__web9web__core17snapshot__indices(cache, source) {
  const _bind = _M0MP46mizchi2js8builtins4weak7WeakMap3getGRP36mizchi2js4core3AnyRP46mizchi2js8builtins4weak7WeakMapGRP36mizchi2js4core3AnyRP36mizchi2js4core3AnyEE(cache, source);
  if (_bind.$tag === 1) {
    const _Some = _bind;
    const _previous = _Some._0;
    if (_M0FP36mizchi21kagura__platform__web9web__core6length(_previous) === _M0FP36mizchi21kagura__platform__web9web__core6length(source)) {
      ...
      while (true) {
        if (i < _M0FP36mizchi21kagura__platform__web9web__core6length(source)) {
          if (!_M0FP36mizchi2js4core5equal(_M0MP36mizchi2js4core3Any16__get__by__index(_previous, i), _M0FP36mizchi21kagura__platform__web9web__core10to__uint32(_M0MP36mizchi2js4core3Any16__get__by__index(source, i)))) {
            break;
          }
          i = i + 1 | 0;
          continue;
  ...
  const packed = _M0FP36mizchi21kagura__platform__web9web__core12uint32__copy(source);
  _M0MP46mizchi2js8builtins4weak7WeakMap3setGRP36mizchi2js4core3AnyRP46mizchi2js8builtins4weak7WeakMapGRP36mizchi2js4core3AnyRP36mizchi2js4core3AnyEE(cache, source, packed);
  return packed;
}
function _M0FP36mizchi21kagura__platform__web9web__core24snapshot__draw__geometry(gpu, vertices, indices) {
  ...
  return _M0FP36mizchi2js4core13from__entries([{ _0: "vertexData", _1: _M0FP36mizchi21kagura__platform__web9web__core18snapshot__vertices(_M0MP36mizchi2js4core3Any5__get(cache, "vertices"), vertices) }, { _0: "indices", _1: _M0FP36mizchi21kagura__platform__web9web__core17snapshot__indices(_M0MP36mizchi2js4core3Any5__get(cache, "indices"), indices) }, { _0: "immutableGeometry", _1: true }]);
}
function _M0FP36mizchi21kagura__platform__web9web__core9pad__axis(value) {
  return _M0FP36mizchi21kagura__platform__web9web__core6finite(value) ? _M0FP36mizchi21kagura__platform__web9web__core5clamp(value, -1, 1) : 0;
}
function _M0FP36mizchi21kagura__platform__web9web__core6button(pressed, value) {
  return _M0FP36mizchi2js4core13from__entries([{ _0: "pressed", _1: pressed }, { _0: "value", _1: value }]);
}
function _M0FP36mizchi21kagura__platform__web9web__core11pad__button(source) {
  const value = _M0FP36mizchi21kagura__platform__web9web__core5field(source, "value");
  return _M0FP36mizchi21kagura__platform__web9web__core6button(_M0FP36mizchi21kagura__platform__web9web__core6truthy(_M0FP36mizchi21kagura__platform__web9web__core5field(source, "pressed")), _M0FP36mizchi21kagura__platform__web9web__core6finite(value) ? _M0FP36mizchi21kagura__platform__web9web__core5clamp(value, 0, 1) : 0);
}
function _M0FP36mizchi21kagura__platform__web9web__core12button__down(source) {
  const value = _M0FP36mizchi21kagura__platform__web9web__core5field(source, "value");
  return _M0FP36mizchi21kagura__platform__web9web__core6truthy(_M0FP36mizchi21kagura__platform__web9web__core5field(source, "pressed")) || _M0FP36mizchi21kagura__platform__web9web__core6finite(value) && value >= 0.55;
}
function _M0FP36mizchi21kagura__platform__web9web__core18normalize__gamepad(pad) {
  ...
  if (!(mapping === _p)) {
    ...
    _tmp = !_M0MP46mizchi2js8builtins6regexp6RegExp6test__(_M0FP36mizchi21kagura__platform__web9web__core11victrix__id, _M0MP36mizchi2js4core3Any5__get(pad, "id")) || (_M0FP36mizchi21kagura__platform__web9web__core6length(axes) !== 10 || _M0FP36mizchi21kagura__platform__web9web__core6length(raw_buttons) < 14);
  }
  if (_tmp) {
  ...
  while (true) {
    ...
    if (_p$4 < _p$3) {
      ...
      _p$2[_p$4] = _M0FP36mizchi21kagura__platform__web9web__core11pad__button(_p$5 < 0 ? _M0FP36mizchi2js4core4null() : _M0MP36mizchi2js4core3Any16__get__by__index(raw_buttons, _p$5));
      _tmp$2 = _p$4 + 1 | 0;
      continue;
    } else {
      break;
  ...
  const buttons = _p$2;
  const _bind = [_M0FP36mizchi21kagura__platform__web9web__core18normalize__gamepadN5tupleS510, _M0FP36mizchi21kagura__platform__web9web__core18normalize__gamepadN5tupleS511];
  const _bind$2 = _bind.length;
  let _tmp$3 = 0;
  while (true) {
    const _ = _tmp$3;
    if (_ < _bind$2) {
      ...
      const value = _M0FP36mizchi21kagura__platform__web9web__core6finite(raw) ? (_M0FP36mizchi21kagura__platform__web9web__core9pad__axis(raw) + 1) / 2 : 0;
      _M0MPC15array5Array3setGRP36mizchi2js4core3AnyE(buttons, _button_index, _M0FP36mizchi21kagura__platform__web9web__core6button(_M0FP36mizchi21kagura__platform__web9web__core12button__down(_M0MPC15array5Array2atGRP36mizchi2js4core3AnyE(buttons, _button_index)) || value >= 0.55, value));
      _tmp$3 = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  if (_M0FP36mizchi21kagura__platform__web9web__core6finite(hat) && (hat >= -1 && hat <= 1)) {
    ...
    if (Math.abs(position - (direction + 0)) < 0.1) {
      ...
      while (true) {
        ...
        if (_ < _bind$4) {
          ...
          _M0MPC15array5Array3setGRP36mizchi2js4core3AnyE(buttons, index, _M0FP36mizchi21kagura__platform__web9web__core6button(true, 1));
          _tmp$4 = _ + 1 | 0;
          continue;
        } else {
          break;
  ...
  while (true) {
    ...
    if (_p$7 < _p$6) {
      ...
      _p$5[_p$7] = _M0FP36mizchi21kagura__platform__web9web__core9pad__axis(_M0MP36mizchi2js4core3Any16__get__by__index(axes, _p$8));
      _tmp$9 = _p$7 + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi21kagura__platform__web9web__core11device__key(pad) {
  ...
  const profile = _M0FP36mizchi21kagura__platform__web9web__core8fallback(_M0MP36mizchi2js4core3Any5__get(pad, "profile"), _M0MP36mizchi2js4core3Any5__get(pad, "mapping"));
...
function _M0FP36mizchi21kagura__platform__web9web__core13radial__stick(dx, dy, radius, dead_zone) {
  const length = _M0MP46mizchi2js8builtins4math4Math5hypot([dx, dy]);
  if (length === 0 || length < radius * dead_zone) {
    return _M0FP36mizchi21kagura__platform__web9web__core13radial__stickN5tupleS512;
  }
...
function _M0MP36mizchi21kagura__platform__web9web__core12GamepadState4stepN8axis__atS82(axes, i) {
  return _M0FP36mizchi21kagura__platform__web9web__core9pad__axis(_M0FP36mizchi2js4core11is__nullish(axes) ? _M0FP36mizchi2js4core9undefined() : _M0MP36mizchi2js4core3Any16__get__by__index(axes, i));
}
function _M0MP36mizchi21kagura__platform__web9web__core12GamepadState4step(self, pads, options) {
  const enabled = _M0FP36mizchi21kagura__platform__web9web__core6truthy(_M0FP36mizchi21kagura__platform__web9web__core8argument(_M0FP36mizchi21kagura__platform__web9web__core5field(options, "enabled"), true));
  const _p = _M0FP36mizchi21kagura__platform__web9web__core8argument(_M0FP36mizchi21kagura__platform__web9web__core5field(options, "now"), 0);
  const now = _p;
  const _p$2 = _M0FP36mizchi21kagura__platform__web9web__core13array__values(pads);
  const _p$3 = [];
  ...
  while (true) {
    ...
    if (_p$5 < _p$4) {
      ...
      if (_M0FP36mizchi21kagura__platform__web9web__core6truthy(_p$6) && !_M0FP36mizchi2js4core5equal(_M0FP36mizchi21kagura__platform__web9web__core5field(_p$6, "connected"), false)) {
  ...
  while (true) {
    ...
    if (_p$7 < _p$6) {
      ...
      _p$5[_p$7] = _M0FP36mizchi21kagura__platform__web9web__core18normalize__gamepad(_p$8);
      _tmp$2 = _p$7 + 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      if (_M0IPC16option6OptionPB2Eq5equalGsE(_M0FP36mizchi21kagura__platform__web9web__core11device__key(candidate), self.identity)) {
  ...
  const next_identity = supported ? _M0FP36mizchi21kagura__platform__web9web__core11device__key(pad) : undefined;
  ...
  if (_bind$3.$tag === 0) {
    ...
    dt = _M0FP36mizchi21kagura__platform__web9web__core5clamp((now - _last) / 1000, 0, 0.05);
  }
  ...
  const axes = _M0FP36mizchi21kagura__platform__web9web__core5field(pad, "axes");
  const _bind$4 = _M0FP36mizchi21kagura__platform__web9web__core13radial__stick(_M0MP36mizchi21kagura__platform__web9web__core12GamepadState4stepN8axis__atS82(axes, 0), _M0MP36mizchi21kagura__platform__web9web__core12GamepadState4stepN8axis__atS82(axes, 1), 1, self.dead_zone);
  const _mx = _bind$4._0;
  const _my = _bind$4._1;
  const _bind$5 = _M0FP36mizchi21kagura__platform__web9web__core13radial__stick(_M0MP36mizchi21kagura__platform__web9web__core12GamepadState4stepN8axis__atS82(axes, 2), _M0MP36mizchi21kagura__platform__web9web__core12GamepadState4stepN8axis__atS82(axes, 3), 1, self.dead_zone);
  const _lx = _bind$5._0;
  const _ly = _bind$5._1;
  const _p$10 = _M0FP36mizchi21kagura__platform__web9web__core13array__values(_M0FP36mizchi21kagura__platform__web9web__core5field(pad, "buttons"));
  ...
  while (true) {
    ...
    if (_p$13 < _p$12) {
      ...
      _p$11[_p$13] = _M0FP36mizchi21kagura__platform__web9web__core12button__down(_p$14);
      _tmp$5 = _p$13 + 1 | 0;
      continue;
    } else {
      break;
  ...
  const _tmp$12 = { _0: "index", _1: _M0FP36mizchi21kagura__platform__web9web__core8fallback(_M0FP36mizchi21kagura__platform__web9web__core5field(pad, "index"), -1) };
  const _tmp$13 = { _0: "id", _1: _M0FP36mizchi21kagura__platform__web9web__core8fallback(_M0FP36mizchi21kagura__platform__web9web__core5field(pad, "id"), connected.length === 0 ? "" : _M0MP36mizchi2js4core3Any5__get(_M0MPC15array5Array2atGRP36mizchi2js4core3AnyE(connected, 0), "id")) };
  const _tmp$14 = { _0: "profile", _1: supported ? _M0FP36mizchi21kagura__platform__web9web__core8fallback(_M0FP36mizchi21kagura__platform__web9web__core5field(pad, "profile"), "standard") : _M0FP36mizchi2js4core4null() };
  const _tmp$15 = { _0: "move", _1: ready ? _M0FP36mizchi21kagura__platform__web9web__core6vector(_mx, _my) : _M0FP36mizchi21kagura__platform__web9web__core6vector(0, 0) };
  const _tmp$16 = { _0: "look", _1: ready ? _M0FP36mizchi21kagura__platform__web9web__core6vector(_lx, _ly) : _M0FP36mizchi21kagura__platform__web9web__core6vector(0, 0) };
...
function _M0FP36mizchi21kagura__platform__web9web__core23create__gamepad__reader(options) {
  const dead_zone = _M0FP36mizchi21kagura__platform__web9web__core8argument(_M0FP36mizchi21kagura__platform__web9web__core5field(options, "deadZone"), 0.18);
  if (!_M0FP36mizchi21kagura__platform__web9web__core6finite(dead_zone) || (dead_zone < 0 || dead_zone >= 1)) {
    _M0FP36mizchi21kagura__platform__web9web__core12range__error("Stick coordinates must be finite, radius positive, and deadZone in [0, 1)");
  }
  const state = new _M0TP36mizchi21kagura__platform__web9web__core12GamepadState(dead_zone, undefined, false, [], [0, 0, 0, 0], undefined, 0, _M0DTPC16option6OptionGdE4None__);
  return _M0FP36mizchi2js4core13from__entries([{ _0: "step", _1: (pads, options$2) => _M0MP36mizchi21kagura__platform__web9web__core12GamepadState4step(state, pads, options$2) }]);
}
function _M0FP36mizchi21kagura__platform__web9web__core10percentile(values, p) {
  const _p = _M0FP36mizchi21kagura__platform__web9web__core13array__values(values);
...
function _M0FP36mizchi21kagura__platform__web9web__core20summarize__intervals(timestamps) {
  const _p = _M0FP36mizchi21kagura__platform__web9web__core13array__values(timestamps);
  const _p$2 = new Array(_p.length);
  const _p$3 = _p.length;
  let _tmp = 0;
  while (true) {
  ...
  return _M0FP36mizchi2js4core13from__entries([{ _0: "frames", _1: values.length }, { _0: "elapsedMs", _1: _M0MP46mizchi2js8builtins4math4Math5round(elapsed) }, { _0: "fps", _1: elapsed > 0 ? _M0FP36mizchi21kagura__platform__web9web__core14fixed__decimal((intervals.length + 0) / (elapsed / 1000), 1) : 0 }, { _0: "p50IntervalMs", _1: _M0FP36mizchi21kagura__platform__web9web__core14fixed__decimal(_M0FP36mizchi21kagura__platform__web9web__core10percentile(intervals, 0.5), 2) }, { _0: "p95IntervalMs", _1: _M0FP36mizchi21kagura__platform__web9web__core14fixed__decimal(_M0FP36mizchi21kagura__platform__web9web__core10percentile(intervals, 0.95), 2) }]);
}
function _M0FP36mizchi21kagura__platform__web9web__core6timing(value) {
  return _M0FP36mizchi21kagura__platform__web9web__core6finite(value) && value >= 0 ? value : _M0FP36mizchi2js4core4null();
}
function _M0FP36mizchi21kagura__platform__web9web__core20read__frame__profile(host) {
  const host$2 = _M0FP36mizchi21kagura__platform__web9web__core8argument(host, _M0FP36mizchi2js4core12global__this());
  const runtime = _M0FP36mizchi21kagura__platform__web9web__core5field(host$2, "__kaguraWebRuntime");
  const gpu = _M0FP36mizchi21kagura__platform__web9web__core5field(runtime, "webgpu");
  if (!_M0FP36mizchi21kagura__platform__web9web__core6truthy(gpu)) {
    return _M0FP36mizchi2js4core4null();
  }
  const phases = _M0FP36mizchi21kagura__platform__web9web__core5field(runtime, "frameProfile");
  const commands = _M0FP36mizchi21kagura__platform__web9web__core13array__values(_M0FP36mizchi21kagura__platform__web9web__core5field(gpu, "commands"));
  let indices = 0;
  let instances = 0;
  let shared = 0;
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      const _p = _M0FP36mizchi21kagura__platform__web9web__core8fallback(_M0FP36mizchi21kagura__platform__web9web__core5field(command, "indexCount"), _M0FP36mizchi21kagura__platform__web9web__core8fallback(_M0FP36mizchi21kagura__platform__web9web__core5field(_M0FP36mizchi21kagura__platform__web9web__core5field(command, "indices"), "length"), 0));
      indices = _tmp$2 + _p;
      instances = instances + _M0MPC16double6Double3max(_M0FP36mizchi21kagura__platform__web9web__core13number__field(command, "instanceCount", 1), 1);
      if (_M0FP36mizchi21kagura__platform__web9web__core6truthy(_M0FP36mizchi21kagura__platform__web9web__core5field(command, "sharedGeometry"))) {
        shared = shared + 1 | 0;
      }
      _tmp = _ + 1 | 0;
      continue;
  ...
  const timing_method = _M0FP36mizchi21kagura__platform__web9web__core8fallback(_M0FP36mizchi21kagura__platform__web9web__core5field(gpu, "_gpuTimingMethod"), _M0FP36mizchi2js4core4null());
  const snapshot = _M0FP36mizchi2js4core13from__entries([{ _0: "version", _1: 1 }, { _0: "frame", _1: _M0FP36mizchi21kagura__platform__web9web__core8fallback(_M0FP36mizchi21kagura__platform__web9web__core5field(gpu, "_submittedFrameCount"), 0) }, { _0: "gpuFrameMs", _1: _M0FP36mizchi2js4core11is__nullish(timing_method) ? _M0FP36mizchi2js4core4null() : _M0FP36mizchi21kagura__platform__web9web__core6timing(_M0FP36mizchi21kagura__platform__web9web__core5field(gpu, _M0FP36mizchi2js4core5equal(timing_method, "timestamp-query") ? "_lastTimestampFrameMs" : "_lastCompletedFrameMs")) }, { _0: "gpuTimingMethod", _1: timing_method }, { _0: "drawCalls", _1: commands.length }, { _0: "indexCount", _1: indices }, { _0: "instanceCount", _1: instances }, { _0: "sharedGeometryDraws", _1: shared }, { _0: "residentGeometryBuffers", _1: _M0FP36mizchi21kagura__platform__web9web__core8fallback(_M0FP36mizchi21kagura__platform__web9web__core5field(_M0FP36mizchi21kagura__platform__web9web__core5field(_M0FP36mizchi21kagura__platform__web9web__core5field(gpu, "_sharedGeometryBuffers"), "resident"), "size"), 0) }]);
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      const key = _bind$2[_];
      _M0MP36mizchi2js4core3Any5__set(snapshot, key, _M0FP36mizchi21kagura__platform__web9web__core6timing(_M0FP36mizchi21kagura__platform__web9web__core5field(phases, key)));
      _tmp$2 = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  const _bind$4 = [_M0FP36mizchi21kagura__platform__web9web__core20read__frame__profileN5tupleS513, _M0FP36mizchi21kagura__platform__web9web__core20read__frame__profileN5tupleS514, _M0FP36mizchi21kagura__platform__web9web__core20read__frame__profileN5tupleS515, _M0FP36mizchi21kagura__platform__web9web__core20read__frame__profileN5tupleS516, _M0FP36mizchi21kagura__platform__web9web__core20read__frame__profileN5tupleS517];
  ...
  while (true) {
    ...
    if (_ < _bind$5) {
      ...
      _M0MP36mizchi2js4core3Any5__set(snapshot, _key, _M0FP36mizchi21kagura__platform__web9web__core6timing(_M0FP36mizchi21kagura__platform__web9web__core5field(gpu, _source)));
      _tmp$3 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi21kagura__platform__web9web__core24install__frame__profiler(host) {
  const host$2 = _M0FP36mizchi21kagura__platform__web9web__core8argument(host, _M0FP36mizchi2js4core12global__this());
  const profiler = _M0MP46mizchi2js8builtins6object6Object6freeze(_M0FP36mizchi2js4core13from__entries([{ _0: "version", _1: 1 }, { _0: "snapshot", _1: () => _M0FP36mizchi21kagura__platform__web9web__core20read__frame__profile(host$2) }]));
  _M0MP36mizchi2js4core3Any5__set(host$2, "__kaguraProfiler", profiler);
  return profiler;
}
function _M0FP36mizchi21kagura__platform__web9web__core13stick__vector(dx, dy, radius, options) {
  const dead_zone = _M0FP36mizchi21kagura__platform__web9web__core8argument(_M0FP36mizchi21kagura__platform__web9web__core5field(options, "deadZone"), 0.14);
  if (!_M0FP36mizchi21kagura__platform__web9web__core6finite(dx) || (!_M0FP36mizchi21kagura__platform__web9web__core6finite(dy) || (!_M0FP36mizchi21kagura__platform__web9web__core6finite(radius) || (!_M0FP36mizchi21kagura__platform__web9web__core6finite(dead_zone) || (radius <= 0 || (dead_zone < 0 || dead_zone >= 1)))))) {
    _M0FP36mizchi21kagura__platform__web9web__core12range__error("Stick coordinates must be finite, radius positive, and deadZone in [0, 1)");
  }
  const _bind = _M0FP36mizchi21kagura__platform__web9web__core13radial__stick(dx, dy, radius, dead_zone);
  const _x = _bind._0;
  const _y = _bind._1;
  return _M0FP36mizchi21kagura__platform__web9web__core6vector(_x, _y);
}
function _M0MP36mizchi21kagura__platform__web9web__core12ControlState7release(self, id) {
...
function _M0FP36mizchi21kagura__platform__web9web__core22create__control__input(options) {
  const capacity = _M0FP36mizchi21kagura__platform__web9web__core8argument(_M0FP36mizchi21kagura__platform__web9web__core5field(options, "capacity"), 8);
  if (!_M0FP36mizchi21kagura__platform__web9web__core13safe__integer(capacity) || capacity < 1) {
    _M0FP36mizchi21kagura__platform__web9web__core12range__error("Command capacity must be positive");
  }
  const state = new _M0TP36mizchi21kagura__platform__web9web__core12ControlState(capacity, [], [], _M0DTPC16option6OptionGdE4None__, 0, 0, false);
  return _M0FP36mizchi2js4core13from__entries([{ _0: "version", _1: 1 }, { _0: "move", _1: (id, dx, dy) => {
    ...
    _M0MP36mizchi21kagura__platform__web9web__core12ControlState7release(state, id);
  } }, { _0: "tap", _1: (key, payload) => {
    if (!_M0FP36mizchi21kagura__platform__web9web__core13safe__integer(key) || key <= 0) {
      _M0FP36mizchi21kagura__platform__web9web__core12range__error("Command key must be a positive integer");
    }
    if (state.commands.length + 0 >= state.capacity) {
      return false;
    }
    _M0MPC15array5Array4pushGRP36mizchi2js4core3AnyE(state.commands, _M0FP36mizchi2js4core13from__entries([{ _0: "key", _1: key }, { _0: "payload", _1: _M0FP36mizchi21kagura__platform__web9web__core8argument(payload, _M0FP36mizchi2js4core4null()) }]));
    return true;
...
export { _M0FP36mizchi21kagura__platform__web9web__core20apply__object__patch as applyObjectPatch, _M0FP36mizchi21kagura__platform__web9web__core24create__dependency__gate as createDependencyGate, _M0FP36mizchi21kagura__platform__web9web__core12is__stride32 as isStride32, _M0FP36mizchi21kagura__platform__web9web__core12is__stride64 as isStride64, _M0FP36mizchi21kagura__platform__web9web__core14is__3d__shader as is3DShader, _M0FP36mizchi21kagura__platform__web9web__core21command__needs__depth as commandNeedsDepth, _M0FP36mizchi21kagura__platform__web9web__core24parse__texture__bindings as parseTextureBindings, _M0FP36mizchi21kagura__platform__web9web__core20get__instance__count as getInstanceCount, _M0FP36mizchi21kagura__platform__web9web__core25get__resource__cache__key as getResourceCacheKey, _M0FP36mizchi21kagura__platform__web9web__core13equal__dwords as equalDwords, _M0FP36mizchi21kagura__platform__web9web__core25instance__uniform__shader as instanceUniformShader, _M0FP36mizchi21kagura__platform__web9web__core22create__motion__player as createMotionPlayer, _M0FP36mizchi21kagura__platform__web9web__core18register__geometry as registerGeometry, _M0FP36mizchi21kagura__platform__web9web__core20unregister__geometry as unregisterGeometry, _M0FP36mizchi21kagura__platform__web9web__core26register__static__geometry as registerStaticGeometry, _M0FP36mizchi21kagura__platform__web9web__core24snapshot__draw__geometry as snapshotDrawGeometry, _M0FP36mizchi21kagura__platform__web9web__core18normalize__gamepad as normalizeGamepad, _M0FP36mizchi21kagura__platform__web9web__core23create__gamepad__reader as createGamepadReader, _M0FP36mizchi21kagura__platform__web9web__core10percentile as percentile, _M0FP36mizchi21kagura__platform__web9web__core20summarize__intervals as summarizeIntervals, _M0FP36mizchi21kagura__platform__web9web__core20read__frame__profile as readFrameProfile, _M0FP36mizchi21kagura__platform__web9web__core24install__frame__profiler as installFrameProfiler, _M0FP36mizchi21kagura__platform__web9web__core13stick__vector as stickVector, _M0FP36mizchi21kagura__platform__web9web__core22create__control__input as createControlInput }
