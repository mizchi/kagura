...
function _M0TPB3MapGiRP36mizchi6kagura11animation3d8NodePoseE(param0, param1, param2, param3, param4, param5, param6) {
  this.entries = param0;
  this.size = param1;
...
function _M0TPB5EntryGiRP36mizchi6kagura11animation3d8NodePoseE(param0, param1, param2, param3, param4, param5) {
  this.prev = param0;
  this.next = param1;
  this.psl = param2;
  this.hash = param3;
...
function _M0TP36mizchi6kagura11animation3d15AnimationPlayer(param0, param1, param2, param3, param4) {
  this.clip = param0;
  this.time = param1;
  this.playing = param2;
  this.looping = param3;
...
function _M0TPB9ArrayViewGUiRP36mizchi6kagura11animation3d8NodePoseEE(param0, param1, param2) {
  this.buf = param0;
  this.start = param1;
  this.end = param2;
}
function _M0TP36mizchi6kagura11animation3d8NodePose(param0, param1, param2, param3) {
  this.node_index = param0;
  this.translation = param1;
...
function _M0TP36mizchi6kagura10skeleton3d8Skeleton(param0, param1) {
  this.bones = param0;
...
function _M0TP36mizchi6kagura7scene3d13SkinningState(param0, param1, param2) {
  this.skin = param0;
  this.skinning_matrices = param1;
  this.packed_vertex_data = param2;
}
...
function _M0TP36mizchi6kagura11animation3d11AnimChannel(param0, param1, param2, param3, param4) {
  this.node_index = param0;
  this.target = param1;
...
function _M0TP36mizchi6kagura11animation3d13AnimationClip(param0, param1, param2) {
  this.name = param0;
  this.channels = param1;
  this.duration = param2;
}
function _M0TP36mizchi6kagura10skeleton3d8SkinData(param0, param1, param2) {
  this.joint_indices = param0;
  this.weights = param1;
  this.vertex_count = param2;
}
function _M0TP36mizchi6kagura10skeleton3d4Bone(param0, param1, param2) {
  this.name = param0;
  this.parent = param1;
  this.local_transform = param2;
}
function _M0TP26mizchi14skeletal__anim8Tentacle(param0, param1, param2, param3, param4, param5, param6, param7) {
  this.skeleton = param0;
  this.bind_mesh = param1;
  this.skin_data = param2;
  this.packed_vertex_data = param3;
  this.player = param4;
  this.base_position = param5;
  this.color = param6;
  this.local_poses = param7;
}
function _M0TP26mizchi14skeletal__anim9DemoState(param0, param1, param2, param3, param4, param5, param6, param7) {
  this.tentacles = param0;
  this.ground_mesh = param1;
  this.camera = param2;
  this.lighting = param3;
  this.input = param4;
  this.shader3d = param5;
  this.shader3d_skinned = param6;
  this.frame = param7;
}
...
const _M0FPB33brute__force__find_2econstr_2f211 = 0;
const _M0FPB43boyer__moore__horspool__find_2econstr_2f197 = 0;
...
const _M0FPC14math34trig__reduce_2etwo__over__pi_2f716 = [0, 683565275, -1819212470, 2131351028, 2102212464, 920167782, 1326507024, 0];
...
function _M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(self, index) {
  const len = self.length;
  if (index >= 0 && index < len) {
    $bound_check(self, index);
    return self[index];
...
function _M0MPC15array9ArrayView6lengthGUiRP36mizchi6kagura11animation3d8NodePoseEE(self) {
  return self.end - self.start | 0;
}
...
function _M0FPB28boyer__moore__horspool__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FPB43boyer__moore__horspool__find_2econstr_2f197;
  }
}
function _M0FPB18brute__force__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FPB33brute__force__find_2econstr_2f211;
  }
}
...
function _M0MPC16option6Option6unwrapGRPB5EntryGiRP36mizchi6kagura11animation3d8NodePoseEE(self) {
  if (self === undefined) {
    return $panic();
  } else {
    const _Some = self;
...
function _M0MPC15array5Array4makeGRP36mizchi6kagura6math3d4Mat4E(len, elem) {
  const arr = new Array(len);
  let _tmp = 0;
  while (true) {
    const i = _tmp;
...
function _M0MPC15array5Array3setGRP36mizchi6kagura11transform3d11Transform3DE(self, index, value) {
  const len = self.length;
  if (index >= 0 && index < len) {
    $bound_check(self, index);
    self[index] = value;
...
function _M0MPB3Map11new_2einnerGiRP36mizchi6kagura11animation3d8NodePoseE(capacity) {
  const capacity$2 = _M0MPC13int3Int20next__power__of__two(capacity);
  const _bind = capacity$2 - 1 | 0;
  const _bind$2 = _M0FPB21calc__grow__threshold(capacity$2);
  const _bind$3 = $make_array_len_and_init(capacity$2, undefined);
  const _bind$4 = undefined;
  return new _M0TPB3MapGiRP36mizchi6kagura11animation3d8NodePoseE(_bind$3, 0, capacity$2, _bind, _bind$2, _bind$4, -1);
}
function _M0MPB3Map20add__entry__to__tailGiRP36mizchi6kagura11animation3d8NodePoseE(self, idx, entry) {
  ...
  if (_bind === -1) {
    ...
    _M0MPC16option6Option6unwrapGRPB5EntryGiRP36mizchi6kagura11animation3d8NodePoseEE(_tmp[_bind]).next = entry;
  }
  self.tail = idx;
  const _tmp = self.entries;
...
function _M0MPB3Map10set__entryGiRP36mizchi6kagura11animation3d8NodePoseE(self, entry, new_idx) {
  const _tmp = self.entries;
...
function _M0MPB3Map10push__awayGiRP36mizchi6kagura11animation3d8NodePoseE(self, idx, entry) {
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      entry$2.psl = psl;
      _M0MPB3Map10set__entryGiRP36mizchi6kagura11animation3d8NodePoseE(self, entry$2, idx$2);
      return;
    } else {
      const _Some = _bind;
...
function _M0MPB3Map15set__with__hashGiRP36mizchi6kagura11animation3d8NodePoseE(self, key, value, hash) {
  let _tmp = 0;
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      if (self.size >= self.grow_at) {
        _M0MPB3Map4growGiRP36mizchi6kagura11animation3d8NodePoseE(self);
        _tmp = 0;
      ...
      const entry = new _M0TPB5EntryGiRP36mizchi6kagura11animation3d8NodePoseE(_bind$2, _bind$3, psl, hash, key, value);
      _M0MPB3Map20add__entry__to__tailGiRP36mizchi6kagura11animation3d8NodePoseE(self, idx, entry);
      return undefined;
    } else {
      const _Some = _bind;
      const _curr_entry = _Some;
      ...
      if (psl > _curr_entry.psl) {
        ...
        _M0MPB3Map10push__awayGiRP36mizchi6kagura11animation3d8NodePoseE(self, idx, _curr_entry);
        const _bind$2 = self.tail;
        const _bind$3 = undefined;
        const entry = new _M0TPB5EntryGiRP36mizchi6kagura11animation3d8NodePoseE(_bind$2, _bind$3, psl, hash, key, value);
        _M0MPB3Map20add__entry__to__tailGiRP36mizchi6kagura11animation3d8NodePoseE(self, idx, entry);
...
function _M0MPB3Map4growGiRP36mizchi6kagura11animation3d8NodePoseE(self) {
  ...
  while (true) {
    ...
    if (_param === undefined) {
      ...
      const _hash = _x.hash;
      _M0MPB3Map15set__with__hashGiRP36mizchi6kagura11animation3d8NodePoseE(self, _key, _value, _hash);
      _tmp = _next;
      continue;
    }
  }
}
function _M0MPB3Map3setGiRP36mizchi6kagura11animation3d8NodePoseE(self, key, value) {
  _M0MPB3Map15set__with__hashGiRP36mizchi6kagura11animation3d8NodePoseE(self, key, value, _M0IP016_24default__implPB4Hash4hashGiE(key));
}
function _M0MPB3Map11from__arrayGiRP36mizchi6kagura11animation3d8NodePoseE(arr) {
  const length = _M0MPC15array9ArrayView6lengthGUiRP36mizchi6kagura11animation3d8NodePoseEE(arr);
  let capacity = _M0MPC13int3Int20next__power__of__two(length);
  if (length > _M0FPB21calc__grow__threshold(capacity)) {
    capacity = Math.imul(capacity, 2) | 0;
  }
  const m = _M0MPB3Map11new_2einnerGiRP36mizchi6kagura11animation3d8NodePoseE(capacity);
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      _M0MPB3Map3setGiRP36mizchi6kagura11animation3d8NodePoseE(m, e._0, e._1);
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MPB3Map3getGiRP36mizchi6kagura11animation3d8NodePoseE(self, key) {
...
function _M0MPB3Map4eachGiRP36mizchi6kagura11animation3d8NodePoseE(self, f) {
  let _tmp = self.head;
  while (true) {
    const _param = _tmp;
    if (_param === undefined) {
...
function _M0FPB40fixed__choose__pivot__by_2esort__2_2f560(_env, a, b) {
  const swaps = _env._2;
  const arr = _env._1;
  const cmp = _env._0;
...
function _M0FPB40fixed__choose__pivot__by_2esort__3_2f561(_env, a, b, c) {
  _M0FPB40fixed__choose__pivot__by_2esort__2_2f560(_env, a, b);
  _M0FPB40fixed__choose__pivot__by_2esort__2_2f560(_env, b, c);
  _M0FPB40fixed__choose__pivot__by_2esort__2_2f560(_env, a, b);
}
function _M0FPB24fixed__choose__pivot__byGUiRP36mizchi6kagura7scene3d8Object3DEE(arr, cmp) {
  ...
  if (len >= 8) {
    ...
    if (len > 50) {
      _M0FPB40fixed__choose__pivot__by_2esort__3_2f561(_env, a - 1 | 0, a, a + 1 | 0);
      _M0FPB40fixed__choose__pivot__by_2esort__3_2f561(_env, b - 1 | 0, b, b + 1 | 0);
      _M0FPB40fixed__choose__pivot__by_2esort__3_2f561(_env, c - 1 | 0, c, c + 1 | 0);
    }
    _M0FPB40fixed__choose__pivot__by_2esort__3_2f561(_env, a, b, c);
  }
  if (swaps.val === 12) {
...
function _M0FPC14math12trig__reduce(x, switch_over) {
  ...
  const ind = exp >> 5;
  exp = exp & 31;
  let hi = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f716, ind);
  let mi = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f716, ind + 1 | 0);
  let lo = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f716, ind + 2 | 0);
  const tp = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f716, ind + 3 | 0);
  if (exp > 0) {
...
function _M0MP36mizchi6kagura6math3d4Vec34lerp(self, other, t) {
  return new _M0TP36mizchi6kagura6math3d4Vec3(self.x + (other.x - self.x) * t, self.y + (other.y - self.y) * t, self.z + (other.z - self.z) * t);
}
...
function _M0MP36mizchi6kagura6math3d10Quaternion5slerp(self, other, t) {
  const dot = new _M0TPC13ref3RefGdE(self.x * other.x + self.y * other.y + self.z * other.z + self.w * other.w);
  const bx = new _M0TPC13ref3RefGdE(other.x);
  const by = new _M0TPC13ref3RefGdE(other.y);
  const bz = new _M0TPC13ref3RefGdE(other.z);
  const bw = new _M0TPC13ref3RefGdE(other.w);
  if (dot.val < 0) {
    dot.val = -dot.val;
    bx.val = -bx.val;
    by.val = -by.val;
  ...
  if (dot.val > 0.9995) {
    ...
    const theta = _M0FPC14math4acos(dot.val);
    const sin_theta = _M0FPC14math3sin(theta);
    const s0 = _M0FPC14math3sin((1 - t) * theta) / sin_theta;
    const s1 = _M0FPC14math3sin(t * theta) / sin_theta;
    return new _M0TP36mizchi6kagura6math3d10Quaternion(self.x * s0 + bx.val * s1, self.y * s0 + by.val * s1, self.z * s0 + bz.val * s1, self.w * s0 + bw.val * s1);
  }
}
function _M0MP36mizchi6kagura11transform3d11Transform3D3new() {
  return new _M0TP36mizchi6kagura11transform3d11Transform3D(_M0MP36mizchi6kagura6math3d4Vec34zero(), _M0MP36mizchi6kagura6math3d10Quaternion8identity(), _M0MP36mizchi6kagura6math3d4Vec33one());
}
function _M0MP36mizchi6kagura11transform3d11Transform3D14from__position(pos) {
  return new _M0TP36mizchi6kagura11transform3d11Transform3D(pos, _M0MP36mizchi6kagura6math3d10Quaternion8identity(), _M0MP36mizchi6kagura6math3d4Vec33one());
}
...
function _M0MP36mizchi6kagura11transform3d11Transform3D14with__position(self, pos) {
  return new _M0TP36mizchi6kagura11transform3d11Transform3D(pos, self.rotation, self.scale);
}
function _M0MP36mizchi6kagura11transform3d11Transform3D14with__rotation(self, rot) {
  return new _M0TP36mizchi6kagura11transform3d11Transform3D(self.position, rot, self.scale);
}
function _M0MP36mizchi6kagura11transform3d11Transform3D11with__scale(self, s) {
  return new _M0TP36mizchi6kagura11transform3d11Transform3D(self.position, self.rotation, s);
}
function _M0MP36mizchi6kagura11animation3d15AnimationPlayer3new(clip) {
  return new _M0TP36mizchi6kagura11animation3d15AnimationPlayer(clip, 0, true, true, 1);
}
function _M0MP36mizchi6kagura11animation3d15AnimationPlayer6update(self, dt) {
  ...
  if (self.looping && self.clip.duration > 0) {
    self.time = _M0IPC16double6DoublePB3Mod3mod(self.time, self.clip.duration);
    if (self.time < 0) {
...
function _M0FP36mizchi6kagura11animation3d14find__keyframe(times, time) {
  ...
  if (time <= _M0MPC15array5Array2atGdE(times, 0)) {
    return 0;
  }
  if (time >= _M0MPC15array5Array2atGdE(times, len - 1 | 0)) {
    return len - 1 | 0;
  }
  const lo = new _M0TPC13ref3RefGiE(0);
  const hi = new _M0TPC13ref3RefGiE(len - 1 | 0);
  while (true) {
    if (lo.val < (hi.val - 1 | 0)) {
      ...
      if (_M0MPC15array5Array2atGdE(times, mid) <= time) {
        lo.val = mid;
      } else {
        hi.val = mid;
      }
...
function _M0FP36mizchi6kagura11animation3d12sample__quat(channel, time) {
  ...
  if (time <= _M0MPC15array5Array2atGdE(channel.times, 0)) {
    return _M0MP36mizchi6kagura6math3d10Quaternion3new(_M0MPC15array5Array2atGdE(channel.values, 0), _M0MPC15array5Array2atGdE(channel.values, 1), _M0MPC15array5Array2atGdE(channel.values, 2), _M0MPC15array5Array2atGdE(channel.values, 3));
  }
  if (time >= _M0MPC15array5Array2atGdE(channel.times, len - 1 | 0)) {
    const i = Math.imul(len - 1 | 0, 4) | 0;
    return _M0MP36mizchi6kagura6math3d10Quaternion3new(_M0MPC15array5Array2atGdE(channel.values, i), _M0MPC15array5Array2atGdE(channel.values, i + 1 | 0), _M0MPC15array5Array2atGdE(channel.values, i + 2 | 0), _M0MPC15array5Array2atGdE(channel.values, i + 3 | 0));
  }
  const idx = _M0FP36mizchi6kagura11animation3d14find__keyframe(channel.times, time);
  const q0 = _M0MP36mizchi6kagura6math3d10Quaternion3new(_M0MPC15array5Array2atGdE(channel.values, Math.imul(idx, 4) | 0), _M0MPC15array5Array2atGdE(channel.values, (Math.imul(idx, 4) | 0) + 1 | 0), _M0MPC15array5Array2atGdE(channel.values, (Math.imul(idx, 4) | 0) + 2 | 0), _M0MPC15array5Array2atGdE(channel.values, (Math.imul(idx, 4) | 0) + 3 | 0));
  ...
  if (_bind === 0) {
    ...
    const t0 = _M0MPC15array5Array2atGdE(channel.times, idx);
    const t1 = _M0MPC15array5Array2atGdE(channel.times, next);
    const dt = t1 - t0;
    const t = dt > 1e-10 ? (time - t0) / dt : 0;
    const q1 = _M0MP36mizchi6kagura6math3d10Quaternion3new(_M0MPC15array5Array2atGdE(channel.values, Math.imul(next, 4) | 0), _M0MPC15array5Array2atGdE(channel.values, (Math.imul(next, 4) | 0) + 1 | 0), _M0MPC15array5Array2atGdE(channel.values, (Math.imul(next, 4) | 0) + 2 | 0), _M0MPC15array5Array2atGdE(channel.values, (Math.imul(next, 4) | 0) + 3 | 0));
...
function _M0FP36mizchi6kagura11animation3d12sample__vec3(channel, time) {
  ...
  if (time <= _M0MPC15array5Array2atGdE(channel.times, 0)) {
    return _M0MP36mizchi6kagura6math3d4Vec33new(_M0MPC15array5Array2atGdE(channel.values, 0), _M0MPC15array5Array2atGdE(channel.values, 1), _M0MPC15array5Array2atGdE(channel.values, 2));
  }
  if (time >= _M0MPC15array5Array2atGdE(channel.times, len - 1 | 0)) {
    const i = Math.imul(len - 1 | 0, 3) | 0;
    return _M0MP36mizchi6kagura6math3d4Vec33new(_M0MPC15array5Array2atGdE(channel.values, i), _M0MPC15array5Array2atGdE(channel.values, i + 1 | 0), _M0MPC15array5Array2atGdE(channel.values, i + 2 | 0));
  }
  const idx = _M0FP36mizchi6kagura11animation3d14find__keyframe(channel.times, time);
  const v0 = _M0MP36mizchi6kagura6math3d4Vec33new(_M0MPC15array5Array2atGdE(channel.values, Math.imul(idx, 3) | 0), _M0MPC15array5Array2atGdE(channel.values, (Math.imul(idx, 3) | 0) + 1 | 0), _M0MPC15array5Array2atGdE(channel.values, (Math.imul(idx, 3) | 0) + 2 | 0));
  const _bind = channel.interpolation;
  if (_bind === 0) {
    return v0;
  } else {
    ...
    const dt = t1 - t0;
    const t = dt > 1e-10 ? (time - t0) / dt : 0;
    const v1 = _M0MP36mizchi6kagura6math3d4Vec33new(_M0MPC15array5Array2atGdE(channel.values, Math.imul(next, 3) | 0), _M0MPC15array5Array2atGdE(channel.values, (Math.imul(next, 3) | 0) + 1 | 0), _M0MPC15array5Array2atGdE(channel.values, (Math.imul(next, 3) | 0) + 2 | 0));
...
function _M0MP36mizchi6kagura11animation3d15AnimationPlayer6sample(self) {
  const _bind = [];
  const pose_map = _M0MPB3Map11from__arrayGiRP36mizchi6kagura11animation3d8NodePoseE(new _M0TPB9ArrayViewGUiRP36mizchi6kagura11animation3d8NodePoseEE(_bind, 0, 0));
  const _bind$2 = self.clip.channels;
  const _bind$3 = _bind$2.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
    if (_ < _bind$3) {
      const channel = _bind$2[_];
      const node_idx = channel.node_index;
      let pose;
      const _bind$4 = _M0MPB3Map3getGiRP36mizchi6kagura11animation3d8NodePoseE(pose_map, node_idx);
      if (_bind$4 === undefined) {
        const p = new _M0TP36mizchi6kagura11animation3d8NodePose(node_idx, undefined, undefined, undefined);
        _M0MPB3Map3setGiRP36mizchi6kagura11animation3d8NodePoseE(pose_map, node_idx, p);
        pose = p;
      } else {
        const _Some = _bind$4;
        const _p = _Some;
      ...
      const _bind$5 = channel.target;
      switch (_bind$5) {
        case 0: {
          const v = _M0FP36mizchi6kagura11animation3d12sample__vec3(channel, self.time);
          _M0MPB3Map3setGiRP36mizchi6kagura11animation3d8NodePoseE(pose_map, node_idx, new _M0TP36mizchi6kagura11animation3d8NodePose(pose.node_index, v, pose.rotation, pose.scale));
          break;
        }
        case 1: {
          const q = _M0FP36mizchi6kagura11animation3d12sample__quat(channel, self.time);
          _M0MPB3Map3setGiRP36mizchi6kagura11animation3d8NodePoseE(pose_map, node_idx, new _M0TP36mizchi6kagura11animation3d8NodePose(pose.node_index, pose.translation, q, pose.scale));
          break;
        }
        default: {
          const v$2 = _M0FP36mizchi6kagura11animation3d12sample__vec3(channel, self.time);
          _M0MPB3Map3setGiRP36mizchi6kagura11animation3d8NodePoseE(pose_map, node_idx, new _M0TP36mizchi6kagura11animation3d8NodePose(pose.node_index, pose.translation, pose.rotation, v$2));
        }
      }
      _tmp = _ + 1 | 0;
      continue;
  ...
  const result = [];
  _M0MPB3Map4eachGiRP36mizchi6kagura11animation3d8NodePoseE(pose_map, (_k, v) => {
    _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(result, v);
  });
  return result;
}
...
function _M0MP36mizchi6kagura10skeleton3d8Skeleton3new(bones, inverse_bind_matrices) {
  return new _M0TP36mizchi6kagura10skeleton3d8Skeleton(bones, inverse_bind_matrices);
}
function _M0MP36mizchi6kagura10skeleton3d8Skeleton26compute__world__transforms(self, local_poses) {
  ...
  const world = _M0MPC15array5Array4makeGRP36mizchi6kagura6math3d4Mat4E(count, _M0MP36mizchi6kagura6math3d4Mat48identity());
  const _bind = 0;
  let _tmp = _bind;
  while (true) {
    const i = _tmp;
    if (i < count) {
      const local_mat = _M0MP36mizchi6kagura11transform3d11Transform3D8to__mat4(_M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(local_poses, i));
      const parent = _M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(self.bones, i).parent;
      if (parent < 0) {
        _M0MPC15array5Array3setGRP36mizchi6kagura11transform3d11Transform3DE(world, i, local_mat);
      } else {
        _M0MPC15array5Array3setGRP36mizchi6kagura11transform3d11Transform3DE(world, i, _M0MP36mizchi6kagura6math3d4Mat48multiply(_M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(world, parent), local_mat));
      }
      _tmp = i + 1 | 0;
      continue;
    } else {
...
function _M0MP36mizchi6kagura10skeleton3d8Skeleton27compute__skinning__matrices(self, world_transforms) {
  const count = self.bones.length;
  const result = _M0MPC15array5Array4makeGRP36mizchi6kagura6math3d4Mat4E(count, _M0MP36mizchi6kagura6math3d4Mat48identity());
  const _bind = 0;
  let _tmp = _bind;
  while (true) {
    const i = _tmp;
    if (i < count) {
      _M0MPC15array5Array3setGRP36mizchi6kagura11transform3d11Transform3DE(result, i, _M0MP36mizchi6kagura6math3d4Mat48multiply(_M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(world_transforms, i), _M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(self.inverse_bind_matrices, i)));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    ...
    if (i < bone_count) {
      ...
      while (true) {
        const j = _tmp$2;
        if (j < _bind$3) {
          const _tmp$3 = _M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(skinning_matrices, i).elements;
...
function _M0MP36mizchi6kagura7scene3d13SkinningState17new__with__packed(skin, skinning_matrices, packed_vertex_data) {
  return new _M0TP36mizchi6kagura7scene3d13SkinningState(skin, skinning_matrices, new _M0DTPC16option6OptionGRPB5ArrayGdEE4Some(packed_vertex_data));
}
...
function _M0FP36mizchi6kagura7scene3d23sort__objects__for__gpu(objects) {
  ...
  while (true) {
    const i = _tmp;
    if (i < _bind$2) {
      _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(ordered, { _0: i, _1: _M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(objects, i) });
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP26mizchi14skeletal__anim37compute__tentacle__skinning__matrices(t) {
  ...
  while (true) {
    const i = _tmp;
    if (i < _M0FP26mizchi14skeletal__anim10num__bones) {
      _M0MPC15array5Array3setGRP36mizchi6kagura11transform3d11Transform3DE(t.local_poses, i, _M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(t.skeleton.bones, i).local_transform);
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
    ...
    if (_ < _bind$2) {
      ...
      if (idx >= 0 && idx < _M0FP26mizchi14skeletal__anim10num__bones) {
        ...
        _L: {
          ...
          _M0MPC15array5Array3setGRP36mizchi6kagura11transform3d11Transform3DE(t.local_poses, idx, _M0MP36mizchi6kagura11transform3d11Transform3D14with__rotation(_M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(t.local_poses, idx), q));
        }
        let v;
        _L$2: {
          _L$3: {
            const _bind$3 = pose.translation;
            if (_bind$3 === undefined) {
            } else {
              const _Some = _bind$3;
              const _v = _Some;
          ...
          _M0MPC15array5Array3setGRP36mizchi6kagura11transform3d11Transform3DE(t.local_poses, idx, _M0MP36mizchi6kagura11transform3d11Transform3D14with__position(_M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(t.local_poses, idx), v));
        }
        let v$2;
        _L$3: {
          _L$4: {
            const _bind$3 = pose.scale;
            if (_bind$3 === undefined) {
            } else {
              const _Some = _bind$3;
              const _v = _Some;
          ...
          _M0MPC15array5Array3setGRP36mizchi6kagura11transform3d11Transform3DE(t.local_poses, idx, _M0MP36mizchi6kagura11transform3d11Transform3D11with__scale(_M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(t.local_poses, idx), v$2));
        }
      }
      _tmp$2 = _ + 1 | 0;
      continue;
...
function _M0MP26mizchi14skeletal__anim9DemoState4draw(self, ctx) {
  ...
  while (true) {
    ...
    if (_ < _bind$2) {
      ...
      _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(objects, _M0FP36mizchi6kagura7scene3d8object3d(t.bind_mesh, t.base_position, undefined, undefined, t.color, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d8MaterialE4None__, _M0DTPC16option6OptionGdE4None__, new _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d13SkinningStateE4Some(_M0MP36mizchi6kagura7scene3d13SkinningState17new__with__packed(t.skin_data, skinning_matrices, t.packed_vertex_data))));
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(objects, _M0FP36mizchi6kagura7scene3d8object3d(self.ground_mesh, _M0MP36mizchi6kagura6math3d4Vec33new(0, -0.05, 0), undefined, undefined, _M0MP36mizchi6kagura6math3d4Vec43new(0.4, 0.5, 0.35, 1), _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d8MaterialE4None__, new _M0DTPC16option6OptionGdE4Some(100), _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d13SkinningStateE4None__));
...
function _M0FP26mizchi14skeletal__anim26build__tentacle__animation(phase_offset) {
  ...
  while (true) {
    const bone_i = _tmp;
    if (bone_i < _M0FP26mizchi14skeletal__anim10num__bones) {
      const times = [];
      const values = [];
      ...
      while (true) {
        const k = _tmp$2;
        if (k < _M0FP26mizchi14skeletal__anim14num__keyframes) {
          const t = (k + 0) / ((_M0FP26mizchi14skeletal__anim14num__keyframes - 1 | 0) + 0) * _M0FP26mizchi14skeletal__anim14anim__duration;
          _M0MPC15array5Array4pushGdE(times, t);
          const angle = amplitude * _M0FPC14math3sin(t * freq + phase_offset + (bone_i + 0) * 0.5);
          const half = angle / 2;
          const sx = _M0FPC14math3sin(half);
          const cx = _M0FPC14math3cos(half);
          _M0MPC15array5Array4pushGdE(values, 0);
          _M0MPC15array5Array4pushGdE(values, 0);
          _M0MPC15array5Array4pushGdE(values, sx);
          _M0MPC15array5Array4pushGdE(values, cx);
          _tmp$2 = k + 1 | 0;
          continue;
        } else {
          break;
      ...
      _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(channels, new _M0TP36mizchi6kagura11animation3d11AnimChannel(bone_i, 1, 1, times, values));
      _tmp = bone_i + 1 | 0;
      continue;
    } else {
      break;
  ...
  return new _M0TP36mizchi6kagura11animation3d13AnimationClip("tentacle_wave", channels, _M0FP26mizchi14skeletal__anim14anim__duration);
}
function _M0FP26mizchi14skeletal__anim21build__tentacle__mesh() {
  ...
  const joint_indices = [];
  const weights = [];
  const vertex_count = new _M0TPC13ref3RefGiE(0);
  const _bind = 1;
  let _tmp = _bind;
  while (true) {
    const bone_i = _tmp;
    if (bone_i < _M0FP26mizchi14skeletal__anim10num__bones) {
      ...
      while (true) {
        ...
        if (face < _bind$3) {
          ...
          let nz;
          _L: {
            const _bind$4 = _M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(normals, face);
            const _nx = _bind$4._0;
            const _ny = _bind$4._1;
            const _nz = _bind$4._2;
            ny = _ny;
            nx = _nx;
            nz = _nz;
            break _L;
          ...
          while (true) {
            ...
            if (ci < _bind$5) {
              ...
              let pz;
              _L$2: {
                const _bind$6 = _M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(corners, ci);
                const _px = _bind$6._0;
                const _py = _bind$6._1;
                const _pz = _bind$6._2;
                py = _py;
                px = _px;
                pz = _pz;
                break _L$2;
              }
              _M0MPC15array5Array4pushGdE(verts, px);
              _M0MPC15array5Array4pushGdE(verts, py);
              _M0MPC15array5Array4pushGdE(verts, pz);
              _M0MPC15array5Array4pushGdE(verts, nx);
              _M0MPC15array5Array4pushGdE(verts, 0);
              _M0MPC15array5Array4pushGdE(verts, nz);
              _M0MPC15array5Array4pushGdE(verts, ci === 0 || ci === 3 ? 0 : 1);
              _M0MPC15array5Array4pushGdE(verts, ci < 2 ? 0 : 1);
              const assigned_bone = ci < 2 ? ((bone_i - 1 | 0) > 0 ? bone_i - 1 | 0 : 0) : bone_i;
              _M0MPC15array5Array4pushGiE(joint_indices, assigned_bone);
              _M0MPC15array5Array4pushGiE(joint_indices, 0);
              _M0MPC15array5Array4pushGiE(joint_indices, 0);
              _M0MPC15array5Array4pushGiE(joint_indices, 0);
              _M0MPC15array5Array4pushGdE(weights, 1);
              _M0MPC15array5Array4pushGdE(weights, 0);
              _M0MPC15array5Array4pushGdE(weights, 0);
              _M0MPC15array5Array4pushGdE(weights, 0);
          ...
          _M0MPC15array5Array4pushGiE(indices, fi);
          _M0MPC15array5Array4pushGiE(indices, fi + 1 | 0);
          _M0MPC15array5Array4pushGiE(indices, fi + 2 | 0);
          _M0MPC15array5Array4pushGiE(indices, fi);
          _M0MPC15array5Array4pushGiE(indices, fi + 2 | 0);
          _M0MPC15array5Array4pushGiE(indices, fi + 3 | 0);
          _tmp$2 = face + 1 | 0;
          continue;
        } else {
          break;
  ...
  while (true) {
    ...
    if (ci < _bind$3) {
      ...
      let pz;
      _L: {
        const _bind$4 = _M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(cap_corners, ci);
        const _px = _bind$4._0;
        const _py = _bind$4._1;
        const _pz = _bind$4._2;
        py = _py;
        px = _px;
        pz = _pz;
        break _L;
      ...
      _M0MPC15array5Array4pushGdE(verts, pz);
      _M0MPC15array5Array4pushGdE(verts, 0);
      _M0MPC15array5Array4pushGdE(verts, 1);
      _M0MPC15array5Array4pushGdE(verts, 0);
      _M0MPC15array5Array4pushGdE(verts, ci === 0 || ci === 3 ? 0 : 1);
      _M0MPC15array5Array4pushGdE(verts, ci < 2 ? 0 : 1);
      _M0MPC15array5Array4pushGiE(joint_indices, _M0FP26mizchi14skeletal__anim10num__bones - 1 | 0);
      _M0MPC15array5Array4pushGiE(joint_indices, 0);
      _M0MPC15array5Array4pushGiE(joint_indices, 0);
      _M0MPC15array5Array4pushGiE(joint_indices, 0);
      _M0MPC15array5Array4pushGdE(weights, 1);
  ...
  _M0MPC15array5Array4pushGiE(indices, cap_base);
  _M0MPC15array5Array4pushGiE(indices, cap_base + 1 | 0);
  _M0MPC15array5Array4pushGiE(indices, cap_base + 2 | 0);
  _M0MPC15array5Array4pushGiE(indices, cap_base);
  _M0MPC15array5Array4pushGiE(indices, cap_base + 2 | 0);
  _M0MPC15array5Array4pushGiE(indices, cap_base + 3 | 0);
  const mesh = _M0MP36mizchi6kagura6mesh3d6Mesh3D3new(verts, indices);
  const skin = new _M0TP36mizchi6kagura10skeleton3d8SkinData(joint_indices, weights, vertex_count.val);
  return { _0: mesh, _1: skin };
}
function _M0FP26mizchi14skeletal__anim25build__tentacle__skeleton() {
  const bones = [];
  const ibms = [];
  _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(bones, new _M0TP36mizchi6kagura10skeleton3d4Bone("root", -1, _M0MP36mizchi6kagura11transform3d11Transform3D3new()));
  const _bind = 1;
  let _tmp = _bind;
  while (true) {
    const i = _tmp;
    if (i < _M0FP26mizchi14skeletal__anim10num__bones) {
      _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(bones, new _M0TP36mizchi6kagura10skeleton3d4Bone(`bone_${_M0MPC13int3Int18to__string_2einner(i, 10)}`, i - 1 | 0, _M0MP36mizchi6kagura11transform3d11Transform3D14from__position(_M0MP36mizchi6kagura6math3d4Vec33new(0, _M0FP26mizchi14skeletal__anim12bone__length, 0))));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    const i = _tmp$2;
    if (i < _M0FP26mizchi14skeletal__anim10num__bones) {
      _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(rest_poses, _M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(bones, i).local_transform);
      _tmp$2 = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  const world_mats = _M0MPC15array5Array4makeGRP36mizchi6kagura6math3d4Mat4E(_M0FP26mizchi14skeletal__anim10num__bones, _M0MP36mizchi6kagura6math3d4Mat48identity());
  const _bind$3 = 0;
  let _tmp$3 = _bind$3;
  while (true) {
    const i = _tmp$3;
    if (i < _M0FP26mizchi14skeletal__anim10num__bones) {
      const local_mat = _M0MP36mizchi6kagura11transform3d11Transform3D8to__mat4(_M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(rest_poses, i));
      const parent = _M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(bones, i).parent;
      if (parent < 0) {
        _M0MPC15array5Array3setGRP36mizchi6kagura11transform3d11Transform3DE(world_mats, i, local_mat);
      } else {
        _M0MPC15array5Array3setGRP36mizchi6kagura11transform3d11Transform3DE(world_mats, i, _M0MP36mizchi6kagura6math3d4Mat48multiply(_M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(world_mats, parent), local_mat));
      }
      _tmp$3 = i + 1 | 0;
      continue;
    } else {
  ...
  while (true) {
    const i = _tmp$4;
    if (i < _M0FP26mizchi14skeletal__anim10num__bones) {
      _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(ibms, _M0MP36mizchi6kagura6math3d4Mat47inverse(_M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(world_mats, i)));
      _tmp$4 = i + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP26mizchi14skeletal__anim16create__tentacle(position, color, phase) {
  ...
  while (true) {
    const i = _tmp;
    if (i < _M0FP26mizchi14skeletal__anim10num__bones) {
      _M0MPC15array5Array4pushGRP36mizchi6kagura7scene3d8Object3DE(local_poses, _M0MPC15array5Array2atGRP36mizchi6kagura10skeleton3d4BoneE(skeleton.bones, i).local_transform);
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  return new _M0TP26mizchi14skeletal__anim8Tentacle(skeleton, bind_mesh, skin_data, packed_vertex_data, player, position, color, local_poses);
}
function _M0MP26mizchi14skeletal__anim9DemoState3new() {
  ...
  return new _M0TP26mizchi14skeletal__anim9DemoState(tentacles, _M0MP36mizchi6kagura6mesh3d6Mesh3D13plane_2einner(12, 12, 4), camera, lighting, _M0FP36mizchi6kagura9inpututil18new__input__helper(), _M0FP36mizchi6kagura3gfx19new__shader__handle(10, _M0FP36mizchi6kagura6draw3d31shader3d__lit__untextured__wgsl()), _M0FP36mizchi6kagura3gfx19new__shader__handle(11, _M0FP36mizchi6kagura6draw3d28shader3d__lit__skinned__wgsl()), 0);
}
