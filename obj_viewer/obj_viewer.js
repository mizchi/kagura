...
const _M0FP26mizchi11obj__viewer15js__fetch__text = (url, cb) => { fetch(url).then(r => r.text()).then(t => cb(t)); };
function _M0TPC13ref3RefGRP36mizchi6kagura8camera3d11OrbitCameraE(param0) {
  this.val = param0;
}
...
const _M0FP26mizchi11obj__viewer9screen__w = 640;
const _M0FP26mizchi11obj__viewer9screen__h = 480;
...
const _M0FPB33brute__force__find_2econstr_2f189 = 0;
const _M0FPB43boyer__moore__horspool__find_2econstr_2f175 = 0;
...
const _M0FPC14math34trig__reduce_2etwo__over__pi_2f568 = [0, 683565275, -1819212470, 2131351028, 2102212464, 920167782, 1326507024, 0];
...
function _M0FPB28boyer__moore__horspool__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FPB43boyer__moore__horspool__find_2econstr_2f175;
  }
}
function _M0FPB18brute__force__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FPB33brute__force__find_2econstr_2f189;
  }
}
...
function _M0MPC15array5Array4pushGUiiiEE(self, value) {
  _M0MPB7JSArray4push(self, value);
}
...
function _M0FPB40fixed__choose__pivot__by_2esort__2_2f424(_env, a, b) {
  const swaps = _env._2;
  const arr = _env._1;
  const cmp = _env._0;
...
function _M0FPB40fixed__choose__pivot__by_2esort__3_2f425(_env, a, b, c) {
  _M0FPB40fixed__choose__pivot__by_2esort__2_2f424(_env, a, b);
  _M0FPB40fixed__choose__pivot__by_2esort__2_2f424(_env, b, c);
  _M0FPB40fixed__choose__pivot__by_2esort__2_2f424(_env, a, b);
}
function _M0FPB24fixed__choose__pivot__byGUiRP36mizchi6kagura7scene3d8Object3DEE(arr, cmp) {
  ...
  if (len >= 8) {
    ...
    if (len > 50) {
      _M0FPB40fixed__choose__pivot__by_2esort__3_2f425(_env, a - 1 | 0, a, a + 1 | 0);
      _M0FPB40fixed__choose__pivot__by_2esort__3_2f425(_env, b - 1 | 0, b, b + 1 | 0);
      _M0FPB40fixed__choose__pivot__by_2esort__3_2f425(_env, c - 1 | 0, c, c + 1 | 0);
    }
    _M0FPB40fixed__choose__pivot__by_2esort__3_2f425(_env, a, b, c);
  }
  if (swaps.val === 12) {
...
function _M0MPC15array5Array6filterGRP26mizchi5audio5VoiceE(self, f) {
  ...
  while (true) {
    ...
    if (_ < _bind) {
      const v = self[_];
      if (f(v)) {
        _M0MPC15array5Array4pushGUiiiEE(arr, v);
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
...
function _M0FPC14math12trig__reduce(x, switch_over) {
  ...
  const ind = exp >> 5;
  exp = exp & 31;
  let hi = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f568, ind);
  let mi = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f568, ind + 1 | 0);
  let lo = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f568, ind + 2 | 0);
  const tp = _M0MPC15array13ReadOnlyArray2atGjE(_M0FPC14math34trig__reduce_2etwo__over__pi_2f568, ind + 3 | 0);
  if (exp > 0) {
...
function _M0FP36mizchi6kagura6mesh3d18parse__obj__double(chars, start, end) {
  if (start >= end) {
    return 0;
  }
  const i = new _M0TPC13ref3RefGiE(start);
  const negative = new _M0TPC13ref3RefGbE(false);
  if (_M0MPC15array5Array2atGiE(chars, i.val) === 45) {
    negative.val = true;
    i.val = i.val + 1 | 0;
  } else {
    if (_M0MPC15array5Array2atGiE(chars, i.val) === 43) {
      i.val = i.val + 1 | 0;
    }
  }
  const result = new _M0TPC13ref3RefGdE(0);
  while (true) {
    if (i.val < end) {
      const d = _M0MPC15array5Array2atGiE(chars, i.val) - 48 | 0;
      if (d >= 0 && d <= 9) {
        result.val = result.val * 10 + (d + 0);
        i.val = i.val + 1 | 0;
      } else {
        break;
      }
  ...
  if (i.val < end && _M0MPC15array5Array2atGiE(chars, i.val) === 46) {
    i.val = i.val + 1 | 0;
    const frac_div = new _M0TPC13ref3RefGdE(1);
    while (true) {
      if (i.val < end) {
        const d = _M0MPC15array5Array2atGiE(chars, i.val) - 48 | 0;
        if (d >= 0 && d <= 9) {
          frac_div.val = frac_div.val * 10;
          result.val = result.val + (d + 0) / frac_div.val;
          i.val = i.val + 1 | 0;
        } else {
          break;
        }
  ...
  if (i.val < end && (_M0MPC15array5Array2atGiE(chars, i.val) === 101 || _M0MPC15array5Array2atGiE(chars, i.val) === 69)) {
    i.val = i.val + 1 | 0;
    const exp_neg = new _M0TPC13ref3RefGbE(false);
    if (i.val < end && _M0MPC15array5Array2atGiE(chars, i.val) === 45) {
      exp_neg.val = true;
      i.val = i.val + 1 | 0;
    } else {
      if (i.val < end && _M0MPC15array5Array2atGiE(chars, i.val) === 43) {
        i.val = i.val + 1 | 0;
      }
    }
    const exp = new _M0TPC13ref3RefGiE(0);
    while (true) {
      if (i.val < end) {
        const d = _M0MPC15array5Array2atGiE(chars, i.val) - 48 | 0;
        if (d >= 0 && d <= 9) {
          exp.val = (Math.imul(exp.val, 10) | 0) + d | 0;
          i.val = i.val + 1 | 0;
        } else {
          break;
        }
    ...
    const multiplier = new _M0TPC13ref3RefGdE(1);
    const _bind = 0;
    const _bind$2 = exp.val;
    let _tmp = _bind;
    while (true) {
      const _k = _tmp;
      if (_k < _bind$2) {
        multiplier.val = multiplier.val * 10;
        _tmp = _k + 1 | 0;
        continue;
      } else {
        break;
    ...
    if (exp_neg.val) {
      result.val = result.val / multiplier.val;
    } else {
      result.val = result.val * multiplier.val;
    }
  }
  return negative.val ? -result.val : result.val;
}
function _M0FP36mizchi6kagura6mesh3d15parse__obj__int(chars, start, end) {
  if (start >= end) {
    return 0;
  }
  const i = new _M0TPC13ref3RefGiE(start);
  ...
  while (true) {
    if (i.val < end) {
      const d = _M0MPC15array5Array2atGiE(chars, i.val) - 48 | 0;
      if (d >= 0 && d <= 9) {
        result.val = (Math.imul(result.val, 10) | 0) + d | 0;
        i.val = i.val + 1 | 0;
      } else {
        break;
      }
  ...
  return negative.val ? -result.val | 0 : result.val;
}
function _M0FP36mizchi6kagura6mesh3d8skip__ws(chars, start, end) {
  const i = new _M0TPC13ref3RefGiE(start);
  while (true) {
    if (i.val < end && (_M0MPC15array5Array2atGiE(chars, i.val) === 32 || _M0MPC15array5Array2atGiE(chars, i.val) === 9)) {
      i.val = i.val + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi6kagura6mesh3d8find__ws(chars, start, end) {
  const i = new _M0TPC13ref3RefGiE(start);
  while (true) {
    if (i.val < end && (_M0MPC15array5Array2atGiE(chars, i.val) !== 32 && _M0MPC15array5Array2atGiE(chars, i.val) !== 9)) {
      i.val = i.val + 1 | 0;
...
function _M0FP36mizchi6kagura6mesh3d10find__char(chars, ch, start, end) {
  const i = new _M0TPC13ref3RefGiE(start);
  while (true) {
    if (i.val < end && _M0MPC15array5Array2atGiE(chars, i.val) !== ch) {
      i.val = i.val + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP36mizchi6kagura6mesh3d19parse__face__vertex(chars, start, end) {
  const slash1 = _M0FP36mizchi6kagura6mesh3d10find__char(chars, 47, start, end);
  if (slash1 >= end) {
    return { _0: _M0FP36mizchi6kagura6mesh3d15parse__obj__int(chars, start, end), _1: 0, _2: 0 };
  }
  const vi = _M0FP36mizchi6kagura6mesh3d15parse__obj__int(chars, start, slash1);
  const after_slash1 = slash1 + 1 | 0;
  const slash2 = _M0FP36mizchi6kagura6mesh3d10find__char(chars, 47, after_slash1, end);
  if (slash2 >= end) {
    const vti = _M0FP36mizchi6kagura6mesh3d15parse__obj__int(chars, after_slash1, end);
    return { _0: vi, _1: vti, _2: 0 };
  }
  if (slash2 === after_slash1) {
    const vni = _M0FP36mizchi6kagura6mesh3d15parse__obj__int(chars, slash2 + 1 | 0, end);
    return { _0: vi, _1: 0, _2: vni };
  }
  const vti = _M0FP36mizchi6kagura6mesh3d15parse__obj__int(chars, after_slash1, slash2);
  const vni = _M0FP36mizchi6kagura6mesh3d15parse__obj__int(chars, slash2 + 1 | 0, end);
  return { _0: vi, _1: vti, _2: vni };
}
...
function _M0MP36mizchi6kagura6mesh3d6Mesh3D9from__obj(source) {
  const chars = [];
  ...
  while (true) {
    ...
    _M0MPC15array5Array4pushGiE(chars, ch);
    continue;
  }
  ...
  const has_normals = new _M0TPC13ref3RefGbE(false);
  const face_starts = [];
  const face_tri_counts = [];
  const pos = new _M0TPC13ref3RefGiE(0);
  while (true) {
    if (pos.val < len) {
      const line_end = new _M0TPC13ref3RefGiE(pos.val);
      while (true) {
        if (line_end.val < len && (_M0MPC15array5Array2atGiE(chars, line_end.val) !== 10 && _M0MPC15array5Array2atGiE(chars, line_end.val) !== 13)) {
          line_end.val = line_end.val + 1 | 0;
          continue;
        } else {
          break;
        }
      }
      const line_start = _M0FP36mizchi6kagura6mesh3d8skip__ws(chars, pos.val, line_end.val);
      if (line_start < line_end.val) {
        const first = _M0MPC15array5Array2atGiE(chars, line_start);
        if (first === 118) {
          if ((line_start + 1 | 0) < line_end.val && _M0MPC15array5Array2atGiE(chars, line_start + 1 | 0) === 110) {
            const p = new _M0TPC13ref3RefGiE(_M0FP36mizchi6kagura6mesh3d8skip__ws(chars, line_start + 2 | 0, line_end.val));
            const e1 = _M0FP36mizchi6kagura6mesh3d8find__ws(chars, p.val, line_end.val);
            const nx = _M0FP36mizchi6kagura6mesh3d18parse__obj__double(chars, p.val, e1);
            p.val = _M0FP36mizchi6kagura6mesh3d8skip__ws(chars, e1, line_end.val);
            const e2 = _M0FP36mizchi6kagura6mesh3d8find__ws(chars, p.val, line_end.val);
            const ny = _M0FP36mizchi6kagura6mesh3d18parse__obj__double(chars, p.val, e2);
            p.val = _M0FP36mizchi6kagura6mesh3d8skip__ws(chars, e2, line_end.val);
            const e3 = _M0FP36mizchi6kagura6mesh3d8find__ws(chars, p.val, line_end.val);
            const nz = _M0FP36mizchi6kagura6mesh3d18parse__obj__double(chars, p.val, e3);
            _M0MPC15array5Array4pushGdE(normals, nx);
            _M0MPC15array5Array4pushGdE(normals, ny);
            _M0MPC15array5Array4pushGdE(normals, nz);
          } else {
            if ((line_start + 1 | 0) < line_end.val && _M0MPC15array5Array2atGiE(chars, line_start + 1 | 0) === 116) {
              const p = new _M0TPC13ref3RefGiE(_M0FP36mizchi6kagura6mesh3d8skip__ws(chars, line_start + 2 | 0, line_end.val));
              const e1 = _M0FP36mizchi6kagura6mesh3d8find__ws(chars, p.val, line_end.val);
              const u = _M0FP36mizchi6kagura6mesh3d18parse__obj__double(chars, p.val, e1);
              p.val = _M0FP36mizchi6kagura6mesh3d8skip__ws(chars, e1, line_end.val);
              const e2 = _M0FP36mizchi6kagura6mesh3d8find__ws(chars, p.val, line_end.val);
              const v = _M0FP36mizchi6kagura6mesh3d18parse__obj__double(chars, p.val, e2);
              _M0MPC15array5Array4pushGdE(texcoords, u);
              _M0MPC15array5Array4pushGdE(texcoords, v);
            } else {
              if ((line_start + 1 | 0) < line_end.val && (_M0MPC15array5Array2atGiE(chars, line_start + 1 | 0) === 32 || _M0MPC15array5Array2atGiE(chars, line_start + 1 | 0) === 9)) {
                const p = new _M0TPC13ref3RefGiE(_M0FP36mizchi6kagura6mesh3d8skip__ws(chars, line_start + 1 | 0, line_end.val));
                const e1 = _M0FP36mizchi6kagura6mesh3d8find__ws(chars, p.val, line_end.val);
                const x = _M0FP36mizchi6kagura6mesh3d18parse__obj__double(chars, p.val, e1);
                p.val = _M0FP36mizchi6kagura6mesh3d8skip__ws(chars, e1, line_end.val);
                const e2 = _M0FP36mizchi6kagura6mesh3d8find__ws(chars, p.val, line_end.val);
                const y = _M0FP36mizchi6kagura6mesh3d18parse__obj__double(chars, p.val, e2);
                p.val = _M0FP36mizchi6kagura6mesh3d8skip__ws(chars, e2, line_end.val);
                const e3 = _M0FP36mizchi6kagura6mesh3d8find__ws(chars, p.val, line_end.val);
                const z = _M0FP36mizchi6kagura6mesh3d18parse__obj__double(chars, p.val, e3);
                _M0MPC15array5Array4pushGdE(positions, x);
                _M0MPC15array5Array4pushGdE(positions, y);
                _M0MPC15array5Array4pushGdE(positions, z);
              }
            }
          }
        } else {
          if (first === 102 && ((line_start + 1 | 0) < line_end.val && (_M0MPC15array5Array2atGiE(chars, line_start + 1 | 0) === 32 || _M0MPC15array5Array2atGiE(chars, line_start + 1 | 0) === 9))) {
            const face_verts = [];
            const p = new _M0TPC13ref3RefGiE(_M0FP36mizchi6kagura6mesh3d8skip__ws(chars, line_start + 1 | 0, line_end.val));
            while (true) {
              if (p.val < line_end.val) {
                const tok_end = _M0FP36mizchi6kagura6mesh3d8find__ws(chars, p.val, line_end.val);
                if (tok_end > p.val) {
                  _M0MPC15array5Array4pushGUiiiEE(face_verts, _M0FP36mizchi6kagura6mesh3d19parse__face__vertex(chars, p.val, tok_end));
                }
                p.val = _M0FP36mizchi6kagura6mesh3d8skip__ws(chars, tok_end, line_end.val);
                continue;
              } else {
                break;
              }
            ...
            const num_verts = positions.length / 3 | 0;
            if (3 === 0) {
              $panic();
            }
            const num_norms = normals.length / 3 | 0;
            if (2 === 0) {
              $panic();
            }
            const num_texs = texcoords.length / 2 | 0;
            const face_has_normals = new _M0TPC13ref3RefGbE(false);
            const _bind = face_verts.length;
            let _tmp = 0;
            while (true) {
              const _ = _tmp;
              if (_ < _bind) {
                const fv = face_verts[_];
                let vni;
                _L: {
                  const _vni = fv._2;
                  vni = _vni;
                ...
                if (vni !== 0) {
                  face_has_normals.val = true;
                  has_normals.val = true;
                  break;
                }
                _tmp = _ + 1 | 0;
                continue;
            ...
            const _bind$2 = face_verts.length;
            let _tmp$2 = 0;
            while (true) {
              const _ = _tmp$2;
              if (_ < _bind$2) {
                ...
                _L: {
                  const _vi_raw = fv._0;
                  const _vti_raw = fv._1;
                  const _vni_raw = fv._2;
                  vti_raw = _vti_raw;
                  vi_raw = _vi_raw;
                  vni_raw = _vni_raw;
                  break _L;
                }
                const vi = vi_raw < 0 ? (num_verts + vi_raw | 0) + 1 | 0 : vi_raw;
                const pi = Math.imul(vi - 1 | 0, 3) | 0;
                const px = pi >= 0 && (pi + 2 | 0) < positions.length ? _M0MPC15array5Array2atGdE(positions, pi) : 0;
                const py = pi >= 0 && (pi + 2 | 0) < positions.length ? _M0MPC15array5Array2atGdE(positions, pi + 1 | 0) : 0;
                const pz = pi >= 0 && (pi + 2 | 0) < positions.length ? _M0MPC15array5Array2atGdE(positions, pi + 2 | 0) : 0;
                const nx = new _M0TPC13ref3RefGdE(0);
                const ny = new _M0TPC13ref3RefGdE(0);
                const nz = new _M0TPC13ref3RefGdE(0);
                if (face_has_normals.val && vni_raw !== 0) {
                  const vni = vni_raw < 0 ? (num_norms + vni_raw | 0) + 1 | 0 : vni_raw;
                  const ni = Math.imul(vni - 1 | 0, 3) | 0;
                  if (ni >= 0 && (ni + 2 | 0) < normals.length) {
                    nx.val = _M0MPC15array5Array2atGdE(normals, ni);
                    ny.val = _M0MPC15array5Array2atGdE(normals, ni + 1 | 0);
                    nz.val = _M0MPC15array5Array2atGdE(normals, ni + 2 | 0);
                  }
                }
                const u = new _M0TPC13ref3RefGdE(0);
                const v = new _M0TPC13ref3RefGdE(0);
                if (vti_raw !== 0) {
                  const vti = vti_raw < 0 ? (num_texs + vti_raw | 0) + 1 | 0 : vti_raw;
                  const ti = Math.imul(vti - 1 | 0, 2) | 0;
                  if (ti >= 0 && (ti + 1 | 0) < texcoords.length) {
                    u.val = _M0MPC15array5Array2atGdE(texcoords, ti);
                    v.val = _M0MPC15array5Array2atGdE(texcoords, ti + 1 | 0);
                  }
                }
                _M0FP36mizchi6kagura6mesh3d12push__vertex(vertex_data, px, py, pz, nx.val, ny.val, nz.val, u.val, v.val);
            ...
            const n_face = face_verts.length;
            const face_idx_start = indices.length;
            const tri_count = new _M0TPC13ref3RefGiE(0);
            const _bind$3 = 1;
            const _bind$4 = n_face - 1 | 0;
            let _tmp$3 = _bind$3;
            while (true) {
              const k = _tmp$3;
              if (k < _bind$4) {
                _M0MPC15array5Array4pushGiE(indices, base_idx);
                _M0MPC15array5Array4pushGiE(indices, base_idx + k | 0);
                _M0MPC15array5Array4pushGiE(indices, (base_idx + k | 0) + 1 | 0);
                tri_count.val = tri_count.val + 1 | 0;
                _tmp$3 = k + 1 | 0;
                continue;
              } else {
                break;
            ...
            if (!face_has_normals.val) {
              _M0MPC15array5Array4pushGiE(face_starts, face_idx_start);
              _M0MPC15array5Array4pushGiE(face_tri_counts, tri_count.val);
            }
          }
        }
      }
      pos.val = line_end.val;
      if (pos.val < len && _M0MPC15array5Array2atGiE(chars, pos.val) === 13) {
        pos.val = pos.val + 1 | 0;
      }
      if (pos.val < len && _M0MPC15array5Array2atGiE(chars, pos.val) === 10) {
        pos.val = pos.val + 1 | 0;
      }
      continue;
    } else {
  ...
  if (!has_normals.val || face_starts.length > 0) {
    const _bind = 0;
    const _bind$2 = face_starts.length;
    let _tmp = _bind;
    while (true) {
      const fi = _tmp;
      if (fi < _bind$2) {
        const idx_start = _M0MPC15array5Array2atGiE(face_starts, fi);
        const tris = _M0MPC15array5Array2atGiE(face_tri_counts, fi);
        const i0 = _M0MPC15array5Array2atGiE(indices, idx_start);
        const i1 = _M0MPC15array5Array2atGiE(indices, idx_start + 1 | 0);
        const i2 = _M0MPC15array5Array2atGiE(indices, idx_start + 2 | 0);
        ...
        while (true) {
          const ti = _tmp$2;
          if (ti < tris) {
            const base = idx_start + (Math.imul(ti, 3) | 0) | 0;
            const _bind$4 = 0;
            const _bind$5 = 3;
            let _tmp$3 = _bind$4;
            while (true) {
              const vi = _tmp$3;
              if (vi < _bind$5) {
                const idx = _M0MPC15array5Array2atGiE(indices, base + vi | 0);
  ...
  return _M0MP36mizchi6kagura6mesh3d6Mesh3D3new(vertex_data, indices);
}
...
function _M0FP36mizchi6kagura7scene3d27render__object__gpu_2einner(mesh, model, color, material, skinning, vp, frustum, lighting, dst, shader3d, screen_w, screen_h, cmds, shader3d_textured, shader3d_pbr, shader3d_pbr_textured, shader3d_skinned, camera_pos) {
  ...
  if (is_pbr) {
    ...
    _M0MPC15array5Array4pushGUiiiEE(cmds, cmd);
    return;
  } else {
    _L$4: {
      let sk;
...
function _M0FP36mizchi6kagura7scene3d23sort__objects__for__gpu(objects) {
  ...
  while (true) {
    const i = _tmp;
    if (i < _bind$2) {
      _M0MPC15array5Array4pushGUiiiEE(ordered, { _0: i, _1: _M0MPC15array5Array2atGRP36mizchi6kagura7scene3d8Object3DE(objects, i) });
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      ...
      _M0MPC15array5Array4pushGUiiiEE(sorted, entry._1);
      _tmp$2 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP26mizchi19web__runtime__hooks27bridge__web__capture__input(active, _tick) {
  if (active) {
    ...
    while (true) {
      const i = _tmp$3;
      if (i < touch_count) {
        _M0MPC15array5Array4pushGUiiiEE(touches, _M0FP36mizchi6kagura4core17new__touch__point(_M0FP26mizchi19web__runtime__hooks24js__input__touch__id__at(i), _M0FP26mizchi19web__runtime__hooks23js__input__touch__x__at(i), _M0FP26mizchi19web__runtime__hooks23js__input__touch__y__at(i)));
        _tmp$3 = i + 1 | 0;
        continue;
      } else {
        break;
    ...
    while (true) {
      ...
      if (i < gamepad_count) {
        ...
        _M0MPC15array5Array4pushGUiiiEE(gamepads, _M0FP36mizchi6kagura4core22new__gamepad__snapshot(_M0FP26mizchi19web__runtime__hooks26js__input__gamepad__id__at(i), axes, pressed_buttons));
        _tmp$4 = i + 1 | 0;
        continue;
      } else {
        break;
...
(() => {
  ...
  _M0FP26mizchi11obj__viewer15js__fetch__text("./assets/bunny.obj", (obj_text) => {
    const mesh = _M0MP36mizchi6kagura6mesh3d6Mesh3D9from__obj(obj_text);
    const camera = new _M0TPC13ref3RefGRP36mizchi6kagura8camera3d11OrbitCameraE(_M0MP36mizchi6kagura8camera3d11OrbitCamera3new(_M0MP36mizchi6kagura6math3d4Vec33new(0, 0.1, 0), 0.4, 0.5, 0.3, 0.785398163397448279, (_M0FP26mizchi11obj__viewer9screen__w + 0) / (_M0FP26mizchi11obj__viewer9screen__h + 0), 0.01, 10));
    ...
    _M0FP36mizchi6kagura6engine11run_2einner((input) => {
      ...
      if (lmb.val) {
        camera.val = _M0MP36mizchi6kagura8camera3d11OrbitCamera5orbit(camera.val, dx * -0.005, dy * -0.005);
      }
      if (input.wheel_y !== 0) {
        camera.val = _M0MP36mizchi6kagura8camera3d11OrbitCamera4zoom(camera.val, input.wheel_y * 0.02);
        return;
      } else {
        return;
      }
    }, (ctx) => {
      const objects = [_M0FP36mizchi6kagura7scene3d8object3d(mesh, undefined, undefined, undefined, _M0MP36mizchi6kagura6math3d4Vec43new(0.8, 0.6, 0.5, 1), _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d8MaterialE4None__, _M0DTPC16option6OptionGdE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura7scene3d13SkinningStateE4None__)];
      ...
      return _M0FP36mizchi6kagura7scene3d20render__scene3d__gpu(scene, ctx.dst, shader3d, ctx.screen_w, ctx.screen_h, _M0DTPC16option6OptionGORP36mizchi6kagura3gfx12ShaderHandleE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura3gfx12ShaderHandleE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura3gfx12ShaderHandleE4None__, _M0DTPC16option6OptionGORP36mizchi6kagura3gfx12ShaderHandleE4None__);
