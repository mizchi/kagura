...
for(const [bin,args] of [[process.execPath,['../../../engine/draw3d/scripts/embed-wgsl.mjs']],['moon',['build','--target','js','--release']],[process.execPath,['scripts/convert-assets.mjs']]]){
...
const shaderWatcher=watch(new URL('../../../../engine/draw3d/shaders/',import.meta.url),()=>{spawnSync(process.execPath,['../../../engine/draw3d/scripts/embed-wgsl.mjs'],{cwd:root,stdio:'inherit'})});
