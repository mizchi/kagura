...
- 単発 export:
  - `examples/games/hacknslash_3d/data/hackslash/autoplay_experiments/*.parquet`
  - `examples/games/hacknslash_3d/data/hackslash/autoplay_experiments/autoplay_experiments.duckdb`
- 仮説比較:
  - `examples/games/hacknslash_3d/data/hackslash/autoplay_hypothesis_experiments/*.parquet`
  - `examples/games/hacknslash_3d/data/hackslash/autoplay_hypothesis_experiments/autoplay_experiments.duckdb`
