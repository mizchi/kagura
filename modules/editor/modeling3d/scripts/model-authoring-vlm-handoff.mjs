...
function usage() {
  console.error(
    [
      "Usage: node modules/editor/modeling3d/scripts/model-authoring-vlm-handoff.mjs \\",
...
async function runHandoffCycle({
  ...
  if (!plan.liveReview && plan.editProfile != null) {
    ...
    runNodeScript("modules/editor/modeling3d/scripts/blender-roundtrip-edit.mjs", [
      sourceGlbPath,
