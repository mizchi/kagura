...
<nav class="presentation-tools" data-kagura-overlay aria-label="表示設定"><button id="fullscreen" type="button">全画面</button><details><summary>操作方法</summary><div>WASD：移動<br>左クリック / J：斬撃<br>Space：回避<br>1〜4：技 / I：装備 / K：成長<br>Q・E / 右ドラッグ：カメラ回転<br>ホイール：ズーム / R：視点リセット<br>O：カメラ設定 / Z：TPS切替<br>N：地形実験<br>P：一時停止 / M：ミュート<br><a href="${escape(homeHref)}">${escape(homeLabel)} ↗</a></div></details></nav>
<script>
